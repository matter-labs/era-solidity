...
// CHECK-NEXT:     %0 = sol.callvalue : i256 loc(#loc2)
// CHECK-NEXT:     sol.return %c0_i256, %0 loc(#loc3)
// CHECK-NEXT:     sol.object @Test_deployed {
// CHECK-NEXT:       %c0_i256_0 = arith.constant 0 : i256 loc(#loc4)
// CHECK-NEXT:       %1 = sol.callvalue : i256 loc(#loc5)
// CHECK-NEXT:       sol.return %c0_i256_0, %1 loc(#loc6)
// CHECK-NEXT:     } loc(#loc0)
// CHECK-NEXT:   } loc(#loc0)
// CHECK-NEXT: } loc(#loc0)
