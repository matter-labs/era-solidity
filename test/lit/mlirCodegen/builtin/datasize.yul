...
// CHECK-NEXT:     %0 = sol.datasize {obj = @Test_deployed} loc(#loc2)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:0:106)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:109)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:99)
// CHECK-NEXT: #loc7 = loc({{.*}}:4:30)
// CHECK-NEXT: #loc8 = loc({{.*}}:4:33)
// CHECK-NEXT: #loc9 = loc({{.*}}:4:23)
// CHECK-EMPTY:
