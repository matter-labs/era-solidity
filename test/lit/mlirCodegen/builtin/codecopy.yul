...
// CHECK-NEXT:     %3 = sol.dataoffset {sym = @Test_deployed} : i256 loc(#loc6)
// CHECK-NEXT:     %4 = sol.datasize {sym = @Test_deployed} : i256 loc(#loc7)
...
// CHECK-NEXT:     sol.return %c0_i256, %c0_i256_0 loc(#loc11)
...
// CHECK-NEXT:       sol.return %c0_i256_1, %c0_i256_2 loc(#loc14)
// CHECK-NEXT:     } loc(#loc0)
// CHECK-NEXT:   } loc(#loc0)
// CHECK-NEXT: } loc(#loc0)
