...
// CHECK-NEXT:     } loc(#loc5)
// CHECK-NEXT:   } {interface_fns = [{selector = 1987576030 : i32, sym = @addr_20, type = () -> ui256}, {selector = -684207929 : i32, sym = @msgSender_9, type = () -> ui256}], kind = #sol<ContractKind Contract>} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
