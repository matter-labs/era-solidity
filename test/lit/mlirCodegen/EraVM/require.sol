...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_20.0(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc6)
// CHECK-NEXT:     %2 = arith.extui %c42_i8 : i8 to i256 loc(#loc6)
...
// CHECK-NEXT:     %6 = arith.extui %c42_i8_0 : i8 to i256 loc(#loc8)
// CHECK-NEXT:     %7 = arith.cmpi ugt, %5, %6 : i256 loc(#loc7)
// CHECK-NEXT:     %false_1 = arith.constant false loc(#loc9)
// CHECK-NEXT:     %8 = arith.cmpi eq, %7, %false_1 : i1 loc(#loc9)
// CHECK-NEXT:     scf.if %8 {
...
// CHECK-NEXT:       %11 = llvm.inttoptr %10 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       llvm.store %c3963877391197344453575983046348115674221700746820753546331534351508065746944_i256, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc9)
// CHECK-NEXT:       %12 = arith.addi %10, %c4_i256 : i256 loc(#loc9)
// CHECK-NEXT:       %c32_i256 = arith.constant 32 : i256 loc(#loc9)
// CHECK-NEXT:       %13 = llvm.inttoptr %12 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       llvm.store %c32_i256, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       %14 = arith.addi %12, %c32_i256 : i256 loc(#loc9)
// CHECK-NEXT:       %c6_i256 = arith.constant 6 : i256 loc(#loc9)
// CHECK-NEXT:       %15 = llvm.inttoptr %14 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       llvm.store %c6_i256, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       %c32_i256_2 = arith.constant 32 : i256 loc(#loc9)
// CHECK-NEXT:       %16 = arith.addi %14, %c32_i256_2 : i256 loc(#loc9)
// CHECK-NEXT:       %c31858788171200504151793243853063220343653306658425181981798228421623473504256_i256 = arith.constant 31858788171200504151793243853063220343653306658425181981798228421623473504256 : i256 loc(#loc9)
// CHECK-NEXT:       %17 = llvm.inttoptr %16 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       llvm.store %c31858788171200504151793243853063220343653306658425181981798228421623473504256_i256, %17 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       %18 = arith.subi %14, %10 : i256 loc(#loc9)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc9)
// CHECK-NEXT:       func.call @__revert(%10, %18, %c2_i256) : (i256, i256, i256) -> () loc(#loc9)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc9)
// CHECK-NEXT:     } loc(#loc9)
// CHECK-NEXT:     return loc(#loc3)
// CHECK-NEXT:   } loc(#loc3)
// CHECK-NEXT:   func.func @f_20(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc5)
...
// CHECK-NEXT:       func.call @__revert(%c0_i256, %c0_i256, %c0_i256_2) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %5 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %c42_i8_0 = arith.constant 42 : i8 loc(#loc8)
...
// CHECK-NEXT:       func.call @__revert(%10, %18, %c0_i256) : (i256, i256, i256) -> () loc(#loc9)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc9)
// CHECK-NEXT:     } loc(#loc9)
// CHECK-NEXT:     return loc(#loc3)
// CHECK-NEXT:   } loc(#loc3)
