...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:         } loc(#loc2)
// CHECK-NEXT:         %12 = func.call @f_ui_22() : () -> i256 loc(#loc2)
...
// CHECK-NEXT:         %17 = func.call @f_m0_34(%16) : (i256) -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %22 = func.call @f_m1_50(%16, %21) : (i256, i256) -> i256 loc(#loc2)
...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:         } loc(#loc2)
// CHECK-NEXT:         %12 = func.call @f_s_58() : () -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %13 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc2)
