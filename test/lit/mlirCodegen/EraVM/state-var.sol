...
// CHECK-NEXT:       "scf.int_switch"(%7) <{cases = dense<638722032> : tensor<1xi256>}> ({
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_11.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_11() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<5> loc(#loc4)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc4)
// CHECK-NEXT:     return %1 : i256 loc(#loc5)
