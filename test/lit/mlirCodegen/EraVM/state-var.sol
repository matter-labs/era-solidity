...
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc6)
// CHECK-NEXT:     %6 = arith.addi %c3_i256, %c1_i256_0 : i256 loc(#loc6)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc6)
// CHECK-NEXT:     %7 = arith.addi %3, %c31_i256 : i256 loc(#loc6)
...
// CHECK-NEXT:     %9 = arith.index_castui %8 : i256 to index loc(#loc6)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc6)
// CHECK-NEXT:     scf.for %arg1 = %c0 to %9 step %c1 {
// CHECK-NEXT:       %10 = arith.index_castui %arg1 : index to i256 loc(#loc6)
// CHECK-NEXT:       %c32_i256_1 = arith.constant 32 : i256 loc(#loc6)
// CHECK-NEXT:       %11 = arith.muli %10, %c32_i256_1 : i256 loc(#loc6)
// CHECK-NEXT:       %12 = arith.addi %5, %11 : i256 loc(#loc6)
...
// CHECK-NEXT:       %15 = arith.addi %6, %10 : i256 loc(#loc6)
// CHECK-NEXT:       %16 = llvm.inttoptr %15 : i256 to !llvm.ptr<5> loc(#loc6)
// CHECK-NEXT:       llvm.store %14, %16 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc6)
// CHECK-NEXT:     } loc(#loc6)
...
// CHECK-NEXT:   } loc(#loc7)
// CHECK-NEXT:   func.func @get_m1_50.0(%arg0: i256 loc({{.*}}:10:18), %arg1: i256 loc({{.*}}:10:29)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc9)
// CHECK-NEXT:   func.func @get_m0_34.0(%arg0: i256 loc({{.*}}:9:18)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     return %1 : i256 loc(#loc26)
// CHECK-NEXT:   } loc(#loc23)
// CHECK-NEXT:   func.func @get_m0_34(%arg0: i256 loc({{.*}}:9:18)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc18)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc19)
...
// CHECK-NEXT:     return %7 : i256 loc(#loc22)
// CHECK-NEXT:   } loc(#loc17)
// CHECK-NEXT:   func.func @get_m1_50(%arg0: i256 loc({{.*}}:10:18), %arg1: i256 loc({{.*}}:10:29)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc10)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc11)
