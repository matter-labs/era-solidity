...
// CHECK-NEXT:         %10 = func.call @f_ui_23() : () -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %15 = func.call @f_m0_35(%14) : (i256) -> i256 loc(#loc2)
...
// CHECK-NEXT:         %20 = func.call @f_m1_51(%14, %19) : (i256, i256) -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         } loc(#loc2)
// CHECK-NEXT:         %c4_i256_4 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:         %10 = func.call @f_s_59() : () -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %11 = llvm.inttoptr %c64_i256_5 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %12 = llvm.load %11 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_6 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_s_59.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   } loc(#loc3)
// CHECK-NEXT:   func.func @f_m1_51.0(%arg0: i256 loc({{.*}}:13:16), %arg1: i256 loc({{.*}}:13:27)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @f_m0_35.0(%arg0: i256 loc({{.*}}:12:16)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @f_ui_23.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @f_ui_23() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc20)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<5> loc(#loc21)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc21)
// CHECK-NEXT:     return %1 : i256 loc(#loc22)
// CHECK-NEXT:   } loc(#loc19)
// CHECK-NEXT:   func.func @f_m0_35(%arg0: i256 loc({{.*}}:12:16)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc14)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc15)
...
// CHECK-NEXT:     return %7 : i256 loc(#loc18)
// CHECK-NEXT:   } loc(#loc13)
// CHECK-NEXT:   func.func @f_m1_51(%arg0: i256 loc({{.*}}:13:16), %arg1: i256 loc({{.*}}:13:27)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc6)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc6)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc6)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc7)
...
// CHECK-NEXT:     return %13 : i256 loc(#loc12)
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @f_s_59() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc1)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     llvm.store %c3_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:14:55)
// CHECK-NEXT: #loc5 = loc({{.*}}:13:2)
// CHECK-NEXT: #loc8 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc9 = loc({{.*}}:13:77)
// CHECK-NEXT: #loc10 = loc({{.*}}:13:74)
// CHECK-NEXT: #loc11 = loc({{.*}}:13:80)
// CHECK-NEXT: #loc12 = loc({{.*}}:13:67)
// CHECK-NEXT: #loc13 = loc({{.*}}:12:2)
// CHECK-NEXT: #loc15 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc16 = loc({{.*}}:12:66)
// CHECK-NEXT: #loc17 = loc({{.*}}:12:63)
// CHECK-NEXT: #loc18 = loc({{.*}}:12:56)
// CHECK-NEXT: #loc19 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc20 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc21 = loc({{.*}}:11:54)
// CHECK-NEXT: #loc22 = loc({{.*}}:11:47)
// CHECK-EMPTY:
