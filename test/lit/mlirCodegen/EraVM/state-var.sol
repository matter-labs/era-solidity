...
// CHECK: #loc1 = loc({{.*}}:5:0)
// CHECK-NEXT: #loc3 = loc({{.*}}:12:16)
// CHECK-NEXT: #loc4 = loc({{.*}}:12:27)
// CHECK-NEXT: #loc11 = loc({{.*}}:11:16)
// CHECK-NEXT: module {
...
// CHECK-NEXT:       "scf.int_switch"(%7) <{cases = dense<[3951082809, 3267321859, 3929754631]> : tensor<3xi256>}> ({
...
// CHECK-NEXT:         %10 = func.call @f_ui_21() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         %15 = func.call @f_m0_33(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:         %20 = func.call @f_m1_49(%14, %19) : (i256, i256) -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_m1_49.0(%arg0: i256 loc({{.*}}:12:16), %arg1: i256 loc({{.*}}:12:27)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:     llvm.store %c2_i256, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
...
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_1 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %c32_i256_2 = arith.constant 32 : i256 loc(#loc7)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256_2 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     llvm.store %6, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %c64_i256_3 = arith.constant 64 : i256 loc(#loc7)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_1 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %false_4 = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256_3, %false_4) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc7)
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_m0_33.0(%arg0: i256 loc({{.*}}:11:16)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc12)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc13)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc14)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc14)
...
// CHECK-NEXT:     llvm.store %c1_i256_0, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc14)
...
// CHECK-NEXT:   func.func @f_ui_21.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @f_ui_21() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc17)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<5> loc(#loc18)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc18)
// CHECK-NEXT:     return %1 : i256 loc(#loc19)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @f_m0_33(%arg0: i256 loc({{.*}}:11:16)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc11)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc12)
...
// CHECK-NEXT:     return %7 : i256 loc(#loc15)
// CHECK-NEXT:   } loc(#loc10)
// CHECK-NEXT:   func.func @f_m1_49(%arg0: i256 loc({{.*}}:12:16), %arg1: i256 loc({{.*}}:12:27)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT: #loc6 = loc({{.*}}:12:77)
// CHECK-NEXT: #loc7 = loc({{.*}}:12:74)
// CHECK-NEXT: #loc8 = loc({{.*}}:12:80)
// CHECK-NEXT: #loc9 = loc({{.*}}:12:67)
// CHECK-NEXT: #loc10 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc12 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc13 = loc({{.*}}:11:66)
// CHECK-NEXT: #loc14 = loc({{.*}}:11:63)
// CHECK-NEXT: #loc15 = loc({{.*}}:11:56)
// CHECK-NEXT: #loc16 = loc({{.*}}:10:2)
// CHECK-NEXT: #loc17 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc18 = loc({{.*}}:10:54)
// CHECK-NEXT: #loc19 = loc({{.*}}:10:47)
// CHECK-EMPTY:
