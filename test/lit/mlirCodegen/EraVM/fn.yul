...
// CHECK-NEXT:     %0 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %1 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256, %1 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %2 = arith.muli %c0_i256_0, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %3 = arith.addi %2, %c64_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_1 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_2 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_1, %3, %c2_i256_2) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %0 = call @f() : () -> i256 loc(#loc5)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc6)
// CHECK-NEXT:     call @__return(%c20_i256, %0, %c0_i256) : (i256, i256, i256) -> () loc(#loc6)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, personality = @__personality} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %c21_i256 = arith.constant 21 : i256 loc(#loc9)
// CHECK-NEXT:     llvm.store %c21_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
