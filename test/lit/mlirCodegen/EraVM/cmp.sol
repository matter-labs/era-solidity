...
// CHECK-NEXT:     %5 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %6 = llvm.load %5 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %7 = llvm.getelementptr %6[%c0_i256_1] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:     %8 = llvm.inttoptr %4 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%8, %7, %c0_i256_2) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @si_94.0(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     call @f_6.0(%4) : (i1) -> () loc(#loc7)
...
// CHECK-NEXT:     %7 = arith.cmpi ne, %5, %6 : i256 loc(#loc8)
// CHECK-NEXT:     call @f_6.0(%7) : (i1) -> () loc(#loc10)
...
// CHECK-NEXT:     %10 = arith.cmpi slt, %8, %9 : i256 loc(#loc11)
// CHECK-NEXT:     call @f_6.0(%10) : (i1) -> () loc(#loc13)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc15)
// CHECK-NEXT:     %13 = arith.cmpi sle, %11, %12 : i256 loc(#loc14)
// CHECK-NEXT:     call @f_6.0(%13) : (i1) -> () loc(#loc16)
// CHECK-NEXT:     %14 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %15 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     %16 = arith.cmpi sgt, %14, %15 : i256 loc(#loc17)
// CHECK-NEXT:     call @f_6.0(%16) : (i1) -> () loc(#loc19)
// CHECK-NEXT:     %17 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc21)
// CHECK-NEXT:     %19 = arith.cmpi sge, %17, %18 : i256 loc(#loc20)
// CHECK-NEXT:     call @f_6.0(%19) : (i1) -> () loc(#loc22)
// CHECK-NEXT:     return loc(#loc2)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @ui_50.0(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc25)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc25)
...
// CHECK-NEXT:     %4 = arith.cmpi eq, %2, %3 : i256 loc(#loc26)
// CHECK-NEXT:     call @f_6.0(%4) : (i1) -> () loc(#loc28)
// CHECK-NEXT:     %5 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %6 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc30)
// CHECK-NEXT:     %7 = arith.cmpi ne, %5, %6 : i256 loc(#loc29)
// CHECK-NEXT:     call @f_6.0(%7) : (i1) -> () loc(#loc31)
// CHECK-NEXT:     %8 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc32)
// CHECK-NEXT:     %9 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc33)
// CHECK-NEXT:     %10 = arith.cmpi ult, %8, %9 : i256 loc(#loc32)
// CHECK-NEXT:     call @f_6.0(%10) : (i1) -> () loc(#loc34)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc35)
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc36)
// CHECK-NEXT:     %13 = arith.cmpi ule, %11, %12 : i256 loc(#loc35)
// CHECK-NEXT:     call @f_6.0(%13) : (i1) -> () loc(#loc37)
// CHECK-NEXT:     %14 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc38)
// CHECK-NEXT:     %15 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc39)
// CHECK-NEXT:     %16 = arith.cmpi ugt, %14, %15 : i256 loc(#loc38)
// CHECK-NEXT:     call @f_6.0(%16) : (i1) -> () loc(#loc40)
// CHECK-NEXT:     %17 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc41)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc42)
// CHECK-NEXT:     %19 = arith.cmpi uge, %17, %18 : i256 loc(#loc41)
// CHECK-NEXT:     call @f_6.0(%19) : (i1) -> () loc(#loc43)
// CHECK-NEXT:     return loc(#loc23)
// CHECK-NEXT:   } loc(#loc23)
// CHECK-NEXT:   func.func @f_6.0(%arg0: i1 loc({{.*}}:3:13)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc45)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i1 : (i256) -> !llvm.ptr<i1> loc(#loc45)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i1> loc(#loc45)
// CHECK-NEXT:     return loc(#loc44)
// CHECK-NEXT:   } loc(#loc44)
// CHECK-NEXT:   func.func @f_6(%arg0: i1 loc({{.*}}:3:13)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc45)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i1 : (i256) -> !llvm.ptr<i1> loc(#loc45)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i1> loc(#loc45)
// CHECK-NEXT:     return loc(#loc44)
// CHECK-NEXT:   } loc(#loc44)
// CHECK-NEXT:   func.func @ui_50(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc24)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc24)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc24)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc25)
...
// CHECK-NEXT:     %3 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc27)
// CHECK-NEXT:     %4 = arith.cmpi eq, %2, %3 : i256 loc(#loc26)
// CHECK-NEXT:     call @f_6(%4) : (i1) -> () loc(#loc28)
// CHECK-NEXT:     %5 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %6 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc30)
// CHECK-NEXT:     %7 = arith.cmpi ne, %5, %6 : i256 loc(#loc29)
// CHECK-NEXT:     call @f_6(%7) : (i1) -> () loc(#loc31)
// CHECK-NEXT:     %8 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc32)
// CHECK-NEXT:     %9 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc33)
// CHECK-NEXT:     %10 = arith.cmpi ult, %8, %9 : i256 loc(#loc32)
// CHECK-NEXT:     call @f_6(%10) : (i1) -> () loc(#loc34)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc35)
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc36)
// CHECK-NEXT:     %13 = arith.cmpi ule, %11, %12 : i256 loc(#loc35)
// CHECK-NEXT:     call @f_6(%13) : (i1) -> () loc(#loc37)
// CHECK-NEXT:     %14 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc38)
// CHECK-NEXT:     %15 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc39)
// CHECK-NEXT:     %16 = arith.cmpi ugt, %14, %15 : i256 loc(#loc38)
// CHECK-NEXT:     call @f_6(%16) : (i1) -> () loc(#loc40)
// CHECK-NEXT:     %17 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc41)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc42)
// CHECK-NEXT:     %19 = arith.cmpi uge, %17, %18 : i256 loc(#loc41)
// CHECK-NEXT:     call @f_6(%19) : (i1) -> () loc(#loc43)
// CHECK-NEXT:     return loc(#loc23)
// CHECK-NEXT:   } loc(#loc23)
// CHECK-NEXT:   func.func @si_94(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT:     %3 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc6)
// CHECK-NEXT:     %4 = arith.cmpi eq, %2, %3 : i256 loc(#loc5)
// CHECK-NEXT:     call @f_6(%4) : (i1) -> () loc(#loc7)
// CHECK-NEXT:     %5 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %6 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
// CHECK-NEXT:     %7 = arith.cmpi ne, %5, %6 : i256 loc(#loc8)
// CHECK-NEXT:     call @f_6(%7) : (i1) -> () loc(#loc10)
// CHECK-NEXT:     %8 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:     %9 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     %10 = arith.cmpi slt, %8, %9 : i256 loc(#loc11)
// CHECK-NEXT:     call @f_6(%10) : (i1) -> () loc(#loc13)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc15)
// CHECK-NEXT:     %13 = arith.cmpi sle, %11, %12 : i256 loc(#loc14)
// CHECK-NEXT:     call @f_6(%13) : (i1) -> () loc(#loc16)
// CHECK-NEXT:     %14 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %15 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     %16 = arith.cmpi sgt, %14, %15 : i256 loc(#loc17)
// CHECK-NEXT:     call @f_6(%16) : (i1) -> () loc(#loc19)
// CHECK-NEXT:     %17 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc21)
// CHECK-NEXT:     %19 = arith.cmpi sge, %17, %18 : i256 loc(#loc20)
// CHECK-NEXT:     call @f_6(%19) : (i1) -> () loc(#loc22)
// CHECK-NEXT:     return loc(#loc2)
// CHECK-NEXT:   } loc(#loc2)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:14:14)
// CHECK-NEXT: #loc4 = loc({{.*}}:14:24)
// CHECK-NEXT: #loc5 = loc({{.*}}:15:6)
// CHECK-NEXT: #loc6 = loc({{.*}}:15:11)
// CHECK-NEXT: #loc7 = loc({{.*}}:15:4)
// CHECK-NEXT: #loc8 = loc({{.*}}:16:6)
// CHECK-NEXT: #loc9 = loc({{.*}}:16:11)
// CHECK-NEXT: #loc10 = loc({{.*}}:16:4)
// CHECK-NEXT: #loc11 = loc({{.*}}:17:6)
// CHECK-NEXT: #loc12 = loc({{.*}}:17:10)
// CHECK-NEXT: #loc13 = loc({{.*}}:17:4)
// CHECK-NEXT: #loc14 = loc({{.*}}:18:6)
// CHECK-NEXT: #loc15 = loc({{.*}}:18:11)
// CHECK-NEXT: #loc16 = loc({{.*}}:18:4)
// CHECK-NEXT: #loc17 = loc({{.*}}:19:6)
// CHECK-NEXT: #loc18 = loc({{.*}}:19:10)
// CHECK-NEXT: #loc19 = loc({{.*}}:19:4)
// CHECK-NEXT: #loc20 = loc({{.*}}:20:6)
// CHECK-NEXT: #loc21 = loc({{.*}}:20:11)
// CHECK-NEXT: #loc22 = loc({{.*}}:20:4)
// CHECK-NEXT: #loc23 = loc({{.*}}:5:2)
// CHECK-NEXT: #loc24 = loc({{.*}}:5:14)
// CHECK-NEXT: #loc25 = loc({{.*}}:5:25)
// CHECK-NEXT: #loc26 = loc({{.*}}:6:6)
// CHECK-NEXT: #loc27 = loc({{.*}}:6:11)
// CHECK-NEXT: #loc28 = loc({{.*}}:6:4)
// CHECK-NEXT: #loc29 = loc({{.*}}:7:6)
// CHECK-NEXT: #loc30 = loc({{.*}}:7:11)
// CHECK-NEXT: #loc31 = loc({{.*}}:7:4)
// CHECK-NEXT: #loc32 = loc({{.*}}:8:6)
// CHECK-NEXT: #loc33 = loc({{.*}}:8:10)
// CHECK-NEXT: #loc34 = loc({{.*}}:8:4)
// CHECK-NEXT: #loc35 = loc({{.*}}:9:6)
// CHECK-NEXT: #loc36 = loc({{.*}}:9:11)
// CHECK-NEXT: #loc37 = loc({{.*}}:9:4)
// CHECK-NEXT: #loc38 = loc({{.*}}:10:6)
// CHECK-NEXT: #loc39 = loc({{.*}}:10:10)
// CHECK-NEXT: #loc40 = loc({{.*}}:10:4)
// CHECK-NEXT: #loc41 = loc({{.*}}:11:6)
// CHECK-NEXT: #loc42 = loc({{.*}}:11:11)
// CHECK-NEXT: #loc43 = loc({{.*}}:11:4)
