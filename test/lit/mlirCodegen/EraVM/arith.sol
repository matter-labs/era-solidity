...
// CHECK-NEXT:         func.call @f_12(%16) : (i256) -> () loc(#loc1)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %17 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %18 = llvm.load %17 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%18, %c0_i256_7, %c0_i256_8) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
