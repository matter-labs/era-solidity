...
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %13 = arith.cmpi slt, %12, %c64_i256_5 : i256 loc(#loc1)
...
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %18 = arith.addi %c4_i256_4, %c32_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:         %21 = llvm.getelementptr %20[%18] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:         %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @unchk_51(%17, %22) : (i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %24 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %25 = llvm.load %24 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%25, %c0_i256_8, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
