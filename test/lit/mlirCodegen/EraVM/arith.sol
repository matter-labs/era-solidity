...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @unchk_45.0(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     call @f_6.0(%13) : (i256) -> () loc(#loc13)
...
// CHECK-NEXT:     call @f_6.0(%16) : (i256) -> () loc(#loc16)
...
// CHECK-NEXT:     call @f_6.0(%19) : (i256) -> () loc(#loc19)
// CHECK-NEXT:     return loc(#loc2)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_6.0(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   func.func @f_6(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc21)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc21)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc21)
// CHECK-NEXT:     return loc(#loc20)
// CHECK-NEXT:   } loc(#loc20)
// CHECK-NEXT:   func.func @unchk_45(%arg0: i256 loc(unknown), %arg1: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     %13 = arith.addi %11, %12 : i256 loc(#loc11)
// CHECK-NEXT:     call @f_6(%13) : (i256) -> () loc(#loc13)
// CHECK-NEXT:     %14 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:     %15 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc15)
// CHECK-NEXT:     %16 = arith.subi %14, %15 : i256 loc(#loc14)
// CHECK-NEXT:     call @f_6(%16) : (i256) -> () loc(#loc16)
// CHECK-NEXT:     %17 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     %19 = arith.muli %17, %18 : i256 loc(#loc17)
// CHECK-NEXT:     call @f_6(%19) : (i256) -> () loc(#loc19)
// CHECK-NEXT:     return loc(#loc2)
// CHECK-NEXT:   } loc(#loc2)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:5:17)
// CHECK-NEXT: #loc4 = loc({{.*}}:5:28)
// CHECK-NEXT: #loc5 = loc({{.*}}:7:11)
// CHECK-NEXT: #loc6 = loc({{.*}}:7:6)
// CHECK-NEXT: #loc7 = loc({{.*}}:8:11)
// CHECK-NEXT: #loc8 = loc({{.*}}:8:6)
// CHECK-NEXT: #loc9 = loc({{.*}}:9:11)
// CHECK-NEXT: #loc10 = loc({{.*}}:9:6)
// CHECK-NEXT: #loc11 = loc({{.*}}:11:8)
// CHECK-NEXT: #loc12 = loc({{.*}}:11:12)
// CHECK-NEXT: #loc13 = loc({{.*}}:11:6)
// CHECK-NEXT: #loc14 = loc({{.*}}:12:8)
// CHECK-NEXT: #loc15 = loc({{.*}}:12:12)
// CHECK-NEXT: #loc16 = loc({{.*}}:12:6)
// CHECK-NEXT: #loc17 = loc({{.*}}:13:8)
// CHECK-NEXT: #loc18 = loc({{.*}}:13:12)
// CHECK-NEXT: #loc19 = loc({{.*}}:13:6)
// CHECK-NEXT: #loc20 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc21 = loc({{.*}}:3:13)
// CHECK-EMPTY:
