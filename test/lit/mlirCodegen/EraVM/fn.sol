...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %12 = func.call @out_bool_38() : () -> i1 loc(#loc1)
...
// CHECK-NEXT:           func.call @__revert(%c0_i256_14, %c0_i256_14, %c0_i256_15) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
...
// CHECK-NEXT:           %c64_i256_14 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:           %44 = llvm.inttoptr %c64_i256_14 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           %c4_i256_15 = arith.constant 4 : i256 loc(#loc1)
// CHECK-NEXT:           %47 = arith.addi %45, %c4_i256_15 : i256 loc(#loc1)
// CHECK-NEXT:           %c32_i256_16 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:           %48 = llvm.inttoptr %47 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:           llvm.store %c32_i256_16, %48 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:           %49 = arith.addi %47, %c32_i256_16 : i256 loc(#loc1)
...
// CHECK-NEXT:           %51 = arith.addi %49, %c32_i256_17 : i256 loc(#loc1)
...
// CHECK-NEXT:           %53 = arith.addi %51, %c32_i256_18 : i256 loc(#loc1)
...
// CHECK-NEXT:           %55 = arith.subi %49, %45 : i256 loc(#loc1)
// CHECK-NEXT:           %c0_i256_19 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:           func.call @__revert(%45, %55, %c0_i256_19) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
...
// CHECK-NEXT:           %44 = llvm.inttoptr %c0_i256_14 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           %45 = llvm.inttoptr %c4_i256_15 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           func.call @__revert(%c0_i256_16, %c24_i256, %c0_i256_17) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
...
// CHECK-NEXT:         func.call @inp_string_48(%28) : (i256) -> () loc(#loc1)
// CHECK-NEXT:         %c64_i256_11 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %42 = llvm.inttoptr %c64_i256_11 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:         func.call @__return(%43, %c0_i256_12, %c0_i256_13) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }
// CHECK-NEXT:       case 2072703138 {
// CHECK-NEXT:         %10 = "llvm.intrcall"() <{id = 3177 : i32, name = "eravm.getu128"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %11 = arith.cmpi ne, %10, %c0_i256_3 : i256 loc(#loc1)
// CHECK-NEXT:         scf.if %11 {
...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %12 = func.call @out_string_65() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_4 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %13 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %15 = arith.addi %14, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %16 = arith.subi %15, %14 : i256 loc(#loc1)
// CHECK-NEXT:         %17 = llvm.inttoptr %14 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         llvm.store %16, %17 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:         %20 = llvm.inttoptr %15 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         llvm.store %19, %20 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %c32_i256_5 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %21 = arith.addi %12, %c32_i256_5 : i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %22 = arith.addi %15, %c32_i256_6 : i256 loc(#loc1)
// CHECK-NEXT:         %23 = llvm.inttoptr %22 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %24 = llvm.inttoptr %21 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         "llvm.intr.memmove"(%23, %24, %19) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc1)
// CHECK-NEXT:         %25 = arith.addi %22, %19 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %26 = llvm.inttoptr %25 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         llvm.store %c0_i256_7, %26 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %c31_i256 = arith.constant 31 : i256 loc(#loc1)
// CHECK-NEXT:         %27 = arith.addi %19, %c31_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %c-32_i256 = arith.constant -32 : i256 loc(#loc1)
// CHECK-NEXT:         %28 = arith.andi %27, %c-32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %29 = arith.addi %22, %28 : i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %30 = arith.addi %14, %c32_i256_8 : i256 loc(#loc1)
// CHECK-NEXT:         %31 = arith.subi %29, %14 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%14, %31, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }
...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %12 = func.call @out_ui_30() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_4 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %13 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @out_string_65.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc3)
// CHECK-NEXT:     llvm.store %c96_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
...
// CHECK-NEXT:     call @internal_inp_string_54(%1) : (i256) -> () loc(#loc11)
// CHECK-NEXT:     return loc(#loc8)
// CHECK-NEXT:   } loc(#loc8)
// CHECK-NEXT:   func.func @out_bool_38.0() -> i1 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %true = arith.constant true loc(#loc13)
// CHECK-NEXT:     return %true : i1 loc(#loc14)
// CHECK-NEXT:   } loc(#loc12)
// CHECK-NEXT:   func.func @out_ui_30.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc16)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc16)
// CHECK-NEXT:     return %0 : i256 loc(#loc17)
// CHECK-NEXT:   } loc(#loc15)
// CHECK-NEXT:   func.func @internal_inp_ui_22.0(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   func.func @inp_ui_12.0(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %2 = call @internal_inp_ui_22(%1) : (i256) -> i256 loc(#loc25)
// CHECK-NEXT:     return %2 : i256 loc(#loc26)
// CHECK-NEXT:   } loc(#loc22)
// CHECK-NEXT:   func.func @inp_ui_12(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc23)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc23)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc23)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc24)
...
// CHECK-NEXT:     return %2 : i256 loc(#loc26)
// CHECK-NEXT:   } loc(#loc22)
// CHECK-NEXT:   func.func @internal_inp_ui_22(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc19)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc19)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc19)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     return %1 : i256 loc(#loc21)
// CHECK-NEXT:   } loc(#loc18)
// CHECK-NEXT:   func.func @out_ui_30() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc16)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc16)
// CHECK-NEXT:     return %0 : i256 loc(#loc17)
// CHECK-NEXT:   } loc(#loc15)
// CHECK-NEXT:   func.func @out_bool_38() -> i1 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %true = arith.constant true loc(#loc13)
// CHECK-NEXT:     return %true : i1 loc(#loc14)
// CHECK-NEXT:   } loc(#loc12)
...
// CHECK-NEXT:     return loc(#loc6)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @out_string_65() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc3)
// CHECK-NEXT:     llvm.store %c96_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
...
// CHECK-NEXT: #loc7 = loc({{.*}}:9:31)
// CHECK-NEXT: #loc8 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc9 = loc({{.*}}:8:22)
// CHECK-NEXT: #loc10 = loc({{.*}}:8:68)
// CHECK-NEXT: #loc11 = loc({{.*}}:8:48)
// CHECK-NEXT: #loc12 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc13 = loc({{.*}}:6:53)
// CHECK-NEXT: #loc14 = loc({{.*}}:6:46)
// CHECK-NEXT: #loc15 = loc({{.*}}:5:2)
// CHECK-NEXT: #loc16 = loc({{.*}}:5:51)
// CHECK-NEXT: #loc17 = loc({{.*}}:5:44)
// CHECK-NEXT: #loc18 = loc({{.*}}:4:2)
// CHECK-NEXT: #loc19 = loc({{.*}}:4:27)
// CHECK-NEXT: #loc20 = loc({{.*}}:4:68)
// CHECK-NEXT: #loc21 = loc({{.*}}:4:61)
// CHECK-NEXT: #loc22 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc23 = loc({{.*}}:3:18)
// CHECK-NEXT: #loc24 = loc({{.*}}:3:73)
// CHECK-NEXT: #loc25 = loc({{.*}}:3:57)
// CHECK-NEXT: #loc26 = loc({{.*}}:3:50)
// CHECK-EMPTY:
