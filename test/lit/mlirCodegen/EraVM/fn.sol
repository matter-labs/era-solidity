...
// CHECK-NEXT:   } loc(#loc0)
// CHECK-NEXT:   func.func private @__revert(i256, i256, i256) attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc0)
...
// CHECK-NEXT:     %1 = "llvm.intrcall"() {id = 2630 : i32, name = "eravm.getu128"} : () -> i256 loc(#loc1)
...
// CHECK-NEXT:     %9 = llvm.mlir.constant(false) : i1 loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%5, %8, %c0_i256_2, %9) : (!llvm.ptr<1>, !llvm.ptr<3>, i256, i1) -> () loc(#loc1)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %10 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256, %10 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %11 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_3, %11 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %12 = arith.muli %c0_i256_4, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %13 = arith.addi %12, %c64_i256_5 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_6 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_7 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_6, %13, %c2_i256_7) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:       "scf.int_switch"(%7) ({
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }, {
// CHECK-NEXT:         %8 = "llvm.intrcall"() {id = 2630 : i32, name = "eravm.getu128"} : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
...
// CHECK-NEXT:           func.call @__revert(%c0_i256_5, %c0_i256_6, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
...
// CHECK-NEXT:         %14 = arith.subi %13, %12 : i256 loc(#loc1)
...
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }) {cases = dense<638722032> : tensor<1xi256>} : (i256) -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc1)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:6:50)
// CHECK-NEXT: #loc4 = loc({{.*}}:6:43)
// CHECK-EMPTY:
