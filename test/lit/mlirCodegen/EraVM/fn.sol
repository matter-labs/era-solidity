...
// CHECK-NEXT:         %12 = arith.addi %c4_i256_4, %c0_i256_5 : i256 loc(#loc1)
// CHECK-NEXT:         %13 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:         %15 = llvm.getelementptr %14[%12] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:         %16 = llvm.load %15 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:         %17 = func.call @inp_ui_12(%16) : (i256) -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %18 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256_7 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %20 = arith.addi %19, %c32_i256_7 : i256 loc(#loc1)
...
// CHECK-NEXT:         %22 = arith.addi %19, %c32_i256_8 : i256 loc(#loc1)
// CHECK-NEXT:         %23 = arith.subi %20, %19 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%19, %23, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @internal_fn_22.0(%arg0: i256 loc({{.*}}:8:22)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @inp_ui_12.0(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:     %2 = call @internal_fn_22(%1) : (i256) -> i256 loc(#loc9)
// CHECK-NEXT:     return %2 : i256 loc(#loc10)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @inp_ui_12(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
...
// CHECK-NEXT:     return %2 : i256 loc(#loc10)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @internal_fn_22(%arg0: i256 loc({{.*}}:8:22)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
