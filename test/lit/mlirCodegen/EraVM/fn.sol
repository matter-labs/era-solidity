...
contract C {
	...
	function inp_ui(uint a) public pure returns (uint) { return internal_fn(a); }

	function internal_fn(uint a) internal pure returns (uint) { return a; }
}
...
// CHECK-NEXT:         %14 = arith.addi %12, %c0_i256_6 : i256 loc(#loc1)
...
// CHECK-NEXT:         %16 = arith.subi %13, %12 : i256 loc(#loc1)
...
// CHECK-NEXT:         %17 = arith.subi %13, %12 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
...
// CHECK-NEXT:         %15 = func.call @inp_ui_28(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %18 = arith.addi %17, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %19 = arith.addi %17, %c0_i256_7 : i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @internal_fn_38.0(%arg0: i256 loc({{.*}}:8:22)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @inp_ui_28.0(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:     %2 = call @internal_fn_38(%1) : (i256) -> i256 loc(#loc9)
...
// CHECK-NEXT:     return %true : i1 loc(#loc13)
// CHECK-NEXT:   } loc(#loc11)
// CHECK-NEXT:   func.func @inp_ui_28(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
...
// CHECK-NEXT:     return %2 : i256 loc(#loc10)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @internal_fn_38(%arg0: i256 loc({{.*}}:8:22)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
...
// CHECK-NEXT: #loc2 = loc({{.*}}:8:1)
// CHECK-NEXT: #loc4 = loc({{.*}}:8:68)
// CHECK-NEXT: #loc5 = loc({{.*}}:8:61)
// CHECK-NEXT: #loc6 = loc({{.*}}:6:1)
// CHECK-NEXT: #loc8 = loc({{.*}}:6:73)
// CHECK-NEXT: #loc9 = loc({{.*}}:6:61)
// CHECK-NEXT: #loc10 = loc({{.*}}:6:54)
// CHECK-NEXT: #loc11 = loc({{.*}}:4:1)
// CHECK-NEXT: #loc12 = loc({{.*}}:4:57)
// CHECK-NEXT: #loc13 = loc({{.*}}:4:50)
// CHECK-NEXT: #loc14 = loc({{.*}}:3:1)
// CHECK-NEXT: #loc15 = loc({{.*}}:3:55)
// CHECK-NEXT: #loc16 = loc({{.*}}:3:48)
// CHECK-EMPTY:
