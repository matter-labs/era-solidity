...
// CHECK-NEXT:         %10 = func.call @f0_8() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         %15 = func.call @f1_18(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f1_18.0(%arg0: i256 loc({{.*}}:4:13)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f0_8.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @f0_8() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc7)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc7)
// CHECK-NEXT:     return %0 : i256 loc(#loc8)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @f1_18(%arg0: i256 loc({{.*}}:4:13)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc4)
...
// CHECK-NEXT: #loc2 = loc({{.*}}:4:1)
// CHECK-NEXT: #loc4 = loc({{.*}}:4:57)
// CHECK-NEXT: #loc5 = loc({{.*}}:4:50)
// CHECK-NEXT: #loc6 = loc({{.*}}:3:1)
// CHECK-NEXT: #loc7 = loc({{.*}}:3:51)
// CHECK-NEXT: #loc8 = loc({{.*}}:3:44)
// CHECK-EMPTY:
