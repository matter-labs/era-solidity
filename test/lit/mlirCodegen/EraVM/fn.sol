...
contract C {
	function out_ui() public pure returns (uint) { return 42; }
	function out_bool() public pure returns (bool) { return true; }

	function inp_ui(uint a) public pure returns (uint) { return 42; }
}

// NOTE: Assertions have been autogenerated by test/updFileCheckTest.py
// CHECK: #loc1 = loc({{.*}}:2:0)
// CHECK-NEXT: #loc3 = loc({{.*}}:6:17)
// CHECK-NEXT: module {
...
// CHECK-NEXT:         %10 = func.call @out_ui_8() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %c4_i256_4 = arith.constant 4 : i256 loc(#loc1)
// CHECK-NEXT:         %10 = func.call @out_bool_16() : () -> i1 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %11 = llvm.inttoptr %c64_i256_5 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %12 = llvm.load %11 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_6 = arith.constant 0 : i256 loc(#loc1)
...
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %14 = arith.addi %12, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %15 = arith.extui %10 : i1 to i256 loc(#loc1)
...
// CHECK-NEXT:         %17 = arith.subi %14, %12 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%12, %17, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }
// CHECK-NEXT:       case 2438830910 {
// CHECK-NEXT:         %8 = "llvm.intrcall"() <{id = 3177 : i32, name = "eravm.getu128"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %9 = arith.cmpi ne, %8, %c0_i256_3 : i256 loc(#loc1)
// CHECK-NEXT:         scf.if %9 {
...
// CHECK-NEXT:         %15 = func.call @inp_ui_26(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @inp_ui_26.0(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:     %1 = arith.extui %c42_i8 : i8 to i256 loc(#loc4)
// CHECK-NEXT:     return %1 : i256 loc(#loc5)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @out_bool_16.0() -> i1 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %true = arith.constant true loc(#loc7)
// CHECK-NEXT:     return %true : i1 loc(#loc8)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @out_ui_8.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc10)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc10)
// CHECK-NEXT:     return %0 : i256 loc(#loc11)
// CHECK-NEXT:   } loc(#loc9)
// CHECK-NEXT:   func.func @out_ui_8() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc10)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc10)
// CHECK-NEXT:     return %0 : i256 loc(#loc11)
// CHECK-NEXT:   } loc(#loc9)
// CHECK-NEXT:   func.func @out_bool_16() -> i1 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %true = arith.constant true loc(#loc7)
// CHECK-NEXT:     return %true : i1 loc(#loc8)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @inp_ui_26(%arg0: i256 loc({{.*}}:6:17)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc4)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:6:61)
// CHECK-NEXT: #loc5 = loc({{.*}}:6:54)
// CHECK-NEXT: #loc6 = loc({{.*}}:4:1)
// CHECK-NEXT: #loc7 = loc({{.*}}:4:57)
// CHECK-NEXT: #loc8 = loc({{.*}}:4:50)
// CHECK-NEXT: #loc9 = loc({{.*}}:3:1)
// CHECK-NEXT: #loc10 = loc({{.*}}:3:55)
// CHECK-NEXT: #loc11 = loc({{.*}}:3:48)
// CHECK-EMPTY:
