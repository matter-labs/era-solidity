...
// CHECK-NEXT:           %46 = llvm.inttoptr %c64_i256_15 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           %49 = arith.addi %47, %c4_i256_16 : i256 loc(#loc1)
// CHECK-NEXT:           %c32_i256_17 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:           %50 = llvm.inttoptr %49 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:           llvm.store %c32_i256_17, %50 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           %55 = arith.addi %53, %c32_i256_19 : i256 loc(#loc1)
...
// CHECK-NEXT:           %57 = arith.subi %51, %47 : i256 loc(#loc1)
// CHECK-NEXT:           %c0_i256_20 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:           func.call @__revert(%47, %57, %c0_i256_20) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
...
// CHECK-NEXT:           %46 = llvm.inttoptr %c0_i256_15 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:           %47 = llvm.inttoptr %c4_i256_16 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:         func.call @__return(%45, %c0_i256_13, %c0_i256_14) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }
