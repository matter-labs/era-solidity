...
contract C {
	...
	function inp_string(string memory a) public {}
}
...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %12 = func.call @out_bool_16() : () -> i1 loc(#loc1)
...
// CHECK-NEXT:         func.call @inp_string_44(%27) : (i256) -> () loc(#loc1)
...
// CHECK-NEXT:         %19 = func.call @inp_ui_28(%17) : (i256) -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %12 = func.call @out_ui_8() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_4 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %13 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @inp_string_44.0(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %2 = call @internal_fn_38(%1) : (i256) -> i256 loc(#loc11)
...
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc17)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc17)
// CHECK-NEXT:     return %0 : i256 loc(#loc18)
...
// CHECK-NEXT:     return %1 : i256 loc(#loc7)
// CHECK-NEXT:   } loc(#loc4)
// CHECK-NEXT:   func.func @inp_string_44(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     return loc(#loc2)
...
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc2 = loc({{.*}}:10:1)
// CHECK-NEXT: #loc3 = loc({{.*}}:10:21)
// CHECK-NEXT: #loc4 = loc({{.*}}:8:1)
// CHECK-NEXT: #loc6 = loc({{.*}}:8:68)
// CHECK-NEXT: #loc7 = loc({{.*}}:8:61)
// CHECK-NEXT: #loc8 = loc({{.*}}:6:1)
// CHECK-NEXT: #loc10 = loc({{.*}}:6:73)
// CHECK-NEXT: #loc11 = loc({{.*}}:6:61)
// CHECK-NEXT: #loc12 = loc({{.*}}:6:54)
// CHECK-NEXT: #loc13 = loc({{.*}}:4:1)
// CHECK-NEXT: #loc14 = loc({{.*}}:4:57)
// CHECK-NEXT: #loc15 = loc({{.*}}:4:50)
// CHECK-NEXT: #loc16 = loc({{.*}}:3:1)
// CHECK-NEXT: #loc17 = loc({{.*}}:3:55)
// CHECK-NEXT: #loc18 = loc({{.*}}:3:48)
// CHECK-EMPTY:
