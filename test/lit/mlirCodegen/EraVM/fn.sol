...
contract C {
	...
	function f1(uint a) public pure returns (uint) { return 42; }
}

// NOTE: Assertions have been autogenerated by test/updFileCheckTest.py
// CHECK: #loc1 = loc({{.*}}:5:0)
// CHECK-NEXT: #loc3 = loc({{.*}}:7:13)
// CHECK-NEXT: module {
...
// CHECK-NEXT:         %10 = func.call @f0_9() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         %15 = func.call @f1_19(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f1_19.0(%arg0: i256 loc({{.*}}:7:13)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f0_9.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
...
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @f0_9() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc7)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc7)
// CHECK-NEXT:     return %0 : i256 loc(#loc8)
// CHECK-NEXT:   } loc(#loc6)
// CHECK-NEXT:   func.func @f1_19(%arg0: i256 loc({{.*}}:7:13)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc4)
...
// CHECK-NEXT: #loc2 = loc({{.*}}:7:1)
// CHECK-NEXT: #loc4 = loc({{.*}}:7:57)
// CHECK-NEXT: #loc5 = loc({{.*}}:7:50)
// CHECK-NEXT: #loc6 = loc({{.*}}:6:1)
// CHECK-NEXT: #loc7 = loc({{.*}}:6:51)
// CHECK-NEXT: #loc8 = loc({{.*}}:6:44)
// CHECK-EMPTY:
