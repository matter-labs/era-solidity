...
// CHECK-NEXT:     llvm.store %c0_i256_1, %1 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %2 = arith.muli %c0_i256_2, %c2_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:     call @__return(%c256_i256_3, %3, %c2_i256_4) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     call @__return(%c0_i256, %1, %c0_i256_0) : (i256, i256, i256) -> () loc(#loc6)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:0:112)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:115)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:105)
// CHECK-EMPTY:
