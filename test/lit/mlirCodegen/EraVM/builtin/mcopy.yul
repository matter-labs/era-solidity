...
// CHECK-NEXT:     %2 = llvm.mlir.constant(false) : i1 loc(#loc5)
// CHECK-NEXT:     "llvm.intr.memmove"(%0, %1, %c3_i256, %2) : (!llvm.ptr<1>, !llvm.ptr<1>, i256, i1) -> () loc(#loc5)
...
// CHECK-NEXT:     %3 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %4 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %5 = arith.muli %c0_i256_2, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %6 = arith.addi %5, %c64_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_3 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_4 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_3, %6, %c2_i256_4) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %2 = llvm.mlir.constant(false) : i1 loc(#loc11)
// CHECK-NEXT:     "llvm.intr.memmove"(%0, %1, %c3_i256, %2) : (!llvm.ptr<1>, !llvm.ptr<1>, i256, i1) -> () loc(#loc11)
