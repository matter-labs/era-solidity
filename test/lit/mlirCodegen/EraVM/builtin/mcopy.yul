...
// CHECK-NEXT:     %c82_i256 = arith.constant 82 : i256 loc(#loc3)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.inttoptr %c42_i256 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:     %1 = llvm.inttoptr %c82_i256 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:     "llvm.intr.memmove"(%0, %1, %c3_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc5)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc6)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc7)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %2 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256, %2 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %3 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_1, %3 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %4 = arith.muli %c0_i256_2, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %5 = arith.addi %4, %c64_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_3 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_4 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_3, %5, %c2_i256_4) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %c82_i256 = arith.constant 82 : i256 loc(#loc9)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc10)
// CHECK-NEXT:     %0 = llvm.inttoptr %c42_i256 : i256 to !llvm.ptr<1> loc(#loc11)
// CHECK-NEXT:     %1 = llvm.inttoptr %c82_i256 : i256 to !llvm.ptr<1> loc(#loc11)
// CHECK-NEXT:     "llvm.intr.memmove"(%0, %1, %c3_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc11)
...
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc1 = loc({{.*}}:0:78)
// CHECK-NEXT: #loc2 = loc({{.*}}:0:55)
// CHECK-NEXT: #loc3 = loc({{.*}}:0:59)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:63)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:49)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:85)
// CHECK-NEXT: #loc7 = loc({{.*}}:0:88)
