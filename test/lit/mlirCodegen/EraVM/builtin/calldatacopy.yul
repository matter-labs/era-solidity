...
// CHECK-NEXT:     %2 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc5)
// CHECK-NEXT:     %3 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc5)
// CHECK-NEXT:     %4 = llvm.getelementptr %3[%1] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc5)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:     "llvm.intr.memcpy"(%5, %4, %c32_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc5)
...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc11)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc11)
// CHECK-NEXT:     %2 = llvm.getelementptr %1[%c1_i256] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc11)
// CHECK-NEXT:     %3 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc11)
// CHECK-NEXT:     "llvm.intr.memcpy"(%3, %2, %c32_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc11)
...
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc1 = loc({{.*}}:0:84)
// CHECK-NEXT: #loc2 = loc({{.*}}:0:62)
// CHECK-NEXT: #loc3 = loc({{.*}}:0:65)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:68)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:49)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:91)
// CHECK-NEXT: #loc7 = loc({{.*}}:0:94)
// CHECK-NEXT: #loc8 = loc({{.*}}:6:1)
// CHECK-NEXT: #loc9 = loc({{.*}}:7:0)
// CHECK-NEXT: #loc10 = loc({{.*}}:7:3)
// CHECK-NEXT: #loc11 = loc({{.*}}:5:5)
// CHECK-NEXT: #loc12 = loc({{.*}}:8:3)
