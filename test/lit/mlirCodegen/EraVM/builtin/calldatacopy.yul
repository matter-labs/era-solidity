...
// CHECK-NEXT:     %6 = llvm.mlir.constant(false) : i1 loc(#loc5)
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %5, %c32_i256, %6) : (!llvm.ptr<1>, !llvm.ptr<3>, i256, i1) -> () loc(#loc5)
...
// CHECK-NEXT:     %7 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256_2 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256_2, %7 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %8 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_3, %8 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %9 = arith.muli %c0_i256_4, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %10 = arith.addi %9, %c64_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_5 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_6 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_5, %10, %c2_i256_6) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %4 = llvm.mlir.constant(false) : i1 loc(#loc11)
// CHECK-NEXT:     "llvm.intr.memcpy"(%0, %3, %c32_i256, %4) : (!llvm.ptr<1>, !llvm.ptr<3>, i256, i1) -> () loc(#loc11)
