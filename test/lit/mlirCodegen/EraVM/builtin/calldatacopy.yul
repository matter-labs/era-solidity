...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc5)
...
// CHECK-NEXT:     %3 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc5)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc5)
// CHECK-NEXT:     %5 = llvm.getelementptr %4[%1] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc5)
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %5, %c32_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc5)
...
// CHECK-NEXT:     %6 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256_2 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256_2, %6 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %7 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_3, %7 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %8 = arith.muli %c0_i256_4, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %9 = arith.addi %8, %c64_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_5 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_6 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_5, %9, %c2_i256_6) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %1 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc11)
// CHECK-NEXT:     %2 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc11)
// CHECK-NEXT:     %3 = llvm.getelementptr %2[%c1_i256] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc11)
// CHECK-NEXT:     "llvm.intr.memcpy"(%0, %3, %c32_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc11)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc12)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc13)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc14)
// CHECK-NEXT:     call @__return(%c0_i256_0, %c0_i256_1, %c0_i256_2) : (i256, i256, i256) -> () loc(#loc14)
