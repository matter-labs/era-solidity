...
// CHECK-NEXT:     llvm.store %c42_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc10)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc11)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc12)
// CHECK-NEXT:     call @__return(%c0_i256, %c0_i256_0, %c0_i256_1) : (i256, i256, i256) -> () loc(#loc12)
...
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc1 = loc({{.*}}:0:91)
// CHECK-NEXT: #loc2 = loc({{.*}}:0:56)
// CHECK-NEXT: #loc3 = loc({{.*}}:0:60)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:49)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:98)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:101)
// CHECK-NEXT: #loc7 = loc({{.*}}:5:12)
// CHECK-NEXT: #loc8 = loc({{.*}}:5:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:5:5)
// CHECK-NEXT: #loc10 = loc({{.*}}:7:22)
// CHECK-NEXT: #loc11 = loc({{.*}}:7:25)
// CHECK-NEXT: #loc12 = loc({{.*}}:7:15)
// CHECK-EMPTY:
