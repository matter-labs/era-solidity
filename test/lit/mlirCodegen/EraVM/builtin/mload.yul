...
// CHECK-NEXT:     llvm.store %c0_i256_0, %3 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %4 = arith.muli %c0_i256_1, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_2 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %5 = arith.addi %4, %c64_i256_2 : i256 loc(#loc1)
...
// CHECK-NEXT:     %0 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc7)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc8)
// CHECK-NEXT:     call @__return(%c0_i256, %1, %c0_i256_0) : (i256, i256, i256) -> () loc(#loc8)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:0:45)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:39)
