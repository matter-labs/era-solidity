...
// CHECK-NEXT:     %4 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc9)
// CHECK-NEXT:     %5 = llvm.load %4 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc9)
// CHECK-NEXT:     %6 = llvm.getelementptr %5[%c0_i256] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc9)
// CHECK-NEXT:     %7 = llvm.inttoptr %3 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:     "llvm.intr.memcpy"(%7, %6, %c0_i256_0) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc9)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:0:53)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:70)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:64)
// CHECK-NEXT: #loc6 = loc({{.*}}:0:95)
// CHECK-NEXT: #loc7 = loc({{.*}}:0:104)
// CHECK-NEXT: #loc8 = loc({{.*}}:2:3)
// CHECK-NEXT: #loc9 = loc({{.*}}:0:86)
// CHECK-NEXT: #loc10 = loc({{.*}}:4:24)
// CHECK-NEXT: #loc11 = loc({{.*}}:4:27)
// CHECK-NEXT: #loc12 = loc({{.*}}:5:70)
// CHECK-NEXT: #loc13 = loc({{.*}}:5:73)
// CHECK-NEXT: #loc14 = loc({{.*}}:5:63)
// CHECK-EMPTY:
