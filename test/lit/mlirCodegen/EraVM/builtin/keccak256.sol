...
// CHECK-NEXT:   func.func private @__sha3(!llvm.ptr<1>, i256, i1) -> i256 attributes {llvm.linkage = #llvm.linkage<external>} loc(#loc0)
...
// CHECK-NEXT:     %false = arith.constant false loc(#loc0)
// CHECK-NEXT:     %1 = call @__sha3(%0, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc4)
...
// CHECK-NEXT:     %5 = arith.addi %4, %c64_i256_3 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_4 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_5 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_4, %5, %c2_i256_5) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %false = arith.constant false loc(#loc0)
// CHECK-NEXT:     %1 = call @__sha3(%0, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc8)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc9)
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc10)
// CHECK-NEXT:     call @__return(%1, %c0_i256_0, %c0_i256_1) : (i256, i256, i256) -> () loc(#loc10)
...
// CHECK-NEXT: #loc2 = loc({{.*}}:5:21)
// CHECK-NEXT: #loc3 = loc({{.*}}:5:24)
// CHECK-NEXT: #loc4 = loc({{.*}}:5:11)
// CHECK-NEXT: #loc5 = loc({{.*}}:5:31)
// CHECK-NEXT: #loc6 = loc({{.*}}:9:23)
// CHECK-NEXT: #loc7 = loc({{.*}}:9:26)
// CHECK-NEXT: #loc8 = loc({{.*}}:9:13)
// CHECK-NEXT: #loc9 = loc({{.*}}:9:33)
