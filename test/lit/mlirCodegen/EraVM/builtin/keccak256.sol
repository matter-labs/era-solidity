...
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc1 = loc({{.*}}:0:37)
// CHECK-NEXT: #loc2 = loc({{.*}}:0:54)
// CHECK-NEXT: #loc3 = loc({{.*}}:0:57)
// CHECK-NEXT: #loc4 = loc({{.*}}:0:44)
// CHECK-NEXT: #loc5 = loc({{.*}}:0:64)
// CHECK-NEXT: #loc6 = loc({{.*}}:3:4)
// CHECK-NEXT: #loc7 = loc({{.*}}:3:7)
// CHECK-NEXT: #loc8 = loc({{.*}}:2:10)
// CHECK-NEXT: #loc9 = loc({{.*}}:4:5)
// CHECK-NEXT: #loc10 = loc({{.*}}:2:3)
// CHECK-EMPTY:
