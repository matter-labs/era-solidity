...
// CHECK-NEXT:   %1 = load i256, ptr addrspace(1) inttoptr (i256 64 to ptr addrspace(1)), align 1, !dbg !11
...
// CHECK-NEXT: }
// CHECK-EMPTY:
// CHECK-NEXT: define private void @__runtime() !dbg !14 {
// CHECK-NEXT:   %1 = load i256, ptr addrspace(1) inttoptr (i256 64 to ptr addrspace(1)), align 1, !dbg !15
// CHECK-NEXT:   call void @__return(i256 0, i256 %1, i256 0), !dbg !17
...
// CHECK-NEXT: !11 = !DILocation(line: 5, column: 14, scope: !12)
// CHECK-NEXT: !12 = !DILexicalBlockFile(scope: !10, file: !9, discriminator: 0)
// CHECK-NEXT: !13 = !DILocation(line: 5, column: 4, scope: !12)
// CHECK-NEXT: !14 = distinct !DISubprogram(name: "__runtime", linkageName: "__runtime", scope: null, file: !4, type: !5, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
// CHECK-NEXT: !15 = !DILocation(line: 9, column: 16, scope: !16)
// CHECK-NEXT: !16 = !DILexicalBlockFile(scope: !14, file: !9, discriminator: 0)
// CHECK-NEXT: !17 = !DILocation(line: 9, column: 6, scope: !16)
// CHECK-EMPTY:
// ASM: 	.text
// ASM-NEXT: 	.file	{{.*}}
