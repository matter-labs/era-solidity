...
// CHECK-NEXT:   call void @__return(i256 0, i256 %1, i256 0), !dbg !16
...
// CHECK-NEXT: !14 = !DILocation(line: 9, column: 16, scope: !15)
// CHECK-NEXT: !15 = !DILexicalBlockFile(scope: !13, file: !9, discriminator: 0)
// CHECK-NEXT: !16 = !DILocation(line: 9, column: 6, scope: !15)
// CHECK-EMPTY:
// ASM: 	.text
// ASM-NEXT: 	.file	{{.*}}
...
// ASM-NEXT: 	add	stack[@calldatasize], r0, r2
