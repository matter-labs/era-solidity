...
// CHECK-NEXT:   store i256 42, ptr addrspace(1) inttoptr (i256 64 to ptr addrspace(1)), align 1, !dbg !15
// CHECK-NEXT:   call void @__return(i256 0, i256 0, i256 0), !dbg !17
...
// CHECK-NEXT: !6 = !{}
// CHECK-NEXT: !7 = !DILocation(line: 6, column: 4, scope: !8)
...
// CHECK-NEXT: !13 = !DILocation(line: 6, column: 4, scope: !12)
...
// CHECK-NEXT: !15 = !DILocation(line: 10, column: 6, scope: !16)
// CHECK-NEXT: !16 = !DILexicalBlockFile(scope: !14, file: !9, discriminator: 0)
// CHECK-NEXT: !17 = !DILocation(line: 11, column: 6, scope: !16)
// CHECK-EMPTY:
// ASM: 	.text
// ASM-NEXT: 	.file	{{.*}}
