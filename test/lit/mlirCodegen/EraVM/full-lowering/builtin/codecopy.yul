...
// CHECK-NEXT:   %1 = alloca i256, i256 1, align 32, !dbg !11
// CHECK-NEXT:   %2 = load i256, ptr addrspace(1) inttoptr (i256 64 to ptr addrspace(1)), align 1, !dbg !13
// CHECK-NEXT:   store i256 %2, ptr %1, align 32, !dbg !14
// CHECK-NEXT:   %3 = load i256, ptr %1, align 32, !dbg !15
// CHECK-NEXT:   %4 = inttoptr i256 %3 to ptr addrspace(1), !dbg !16
// CHECK-NEXT:   %5 = load ptr addrspace(3), ptr @ptr_calldata, align 32, !dbg !16
// CHECK-NEXT:   %6 = getelementptr i8, ptr addrspace(3) %5, i256 0, !dbg !16
// CHECK-NEXT:   call void @llvm.memcpy.p1.p3.i256(ptr addrspace(1) %4, ptr addrspace(3) %6, i256 0, i1 false), !dbg !16
// CHECK-NEXT:   store i256 32, ptr addrspace(2) inttoptr (i256 256 to ptr addrspace(2)), align 32, !dbg !17
// CHECK-NEXT:   store i256 0, ptr addrspace(2) inttoptr (i256 288 to ptr addrspace(2)), align 32, !dbg !17
// CHECK-NEXT:   call void @__return(i256 256, i256 64, i256 2), !dbg !17
// CHECK-NEXT:   call void @.unreachable(), !dbg !17
// CHECK-NEXT:   unreachable
// CHECK-NEXT: }
// CHECK-EMPTY:
// CHECK-NEXT: define private void @__runtime() !dbg !18 {
// CHECK-NEXT:   call void @__return(i256 0, i256 0, i256 0), !dbg !19
// CHECK-NEXT:   call void @.unreachable(), !dbg !19
// CHECK-NEXT:   unreachable
// CHECK-NEXT: }
// CHECK-EMPTY:
...
// CHECK-NEXT: !6 = !{}
// CHECK-NEXT: !7 = !DILocation(line: 7, column: 4, scope: !8)
...
// CHECK-NEXT: !11 = !DILocation(line: 5, column: 8, scope: !12)
// CHECK-NEXT: !12 = !DILexicalBlockFile(scope: !10, file: !9, discriminator: 0)
// CHECK-NEXT: !13 = !DILocation(line: 5, column: 19, scope: !12)
// CHECK-NEXT: !14 = !DILocation(line: 5, column: 4, scope: !12)
// CHECK-NEXT: !15 = !DILocation(line: 6, column: 13, scope: !12)
// CHECK-NEXT: !16 = !DILocation(line: 6, column: 4, scope: !12)
// CHECK-NEXT: !17 = !DILocation(line: 7, column: 4, scope: !12)
// CHECK-NEXT: !18 = distinct !DISubprogram(name: "__runtime", linkageName: "__runtime", scope: null, file: !4, type: !5, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
// CHECK-NEXT: !19 = !DILocation(line: 11, column: 6, scope: !20)
// CHECK-NEXT: !20 = !DILexicalBlockFile(scope: !18, file: !9, discriminator: 0)
// CHECK-EMPTY:
// ASM: 	.text
// ASM-NEXT: 	.file	{{.*}}
