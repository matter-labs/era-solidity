...
// CHECK: #View = #sol<StateMutability View>
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @addr_20.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #View} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @msgSender_9.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #View} {
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3170 : i32, name = "eravm.caller"}> : () -> i256 loc(#loc6)
// CHECK-NEXT:     return %0 : i256 loc(#loc7)
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @msgSender_9() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #View} {
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3170 : i32, name = "eravm.caller"}> : () -> i256 loc(#loc6)
// CHECK-NEXT:     return %0 : i256 loc(#loc7)
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @addr_20() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #View} {
// CHECK-NEXT:     %c0_i8 = arith.constant 0 : i8 loc(#loc3)
// CHECK-NEXT:     %0 = arith.extui %c0_i8 : i8 to i256 loc(#loc3)
// CHECK-NEXT:     return %0 : i256 loc(#loc4)
// CHECK-NEXT:   } loc(#loc2)
