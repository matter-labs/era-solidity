...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_approve_101.0(%arg0: i256 loc({{.*}}:39:20), %arg1: i256 loc({{.*}}:39:35), %arg2: i256 loc({{.*}}:39:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc3)
// CHECK-NEXT:   func.func @allowance_85.0(%arg0: i256 loc({{.*}}:35:21), %arg1: i256 loc({{.*}}:35:36)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @balanceOf_69.0(%arg0: i256 loc({{.*}}:31:21)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @totalSupply_57.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @decimals_49.0() -> i8 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc30)
// CHECK-NEXT:     return %c18_i8 : i8 loc(#loc31)
// CHECK-NEXT:   } loc(#loc29)
// CHECK-NEXT:   func.func @symbol_41.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @name_33.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:   func.func @name_33() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc1)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     llvm.store %c3_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     return %9 : i256 loc(#loc36)
// CHECK-NEXT:   } loc(#loc35)
// CHECK-NEXT:   func.func @symbol_41() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c4_i256 = arith.constant 4 : i256 loc(#loc33)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc33)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc33)
// CHECK-NEXT:     llvm.store %c4_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc33)
...
// CHECK-NEXT:     return %9 : i256 loc(#loc34)
// CHECK-NEXT:   } loc(#loc32)
// CHECK-NEXT:   func.func @decimals_49() -> i8 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc30)
// CHECK-NEXT:     return %c18_i8 : i8 loc(#loc31)
// CHECK-NEXT:   } loc(#loc29)
// CHECK-NEXT:   func.func @totalSupply_57() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc26)
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc27)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc27)
// CHECK-NEXT:     return %1 : i256 loc(#loc28)
// CHECK-NEXT:   } loc(#loc25)
// CHECK-NEXT:   func.func @balanceOf_69(%arg0: i256 loc({{.*}}:31:21)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc20)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc21)
...
// CHECK-NEXT:     return %7 : i256 loc(#loc24)
// CHECK-NEXT:   } loc(#loc19)
// CHECK-NEXT:   func.func @allowance_85(%arg0: i256 loc({{.*}}:35:21), %arg1: i256 loc({{.*}}:35:36)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc12)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc13)
...
// CHECK-NEXT:     return %13 : i256 loc(#loc18)
// CHECK-NEXT:   } loc(#loc11)
// CHECK-NEXT:   func.func @_approve_101(%arg0: i256 loc({{.*}}:39:20), %arg1: i256 loc({{.*}}:39:35), %arg2: i256 loc({{.*}}:39:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc5)
