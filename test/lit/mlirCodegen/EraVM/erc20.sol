...
// CHECK: #loc1 = loc({{.*}}:6:0)
// CHECK-NEXT: #loc3 = loc({{.*}}:23:21)
// CHECK-NEXT: #loc4 = loc({{.*}}:23:36)
// CHECK-NEXT: #loc11 = loc({{.*}}:19:21)
// CHECK-NEXT: module {
...
// CHECK-NEXT:       "scf.int_switch"(%7) <{cases = dense<[826074471, 404098525, 1889567281, 3714247998]> : tensor<4xi256>}> ({
...
// CHECK-NEXT:         %10 = func.call @decimals_21() : () -> i8 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         } loc(#loc1)
// CHECK-NEXT:         %c4_i256_4 = arith.constant 4 : i256 loc(#loc1)
// CHECK-NEXT:         %10 = func.call @totalSupply_29() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:         %11 = llvm.inttoptr %c64_i256_5 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %12 = llvm.load %11 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_6 = arith.constant 0 : i256 loc(#loc1)
...
// CHECK-NEXT:         %15 = func.call @balanceOf_41(%14) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:         %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %15 = arith.addi %c4_i256_4, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %16 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:         %17 = llvm.load %16 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:         %18 = llvm.getelementptr %17[%15] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:         %20 = func.call @allowance_57(%14, %19) : (i256, i256) -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %23 = arith.addi %22, %c0_i256_7 : i256 loc(#loc1)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:         %24 = arith.addi %22, %c32_i256_8 : i256 loc(#loc1)
// CHECK-NEXT:         %25 = llvm.inttoptr %23 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         llvm.store %20, %25 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %26 = arith.subi %24, %22 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%22, %26, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @allowance_57.0(%arg0: i256 loc({{.*}}:23:21), %arg1: i256 loc({{.*}}:23:36)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:     %4 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     llvm.store %c1_i256_1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
...
// CHECK-NEXT:     %6 = call @__sha3(%5, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc7)
// CHECK-NEXT:     %7 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc7)
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc7)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256_3 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     llvm.store %6, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc7)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %false_5 = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256_4, %false_5) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc7)
...
// CHECK-NEXT:     return %13 : i256 loc(#loc9)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @balanceOf_41.0(%arg0: i256 loc({{.*}}:19:21)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
...
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc14)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc14)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc14)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc14)
// CHECK-NEXT:     %3 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc14)
// CHECK-NEXT:     llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc14)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc14)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc14)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %5 = call @__sha3(%4, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc14)
// CHECK-NEXT:     %6 = llvm.inttoptr %5 : i256 to !llvm.ptr<5> loc(#loc14)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc14)
// CHECK-NEXT:     return %7 : i256 loc(#loc15)
// CHECK-NEXT:   } loc(#loc10)
// CHECK-NEXT:   func.func @totalSupply_29.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc17)
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc18)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc18)
// CHECK-NEXT:     return %1 : i256 loc(#loc19)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @decimals_21.0() -> i8 attributes {llvm.linkage = #llvm.linkage<private>, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc21)
// CHECK-NEXT:     return %c18_i8 : i8 loc(#loc22)
// CHECK-NEXT:   } loc(#loc20)
// CHECK-NEXT:   func.func @decimals_21() -> i8 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc21)
// CHECK-NEXT:     return %c18_i8 : i8 loc(#loc22)
// CHECK-NEXT:   } loc(#loc20)
// CHECK-NEXT:   func.func @totalSupply_29() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc17)
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc18)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc18)
// CHECK-NEXT:     return %1 : i256 loc(#loc19)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @balanceOf_41(%arg0: i256 loc({{.*}}:19:21)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc11)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc12)
...
// CHECK-NEXT:     return %7 : i256 loc(#loc15)
// CHECK-NEXT:   } loc(#loc10)
// CHECK-NEXT:   func.func @allowance_57(%arg0: i256 loc({{.*}}:23:21), %arg1: i256 loc({{.*}}:23:36)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, runtime, state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT: #loc2 = loc({{.*}}:23:2)
// CHECK-NEXT: #loc5 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc6 = loc({{.*}}:24:23)
// CHECK-NEXT: #loc7 = loc({{.*}}:24:11)
// CHECK-NEXT: #loc8 = loc({{.*}}:24:30)
...
// CHECK-NEXT: #loc20 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc21 = loc({{.*}}:12:11)
// CHECK-NEXT: #loc22 = loc({{.*}}:12:4)
// CHECK-EMPTY:
