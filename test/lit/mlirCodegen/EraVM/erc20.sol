...
// CHECK: #loc2 = loc({{.*}}:6:0)
// CHECK-NEXT: #loc4 = loc({{.*}}:48:20)
// CHECK-NEXT: #loc5 = loc({{.*}}:48:35)
// CHECK-NEXT: #loc6 = loc({{.*}}:48:52)
// CHECK-NEXT: #loc17 = loc({{.*}}:43:19)
// CHECK-NEXT: #loc18 = loc({{.*}}:43:36)
// CHECK-NEXT: #loc26 = loc({{.*}}:39:21)
// CHECK-NEXT: #loc27 = loc({{.*}}:39:36)
// CHECK-NEXT: #loc33 = loc({{.*}}:35:21)
// CHECK-NEXT: module {
...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_approve_137.0(%arg0: i256 loc({{.*}}:48:20), %arg1: i256 loc({{.*}}:48:35), %arg2: i256 loc({{.*}}:48:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %2 = call @_msgSender_34.0() : () -> i256 loc(#loc19)
...
// CHECK-NEXT:     call @_approve_137(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc22)
// CHECK-NEXT:     %true = arith.constant true loc(#loc23)
// CHECK-NEXT:     return %true : i1 loc(#loc24)
...
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc27)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc27)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc27)
...
// CHECK-NEXT:     llvm.store %c1_i256_1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %6 = call @__sha3(%5, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc29)
// CHECK-NEXT:     %7 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc30)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc29)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256_3 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %6, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %false_5 = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256_4, %false_5) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc29)
// CHECK-NEXT:     %12 = llvm.inttoptr %11 : i256 to !llvm.ptr<5> loc(#loc29)
// CHECK-NEXT:     %13 = llvm.load %12 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc29)
// CHECK-NEXT:     return %13 : i256 loc(#loc31)
...
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc35)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc36)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc36)
// CHECK-NEXT:     %3 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc36)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %5 = call @__sha3(%4, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc36)
// CHECK-NEXT:     %6 = llvm.inttoptr %5 : i256 to !llvm.ptr<5> loc(#loc36)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc36)
// CHECK-NEXT:     return %7 : i256 loc(#loc37)
...
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc40)
...
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc43)
// CHECK-NEXT:     %0 = arith.extui %c18_i8 : i8 to i256 loc(#loc43)
// CHECK-NEXT:     return %0 : i256 loc(#loc44)
...
// CHECK-NEXT:     %c4_i256 = arith.constant 4 : i256 loc(#loc46)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc46)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     llvm.store %c4_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc46)
// CHECK-NEXT:     %1 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %2 = call @__sha3(%1, %c32_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc46)
// CHECK-NEXT:     %3 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<5> loc(#loc46)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc46)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc46)
// CHECK-NEXT:     %5 = arith.addi %4, %c31_i256 : i256 loc(#loc46)
// CHECK-NEXT:     %c4294967264_i256 = arith.constant 4294967264 : i256 loc(#loc46)
// CHECK-NEXT:     %6 = arith.andi %5, %c4294967264_i256 : i256 loc(#loc46)
// CHECK-NEXT:     %c32_i256_0 = arith.constant 32 : i256 loc(#loc46)
// CHECK-NEXT:     %7 = arith.addi %6, %c32_i256_0 : i256 loc(#loc46)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc46)
// CHECK-NEXT:     %8 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     %9 = llvm.load %8 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc46)
// CHECK-NEXT:     %10 = arith.addi %9, %7 : i256 loc(#loc46)
// CHECK-NEXT:     %c18446744073709551615_i256 = arith.constant 18446744073709551615 : i256 loc(#loc46)
// CHECK-NEXT:     %11 = arith.cmpi ugt, %10, %c18446744073709551615_i256 : i256 loc(#loc46)
// CHECK-NEXT:     %12 = arith.cmpi ult, %10, %9 : i256 loc(#loc46)
// CHECK-NEXT:     %13 = arith.ori %11, %12 : i1 loc(#loc46)
// CHECK-NEXT:     scf.if %13 {
// CHECK-NEXT:       %c0_i256_4 = arith.constant 0 : i256 loc(#loc46)
// CHECK-NEXT:       %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc46)
// CHECK-NEXT:       %19 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %19 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:       %c4_i256_5 = arith.constant 4 : i256 loc(#loc46)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc46)
// CHECK-NEXT:       %20 = llvm.inttoptr %c4_i256_5 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:       llvm.store %c65_i256, %20 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc46)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc46)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc46)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc46)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc46)
// CHECK-NEXT:     } loc(#loc46)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc46)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     llvm.store %10, %14 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     %15 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     llvm.store %4, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     %c31_i256_2 = arith.constant 31 : i256 loc(#loc46)
// CHECK-NEXT:     %16 = arith.addi %4, %c31_i256_2 : i256 loc(#loc46)
// CHECK-NEXT:     %c4294967264_i256_3 = arith.constant 4294967264 : i256 loc(#loc46)
// CHECK-NEXT:     %17 = arith.andi %16, %c4294967264_i256_3 : i256 loc(#loc46)
// CHECK-NEXT:     %c0 = arith.constant 0 : index loc(#loc46)
// CHECK-NEXT:     %18 = arith.index_castui %17 : i256 to index loc(#loc46)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc46)
// CHECK-NEXT:     scf.for %arg0 = %c0 to %18 step %c1 {
// CHECK-NEXT:       %19 = arith.index_castui %arg0 : index to i256 loc(#loc46)
// CHECK-NEXT:       %20 = arith.addi %2, %19 : i256 loc(#loc46)
// CHECK-NEXT:       %21 = llvm.inttoptr %20 : i256 to !llvm.ptr<5> loc(#loc46)
// CHECK-NEXT:       %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc46)
// CHECK-NEXT:       %c32_i256_4 = arith.constant 32 : i256 loc(#loc46)
// CHECK-NEXT:       %23 = arith.muli %19, %c32_i256_4 : i256 loc(#loc46)
// CHECK-NEXT:       %24 = arith.addi %9, %23 : i256 loc(#loc46)
// CHECK-NEXT:       %25 = llvm.inttoptr %24 : i256 to !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:       llvm.store %22, %25 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc46)
// CHECK-NEXT:     } loc(#loc46)
// CHECK-NEXT:     return %9 : i256 loc(#loc47)
...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     return %9 : i256 loc(#loc49)
...
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3170 : i32, name = "eravm.caller"}> : () -> i256 loc(#loc51)
// CHECK-NEXT:     return %0 : i256 loc(#loc52)
...
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc46)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc46)
// CHECK-NEXT:       %c0_i256_7 = arith.constant 0 : i256 loc(#loc46)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc46)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc46)
// CHECK-NEXT:     } loc(#loc46)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc46)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc46)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     %2 = call @_msgSender_34() : () -> i256 loc(#loc19)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc21)
// CHECK-NEXT:     call @_approve_137(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc22)
// CHECK-NEXT:     %true = arith.constant true loc(#loc23)
// CHECK-NEXT:     return %true : i1 loc(#loc24)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @_approve_137(%arg0: i256 loc({{.*}}:48:20), %arg1: i256 loc({{.*}}:48:35), %arg2: i256 loc({{.*}}:48:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc5)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:48:2)
// CHECK-NEXT: #loc7 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc8 = loc({{.*}}:53:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:53:4)
// CHECK-NEXT: #loc10 = loc({{.*}}:53:23)
// CHECK-NEXT: #loc11 = loc({{.*}}:53:34)
// CHECK-NEXT: #loc12 = loc({{.*}}:54:18)
// CHECK-NEXT: #loc13 = loc({{.*}}:54:25)
// CHECK-NEXT: #loc14 = loc({{.*}}:54:34)
// CHECK-NEXT: #loc15 = loc({{.*}}:54:9)
// CHECK-NEXT: #loc16 = loc({{.*}}:43:2)
// CHECK-NEXT: #loc19 = loc({{.*}}:44:13)
// CHECK-NEXT: #loc20 = loc({{.*}}:44:27)
// CHECK-NEXT: #loc21 = loc({{.*}}:44:36)
// CHECK-NEXT: #loc22 = loc({{.*}}:44:4)
// CHECK-NEXT: #loc23 = loc({{.*}}:45:11)
// CHECK-NEXT: #loc24 = loc({{.*}}:45:4)
// CHECK-NEXT: #loc25 = loc({{.*}}:39:2)
// CHECK-NEXT: #loc28 = loc({{.*}}:40:23)
// CHECK-NEXT: #loc29 = loc({{.*}}:40:11)
// CHECK-NEXT: #loc30 = loc({{.*}}:40:30)
// CHECK-NEXT: #loc31 = loc({{.*}}:40:4)
// CHECK-NEXT: #loc32 = loc({{.*}}:35:2)
// CHECK-NEXT: #loc34 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc35 = loc({{.*}}:36:21)
// CHECK-NEXT: #loc36 = loc({{.*}}:36:11)
// CHECK-NEXT: #loc37 = loc({{.*}}:36:4)
// CHECK-NEXT: #loc38 = loc({{.*}}:31:2)
// CHECK-NEXT: #loc39 = loc({{.*}}:9:2)
// CHECK-NEXT: #loc40 = loc({{.*}}:32:11)
// CHECK-NEXT: #loc41 = loc({{.*}}:32:4)
// CHECK-NEXT: #loc42 = loc({{.*}}:27:2)
// CHECK-NEXT: #loc43 = loc({{.*}}:28:11)
// CHECK-NEXT: #loc44 = loc({{.*}}:28:4)
// CHECK-NEXT: #loc45 = loc({{.*}}:23:2)
// CHECK-NEXT: #loc46 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc47 = loc({{.*}}:24:4)
// CHECK-NEXT: #loc48 = loc({{.*}}:19:2)
// CHECK-NEXT: #loc49 = loc({{.*}}:20:4)
// CHECK-NEXT: #loc50 = loc({{.*}}:15:2)
// CHECK-NEXT: #loc51 = loc({{.*}}:16:11)
// CHECK-NEXT: #loc52 = loc({{.*}}:16:4)
// CHECK-EMPTY:
