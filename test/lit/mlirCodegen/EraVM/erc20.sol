...
// CHECK-NEXT:       %32 = llvm.inttoptr %c0_i256_13 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %32 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %33 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %33 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c0_i256_14 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_15 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%c0_i256_14, %c24_i256, %c2_i256_15) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     %15 = arith.cmpi slt, %3, %c64_i256_2 : i256 loc(#loc2)
// CHECK-NEXT:     scf.if %15 {
// CHECK-NEXT:       %c0_i256_13 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_14 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%c0_i256_13, %c0_i256_13, %c2_i256_14) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:     %18 = arith.addi %5, %c32_i256 : i256 loc(#loc2)
...
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %21 = arith.addi %18, %c32_i256_3 : i256 loc(#loc2)
// CHECK-NEXT:     call @_49(%17, %20) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %22 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %27 = llvm.getelementptr %26[%c0_i256_5] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%24, %27, %c0_i256_6) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %28 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c32_i256_7 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c32_i256_7, %28 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc2)
// CHECK-NEXT:     %29 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_8 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c0_i256_8, %29 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     %30 = arith.muli %c0_i256_9, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_10 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %31 = arith.addi %30, %c64_i256_10 : i256 loc(#loc2)
// CHECK-NEXT:     %c256_i256_11 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256_12 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     call @__return(%c256_i256_11, %31, %c2_i256_12) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     %c-32_i256_3 = arith.constant -32 : i256 loc(#loc176)
// CHECK-NEXT:     %18 = arith.andi %17, %c-32_i256_3 : i256 loc(#loc176)
...
// CHECK-NEXT:       %c32_i256_4 = arith.constant 32 : i256 loc(#loc176)
// CHECK-NEXT:       %24 = arith.muli %20, %c32_i256_4 : i256 loc(#loc176)
...
// CHECK-NEXT:     %c-32_i256_3 = arith.constant -32 : i256 loc(#loc1)
// CHECK-NEXT:     %18 = arith.andi %17, %c-32_i256_3 : i256 loc(#loc1)
...
// CHECK-NEXT:       %24 = arith.muli %20, %c32_i256_4 : i256 loc(#loc1)
...
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc187)
// CHECK-NEXT:     %7 = arith.addi %c3_i256, %c1_i256_1 : i256 loc(#loc187)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc187)
// CHECK-NEXT:     %8 = arith.addi %4, %c31_i256 : i256 loc(#loc187)
// CHECK-NEXT:     %c-32_i256 = arith.constant -32 : i256 loc(#loc187)
// CHECK-NEXT:     %9 = arith.andi %8, %c-32_i256 : i256 loc(#loc187)
// CHECK-NEXT:     %c0 = arith.constant 0 : index loc(#loc187)
// CHECK-NEXT:     %10 = arith.index_castui %9 : i256 to index loc(#loc187)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc187)
// CHECK-NEXT:     scf.for %arg2 = %c0 to %10 step %c1 {
// CHECK-NEXT:       %20 = arith.index_castui %arg2 : index to i256 loc(#loc187)
// CHECK-NEXT:       %c32_i256_8 = arith.constant 32 : i256 loc(#loc187)
// CHECK-NEXT:       %21 = arith.muli %20, %c32_i256_8 : i256 loc(#loc187)
// CHECK-NEXT:       %22 = arith.addi %6, %21 : i256 loc(#loc187)
// CHECK-NEXT:       %23 = llvm.inttoptr %22 : i256 to !llvm.ptr<1> loc(#loc187)
// CHECK-NEXT:       %24 = llvm.load %23 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc187)
// CHECK-NEXT:       %25 = arith.addi %7, %20 : i256 loc(#loc187)
// CHECK-NEXT:       %26 = llvm.inttoptr %25 : i256 to !llvm.ptr<5> loc(#loc187)
// CHECK-NEXT:       llvm.store %24, %26 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc187)
// CHECK-NEXT:     } loc(#loc187)
// CHECK-NEXT:     %c4_i256 = arith.constant 4 : i256 loc(#loc176)
// CHECK-NEXT:     %11 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc188)
// CHECK-NEXT:     %12 = llvm.inttoptr %11 : i256 to !llvm.ptr<1> loc(#loc189)
// CHECK-NEXT:     %13 = llvm.load %12 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc189)
// CHECK-NEXT:     %14 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<5> loc(#loc189)
// CHECK-NEXT:     llvm.store %13, %14 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc189)
// CHECK-NEXT:     %c32_i256_2 = arith.constant 32 : i256 loc(#loc189)
// CHECK-NEXT:     %15 = arith.addi %11, %c32_i256_2 : i256 loc(#loc189)
// CHECK-NEXT:     %c1_i256_3 = arith.constant 1 : i256 loc(#loc189)
// CHECK-NEXT:     %16 = arith.addi %c4_i256, %c1_i256_3 : i256 loc(#loc189)
// CHECK-NEXT:     %c31_i256_4 = arith.constant 31 : i256 loc(#loc189)
// CHECK-NEXT:     %17 = arith.addi %13, %c31_i256_4 : i256 loc(#loc189)
// CHECK-NEXT:     %c-32_i256_5 = arith.constant -32 : i256 loc(#loc189)
// CHECK-NEXT:     %18 = arith.andi %17, %c-32_i256_5 : i256 loc(#loc189)
// CHECK-NEXT:     %c0_6 = arith.constant 0 : index loc(#loc189)
// CHECK-NEXT:     %19 = arith.index_castui %18 : i256 to index loc(#loc189)
// CHECK-NEXT:     %c1_7 = arith.constant 1 : index loc(#loc189)
// CHECK-NEXT:     scf.for %arg2 = %c0_6 to %19 step %c1_7 {
// CHECK-NEXT:       %20 = arith.index_castui %arg2 : index to i256 loc(#loc189)
// CHECK-NEXT:       %c32_i256_8 = arith.constant 32 : i256 loc(#loc189)
// CHECK-NEXT:       %21 = arith.muli %20, %c32_i256_8 : i256 loc(#loc189)
// CHECK-NEXT:       %22 = arith.addi %15, %21 : i256 loc(#loc189)
// CHECK-NEXT:       %23 = llvm.inttoptr %22 : i256 to !llvm.ptr<1> loc(#loc189)
// CHECK-NEXT:       %24 = llvm.load %23 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc189)
// CHECK-NEXT:       %25 = arith.addi %16, %20 : i256 loc(#loc189)
// CHECK-NEXT:       %26 = llvm.inttoptr %25 : i256 to !llvm.ptr<5> loc(#loc189)
// CHECK-NEXT:       llvm.store %24, %26 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc189)
