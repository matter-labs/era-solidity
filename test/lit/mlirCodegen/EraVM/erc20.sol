...
// CHECK-NEXT:         %24 = func.call @approve_140(%17, %22) : (i256, i256) -> i1 loc(#loc2)
...
// CHECK-NEXT:         func.call @_approve_453(%17, %22, %27) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %28 = arith.addi %23, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %29 = func.call @transferFrom_186(%17, %22, %27) : (i256, i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %28 = arith.addi %23, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         func.call @_transfer_316(%17, %22, %27) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %29 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %30 = llvm.load %29 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_8 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = func.call @increaseAllowance_213(%17, %22) : (i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %25 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %26 = llvm.load %25 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         func.call @_mint_354(%17, %22) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         func.call @_burn_408(%17, %22) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %25 = llvm.load %24 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_8 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:         %19 = func.call @balanceOf_86(%17) : (i256) -> i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = func.call @decreaseAllowance_251(%17, %22) : (i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %25 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %26 = llvm.load %25 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = func.call @transfer_105(%17, %22) : (i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %25 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %26 = llvm.load %25 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %18, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = func.call @allowance_121(%17, %22) : (i256, i256) -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %25 = llvm.inttoptr %c64_i256_7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %26 = llvm.load %25 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
