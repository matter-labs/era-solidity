...
// CHECK: #loc2 = loc({{.*}}:6:0)
// CHECK-NEXT: #loc4 = loc({{.*}}:117:20)
// CHECK-NEXT: #loc5 = loc({{.*}}:117:35)
// CHECK-NEXT: #loc6 = loc({{.*}}:117:52)
// CHECK-NEXT: #loc17 = loc({{.*}}:105:17)
// CHECK-NEXT: #loc18 = loc({{.*}}:105:34)
// CHECK-NEXT: #loc31 = loc({{.*}}:89:21)
// CHECK-NEXT: #loc32 = loc({{.*}}:89:37)
// CHECK-NEXT: #loc33 = loc({{.*}}:89:56)
// CHECK-NEXT: #loc49 = loc({{.*}}:77:29)
// CHECK-NEXT: #loc50 = loc({{.*}}:77:46)
// CHECK-NEXT: #loc63 = loc({{.*}}:68:29)
// CHECK-NEXT: #loc64 = loc({{.*}}:68:46)
// CHECK-NEXT: #loc75 = loc({{.*}}:54:24)
// CHECK-NEXT: #loc76 = loc({{.*}}:54:40)
// CHECK-NEXT: #loc77 = loc({{.*}}:54:59)
// CHECK-NEXT: #loc94 = loc({{.*}}:49:19)
// CHECK-NEXT: #loc95 = loc({{.*}}:49:36)
// CHECK-NEXT: #loc103 = loc({{.*}}:45:21)
// CHECK-NEXT: #loc104 = loc({{.*}}:45:36)
// CHECK-NEXT: #loc110 = loc({{.*}}:40:20)
// CHECK-NEXT: #loc111 = loc({{.*}}:40:39)
// CHECK-NEXT: #loc119 = loc({{.*}}:36:21)
// CHECK-NEXT: module {
...
// CHECK-NEXT:         %27 = arith.subi %24, %22 : i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:         %31 = llvm.inttoptr %28 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         llvm.store %30, %31 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %32 = arith.subi %29, %27 : i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_10 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_approve_326.0(%arg0: i256 loc({{.*}}:117:20), %arg1: i256 loc({{.*}}:117:35), %arg2: i256 loc({{.*}}:117:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %c0_i256_8 = arith.constant 0 : i256 loc(#loc15)
// CHECK-NEXT:     %20 = arith.addi %19, %c0_i256_8 : i256 loc(#loc15)
// CHECK-NEXT:     %c32_i256_9 = arith.constant 32 : i256 loc(#loc15)
// CHECK-NEXT:     %21 = arith.addi %19, %c32_i256_9 : i256 loc(#loc15)
// CHECK-NEXT:     %22 = llvm.inttoptr %20 : i256 to !llvm.ptr<1> loc(#loc15)
// CHECK-NEXT:     llvm.store %17, %22 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc15)
// CHECK-NEXT:     %23 = arith.subi %21, %19 : i256 loc(#loc15)
...
// CHECK-NEXT:     %c2_i256_1 = arith.constant 2 : i256 loc(#loc19)
// CHECK-NEXT:     %3 = llvm.inttoptr %c2_i256_1 : i256 to !llvm.ptr<5> loc(#loc21)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc21)
// CHECK-NEXT:     %5 = arith.addi %4, %2 : i256 loc(#loc21)
// CHECK-NEXT:     %6 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc21)
// CHECK-NEXT:     llvm.store %5, %6 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc21)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %7 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc23)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc24)
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc24)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     llvm.store %c0_i256, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc24)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc24)
// CHECK-NEXT:     %12 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc25)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %13 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc23)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc24)
// CHECK-NEXT:     %14 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc24)
...
// CHECK-NEXT:     %15 = llvm.inttoptr %c32_i256_5 : i256 to !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     llvm.store %c0_i256_3, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     %c64_i256_6 = arith.constant 64 : i256 loc(#loc24)
// CHECK-NEXT:     %16 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc24)
// CHECK-NEXT:     %false_7 = arith.constant false loc(#loc)
// CHECK-NEXT:     %17 = call @__sha3(%16, %c64_i256_6, %false_7) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc24)
// CHECK-NEXT:     %18 = llvm.inttoptr %17 : i256 to !llvm.ptr<5> loc(#loc24)
// CHECK-NEXT:     %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc24)
// CHECK-NEXT:     %20 = arith.addi %19, %12 : i256 loc(#loc24)
// CHECK-NEXT:     %21 = llvm.inttoptr %11 : i256 to !llvm.ptr<5> loc(#loc24)
// CHECK-NEXT:     llvm.store %20, %21 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc24)
// CHECK-NEXT:     %c0_i8 = arith.constant 0 : i8 loc(#loc26)
// CHECK-NEXT:     %22 = arith.extui %c0_i8 : i8 to i256 loc(#loc26)
// CHECK-NEXT:     %23 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc27)
// CHECK-NEXT:     %24 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc28)
// CHECK-NEXT:     %c64_i256_8 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %25 = llvm.inttoptr %c64_i256_8 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %26 = llvm.load %25 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc29)
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:     %27 = arith.addi %26, %c0_i256_9 : i256 loc(#loc29)
// CHECK-NEXT:     %c32_i256_10 = arith.constant 32 : i256 loc(#loc29)
// CHECK-NEXT:     %28 = arith.addi %26, %c32_i256_10 : i256 loc(#loc29)
// CHECK-NEXT:     %29 = llvm.inttoptr %27 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %24, %29 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %30 = arith.subi %28, %26 : i256 loc(#loc29)
// CHECK-NEXT:     %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256 = arith.constant 51735811207051471423543085523402233001646248530043601449996937859018943444521 : i256 loc(#loc29)
// CHECK-NEXT:     %c4294967295_i256 = arith.constant 4294967295 : i256 loc(#loc29)
// CHECK-NEXT:     %c1_i64 = arith.constant 1 : i64 loc(#loc29)
// CHECK-NEXT:     %31 = llvm.alloca %c1_i64 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     llvm.store %c4294967295_i256, %31 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %32 = arith.cmpi ule, %26, %c4294967295_i256 : i256 loc(#loc29)
// CHECK-NEXT:     scf.if %32 {
// CHECK-NEXT:       llvm.store %26, %31 : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     } loc(#loc29)
// CHECK-NEXT:     %33 = llvm.load %31 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %c4294967295_i256_11 = arith.constant 4294967295 : i256 loc(#loc29)
// CHECK-NEXT:     %c1_i64_12 = arith.constant 1 : i64 loc(#loc29)
// CHECK-NEXT:     %34 = llvm.alloca %c1_i64_12 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     llvm.store %c4294967295_i256_11, %34 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %35 = arith.cmpi ule, %30, %c4294967295_i256_11 : i256 loc(#loc29)
// CHECK-NEXT:     scf.if %35 {
// CHECK-NEXT:       llvm.store %30, %34 : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     } loc(#loc29)
// CHECK-NEXT:     %36 = llvm.load %34 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %37 = "llvm.intrcall"() <{id = 3176 : i32, name = "eravm.gasleft"}> : () -> i256 loc(#loc29)
// CHECK-NEXT:     %c4294967295_i256_13 = arith.constant 4294967295 : i256 loc(#loc29)
// CHECK-NEXT:     %c1_i64_14 = arith.constant 1 : i64 loc(#loc29)
// CHECK-NEXT:     %38 = llvm.alloca %c1_i64_14 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     llvm.store %c4294967295_i256_13, %38 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %39 = arith.cmpi ule, %37, %c4294967295_i256_13 : i256 loc(#loc29)
// CHECK-NEXT:     scf.if %39 {
// CHECK-NEXT:       llvm.store %37, %38 : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     } loc(#loc29)
// CHECK-NEXT:     %40 = llvm.load %38 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc29)
// CHECK-NEXT:     %c64_i256_15 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %41 = arith.shli %33, %c64_i256_15 : i256 loc(#loc29)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc29)
// CHECK-NEXT:     %42 = arith.shli %36, %c96_i256 : i256 loc(#loc29)
// CHECK-NEXT:     %c192_i256 = arith.constant 192 : i256 loc(#loc29)
// CHECK-NEXT:     %43 = arith.shli %40, %c192_i256 : i256 loc(#loc29)
// CHECK-NEXT:     %44 = arith.addi %41, %42 : i256 loc(#loc29)
// CHECK-NEXT:     %45 = arith.addi %44, %43 : i256 loc(#loc29)
// CHECK-NEXT:     %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 = arith.constant 904625697166532776746648320380374280103671755200316906558262375061821325312 : i256 loc(#loc29)
// CHECK-NEXT:     %46 = arith.addi %45, %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 : i256 loc(#loc29)
// CHECK-NEXT:     %c32781_i256 = arith.constant 32781 : i256 loc(#loc29)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc29)
// CHECK-NEXT:     %47 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %48 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %49 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %50 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %51 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %52 = llvm.mlir.undef : i256 loc(#loc29)
// CHECK-NEXT:     %53:2 = call @__farcall(%46, %c32781_i256, %c3_i256, %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256, %22, %23, %47, %48, %49, %50, %51, %52) : (i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256) -> (!llvm.ptr<3>, i1) loc(#loc29)
// CHECK-NEXT:     %false_16 = arith.constant false loc(#loc29)
// CHECK-NEXT:     %54 = arith.cmpi eq, %53#1, %false_16 : i1 loc(#loc29)
// CHECK-NEXT:     scf.if %54 {
// CHECK-NEXT:       %c0_i256_17 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:       %c0_i256_18 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:       %c2_i256_19 = arith.constant 2 : i256 loc(#loc29)
// CHECK-NEXT:       func.call @__revert(%c0_i256_17, %c0_i256_18, %c2_i256_19) : (i256, i256, i256) -> () loc(#loc29)
...
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc33)
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256_1 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc33)
// CHECK-NEXT:     llvm.store %arg2, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc33)
// CHECK-NEXT:     %c1_i256_2 = arith.constant 1 : i256 loc(#loc34)
// CHECK-NEXT:     %3 = llvm.alloca %c1_i256_2 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %4 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc35)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc36)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     llvm.store %4, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc36)
// CHECK-NEXT:     %6 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     llvm.store %c0_i256, %6 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc36)
// CHECK-NEXT:     %7 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc36)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %8 = call @__sha3(%7, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc36)
// CHECK-NEXT:     %9 = llvm.inttoptr %8 : i256 to !llvm.ptr<5> loc(#loc36)
// CHECK-NEXT:     %10 = llvm.load %9 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc36)
// CHECK-NEXT:     llvm.store %10, %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc37)
// CHECK-NEXT:     %c0_i256_5 = arith.constant 0 : i256 loc(#loc38)
// CHECK-NEXT:     %12 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc38)
// CHECK-NEXT:     llvm.store %11, %12 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc38)
// CHECK-NEXT:     %c32_i256_6 = arith.constant 32 : i256 loc(#loc38)
// CHECK-NEXT:     %13 = llvm.inttoptr %c32_i256_6 : i256 to !llvm.ptr<1> loc(#loc38)
// CHECK-NEXT:     llvm.store %c0_i256_4, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc38)
// CHECK-NEXT:     %c64_i256_7 = arith.constant 64 : i256 loc(#loc38)
// CHECK-NEXT:     %14 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc38)
// CHECK-NEXT:     %false_8 = arith.constant false loc(#loc)
// CHECK-NEXT:     %15 = call @__sha3(%14, %c64_i256_7, %false_8) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc38)
// CHECK-NEXT:     %16 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc39)
// CHECK-NEXT:     %17 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc40)
// CHECK-NEXT:     %18 = arith.subi %16, %17 : i256 loc(#loc39)
// CHECK-NEXT:     %19 = llvm.inttoptr %15 : i256 to !llvm.ptr<5> loc(#loc38)
// CHECK-NEXT:     llvm.store %18, %19 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc38)
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %20 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc41)
// CHECK-NEXT:     %c0_i256_10 = arith.constant 0 : i256 loc(#loc42)
// CHECK-NEXT:     %21 = llvm.inttoptr %c0_i256_10 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     llvm.store %20, %21 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %c32_i256_11 = arith.constant 32 : i256 loc(#loc42)
// CHECK-NEXT:     %22 = llvm.inttoptr %c32_i256_11 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     llvm.store %c0_i256_9, %22 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %c64_i256_12 = arith.constant 64 : i256 loc(#loc42)
// CHECK-NEXT:     %23 = llvm.inttoptr %c0_i256_10 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %false_13 = arith.constant false loc(#loc)
// CHECK-NEXT:     %24 = call @__sha3(%23, %c64_i256_12, %false_13) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc42)
// CHECK-NEXT:     %25 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc43)
// CHECK-NEXT:     %c0_i256_14 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %26 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc41)
// CHECK-NEXT:     %c0_i256_15 = arith.constant 0 : i256 loc(#loc42)
// CHECK-NEXT:     %27 = llvm.inttoptr %c0_i256_15 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     llvm.store %26, %27 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %c32_i256_16 = arith.constant 32 : i256 loc(#loc42)
// CHECK-NEXT:     %28 = llvm.inttoptr %c32_i256_16 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     llvm.store %c0_i256_14, %28 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %c64_i256_17 = arith.constant 64 : i256 loc(#loc42)
// CHECK-NEXT:     %29 = llvm.inttoptr %c0_i256_15 : i256 to !llvm.ptr<1> loc(#loc42)
// CHECK-NEXT:     %false_18 = arith.constant false loc(#loc)
// CHECK-NEXT:     %30 = call @__sha3(%29, %c64_i256_17, %false_18) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc42)
// CHECK-NEXT:     %31 = llvm.inttoptr %30 : i256 to !llvm.ptr<5> loc(#loc42)
// CHECK-NEXT:     %32 = llvm.load %31 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc42)
// CHECK-NEXT:     %33 = arith.addi %32, %25 : i256 loc(#loc42)
// CHECK-NEXT:     %34 = llvm.inttoptr %24 : i256 to !llvm.ptr<5> loc(#loc42)
// CHECK-NEXT:     llvm.store %33, %34 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc42)
// CHECK-NEXT:     %35 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc44)
// CHECK-NEXT:     %36 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc45)
// CHECK-NEXT:     %37 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc46)
// CHECK-NEXT:     %c64_i256_19 = arith.constant 64 : i256 loc(#loc47)
// CHECK-NEXT:     %38 = llvm.inttoptr %c64_i256_19 : i256 to !llvm.ptr<1> loc(#loc47)
// CHECK-NEXT:     %39 = llvm.load %38 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc47)
// CHECK-NEXT:     %c0_i256_20 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:     %40 = arith.addi %39, %c0_i256_20 : i256 loc(#loc47)
// CHECK-NEXT:     %c32_i256_21 = arith.constant 32 : i256 loc(#loc47)
// CHECK-NEXT:     %41 = arith.addi %39, %c32_i256_21 : i256 loc(#loc47)
// CHECK-NEXT:     %42 = llvm.inttoptr %40 : i256 to !llvm.ptr<1> loc(#loc47)
// CHECK-NEXT:     llvm.store %37, %42 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc47)
// CHECK-NEXT:     %43 = arith.subi %41, %39 : i256 loc(#loc47)
// CHECK-NEXT:     %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256 = arith.constant 51735811207051471423543085523402233001646248530043601449996937859018943444521 : i256 loc(#loc47)
// CHECK-NEXT:     %c4294967295_i256 = arith.constant 4294967295 : i256 loc(#loc47)
// CHECK-NEXT:     %c1_i64 = arith.constant 1 : i64 loc(#loc47)
// CHECK-NEXT:     %44 = llvm.alloca %c1_i64 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     llvm.store %c4294967295_i256, %44 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %45 = arith.cmpi ule, %39, %c4294967295_i256 : i256 loc(#loc47)
// CHECK-NEXT:     scf.if %45 {
// CHECK-NEXT:       llvm.store %39, %44 : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     } loc(#loc47)
// CHECK-NEXT:     %46 = llvm.load %44 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %c4294967295_i256_22 = arith.constant 4294967295 : i256 loc(#loc47)
// CHECK-NEXT:     %c1_i64_23 = arith.constant 1 : i64 loc(#loc47)
// CHECK-NEXT:     %47 = llvm.alloca %c1_i64_23 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     llvm.store %c4294967295_i256_22, %47 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %48 = arith.cmpi ule, %43, %c4294967295_i256_22 : i256 loc(#loc47)
// CHECK-NEXT:     scf.if %48 {
// CHECK-NEXT:       llvm.store %43, %47 : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     } loc(#loc47)
// CHECK-NEXT:     %49 = llvm.load %47 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %50 = "llvm.intrcall"() <{id = 3176 : i32, name = "eravm.gasleft"}> : () -> i256 loc(#loc47)
// CHECK-NEXT:     %c4294967295_i256_24 = arith.constant 4294967295 : i256 loc(#loc47)
// CHECK-NEXT:     %c1_i64_25 = arith.constant 1 : i64 loc(#loc47)
// CHECK-NEXT:     %51 = llvm.alloca %c1_i64_25 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     llvm.store %c4294967295_i256_24, %51 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %52 = arith.cmpi ule, %50, %c4294967295_i256_24 : i256 loc(#loc47)
// CHECK-NEXT:     scf.if %52 {
// CHECK-NEXT:       llvm.store %50, %51 : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     } loc(#loc47)
// CHECK-NEXT:     %53 = llvm.load %51 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc47)
// CHECK-NEXT:     %c64_i256_26 = arith.constant 64 : i256 loc(#loc47)
// CHECK-NEXT:     %54 = arith.shli %46, %c64_i256_26 : i256 loc(#loc47)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc47)
// CHECK-NEXT:     %55 = arith.shli %49, %c96_i256 : i256 loc(#loc47)
// CHECK-NEXT:     %c192_i256 = arith.constant 192 : i256 loc(#loc47)
// CHECK-NEXT:     %56 = arith.shli %53, %c192_i256 : i256 loc(#loc47)
// CHECK-NEXT:     %57 = arith.addi %54, %55 : i256 loc(#loc47)
// CHECK-NEXT:     %58 = arith.addi %57, %56 : i256 loc(#loc47)
// CHECK-NEXT:     %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 = arith.constant 904625697166532776746648320380374280103671755200316906558262375061821325312 : i256 loc(#loc47)
// CHECK-NEXT:     %59 = arith.addi %58, %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 : i256 loc(#loc47)
// CHECK-NEXT:     %c32781_i256 = arith.constant 32781 : i256 loc(#loc47)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc47)
// CHECK-NEXT:     %60 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %61 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %62 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %63 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %64 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %65 = llvm.mlir.undef : i256 loc(#loc47)
// CHECK-NEXT:     %66:2 = call @__farcall(%59, %c32781_i256, %c3_i256, %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256, %35, %36, %60, %61, %62, %63, %64, %65) : (i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256) -> (!llvm.ptr<3>, i1) loc(#loc47)
// CHECK-NEXT:     %false_27 = arith.constant false loc(#loc47)
// CHECK-NEXT:     %67 = arith.cmpi eq, %66#1, %false_27 : i1 loc(#loc47)
// CHECK-NEXT:     scf.if %67 {
// CHECK-NEXT:       %c0_i256_28 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc47)
// CHECK-NEXT:       func.call @__revert(%c0_i256_28, %c0_i256_29, %c2_i256) : (i256, i256, i256) -> () loc(#loc47)
...
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc49)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc49)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc49)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc50)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc50)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc50)
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc51)
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256_1 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc51)
// CHECK-NEXT:     %c1_i256_2 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %3 = call @_msgSender_42.0() : () -> i256 loc(#loc52)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc53)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     llvm.store %3, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc53)
// CHECK-NEXT:     %5 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     llvm.store %c1_i256_2, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc53)
// CHECK-NEXT:     %6 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %7 = call @__sha3(%6, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc53)
// CHECK-NEXT:     %8 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc54)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc53)
// CHECK-NEXT:     %9 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     llvm.store %8, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %c32_i256_4 = arith.constant 32 : i256 loc(#loc53)
// CHECK-NEXT:     %10 = llvm.inttoptr %c32_i256_4 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     llvm.store %7, %10 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %c64_i256_5 = arith.constant 64 : i256 loc(#loc53)
// CHECK-NEXT:     %11 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %false_6 = arith.constant false loc(#loc)
// CHECK-NEXT:     %12 = call @__sha3(%11, %c64_i256_5, %false_6) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc53)
// CHECK-NEXT:     %13 = llvm.inttoptr %12 : i256 to !llvm.ptr<5> loc(#loc53)
// CHECK-NEXT:     %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc53)
// CHECK-NEXT:     llvm.store %14, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc51)
// CHECK-NEXT:     %15 = call @_msgSender_42.0() : () -> i256 loc(#loc55)
// CHECK-NEXT:     %16 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc56)
// CHECK-NEXT:     %17 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc57)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc58)
// CHECK-NEXT:     %19 = arith.subi %17, %18 : i256 loc(#loc57)
// CHECK-NEXT:     call @_approve_326(%15, %16, %19) : (i256, i256, i256) -> () loc(#loc59)
// CHECK-NEXT:     %true = arith.constant true loc(#loc60)
// CHECK-NEXT:     return %true : i1 loc(#loc61)
...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc63)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc63)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc64)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc64)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc64)
// CHECK-NEXT:     %2 = call @_msgSender_42.0() : () -> i256 loc(#loc65)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc66)
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %4 = call @_msgSender_42.0() : () -> i256 loc(#loc67)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc68)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     llvm.store %4, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc68)
// CHECK-NEXT:     %6 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     llvm.store %c1_i256_1, %6 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc68)
// CHECK-NEXT:     %7 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %8 = call @__sha3(%7, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc68)
// CHECK-NEXT:     %9 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc69)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc68)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     llvm.store %9, %10 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc68)
// CHECK-NEXT:     %11 = llvm.inttoptr %c32_i256_3 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     llvm.store %8, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc68)
// CHECK-NEXT:     %12 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %false_5 = arith.constant false loc(#loc)
// CHECK-NEXT:     %13 = call @__sha3(%12, %c64_i256_4, %false_5) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc68)
// CHECK-NEXT:     %14 = llvm.inttoptr %13 : i256 to !llvm.ptr<5> loc(#loc68)
// CHECK-NEXT:     %15 = llvm.load %14 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc68)
// CHECK-NEXT:     %16 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc70)
// CHECK-NEXT:     %17 = arith.addi %15, %16 : i256 loc(#loc68)
// CHECK-NEXT:     call @_approve_326(%2, %3, %17) : (i256, i256, i256) -> () loc(#loc71)
// CHECK-NEXT:     %true = arith.constant true loc(#loc72)
// CHECK-NEXT:     return %true : i1 loc(#loc73)
...
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc75)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc75)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc75)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc76)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc76)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc76)
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc77)
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256_1 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc77)
// CHECK-NEXT:     llvm.store %arg2, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc77)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc78)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc79)
// CHECK-NEXT:     %5 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc80)
// CHECK-NEXT:     call @_transfer_274(%3, %4, %5) : (i256, i256, i256) -> () loc(#loc81)
// CHECK-NEXT:     %c1_i256_2 = arith.constant 1 : i256 loc(#loc82)
// CHECK-NEXT:     %6 = llvm.alloca %c1_i256_2 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc82)
...
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc84)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     llvm.store %c1_i256_3, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc84)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc84)
// CHECK-NEXT:     %12 = call @_msgSender_42.0() : () -> i256 loc(#loc85)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc84)
// CHECK-NEXT:     %13 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     llvm.store %12, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %c32_i256_5 = arith.constant 32 : i256 loc(#loc84)
// CHECK-NEXT:     %14 = llvm.inttoptr %c32_i256_5 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     llvm.store %11, %14 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %c64_i256_6 = arith.constant 64 : i256 loc(#loc84)
// CHECK-NEXT:     %15 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %false_7 = arith.constant false loc(#loc)
// CHECK-NEXT:     %16 = call @__sha3(%15, %c64_i256_6, %false_7) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc84)
// CHECK-NEXT:     %17 = llvm.inttoptr %16 : i256 to !llvm.ptr<5> loc(#loc84)
// CHECK-NEXT:     %18 = llvm.load %17 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc84)
// CHECK-NEXT:     llvm.store %18, %6 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc82)
// CHECK-NEXT:     %19 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc86)
// CHECK-NEXT:     %20 = call @_msgSender_42.0() : () -> i256 loc(#loc87)
// CHECK-NEXT:     %21 = llvm.load %6 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc88)
// CHECK-NEXT:     %22 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc89)
// CHECK-NEXT:     %23 = arith.subi %21, %22 : i256 loc(#loc88)
// CHECK-NEXT:     call @_approve_326(%19, %20, %23) : (i256, i256, i256) -> () loc(#loc90)
// CHECK-NEXT:     %true = arith.constant true loc(#loc91)
// CHECK-NEXT:     return %true : i1 loc(#loc92)
...
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc95)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc95)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc95)
// CHECK-NEXT:     %2 = call @_msgSender_42.0() : () -> i256 loc(#loc96)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc97)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc98)
// CHECK-NEXT:     call @_approve_326(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc99)
// CHECK-NEXT:     %true = arith.constant true loc(#loc100)
// CHECK-NEXT:     return %true : i1 loc(#loc101)
...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc103)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc103)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc104)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc104)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc104)
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %2 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc105)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc106)
// CHECK-NEXT:     %3 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     llvm.store %2, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc106)
// CHECK-NEXT:     %4 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     llvm.store %c1_i256_1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc106)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %6 = call @__sha3(%5, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc106)
// CHECK-NEXT:     %7 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc107)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc106)
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc106)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256_3 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     llvm.store %6, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc106)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc106)
// CHECK-NEXT:     %false_5 = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256_4, %false_5) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc106)
// CHECK-NEXT:     %12 = llvm.inttoptr %11 : i256 to !llvm.ptr<5> loc(#loc106)
// CHECK-NEXT:     %13 = llvm.load %12 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc106)
// CHECK-NEXT:     return %13 : i256 loc(#loc108)
...
// CHECK-NEXT:     call @_transfer_274(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc115)
...
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc22)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc120)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc121)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc121)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc121)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc121)
// CHECK-NEXT:     %3 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc121)
// CHECK-NEXT:     llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc121)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc121)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc121)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %5 = call @__sha3(%4, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc121)
// CHECK-NEXT:     %6 = llvm.inttoptr %5 : i256 to !llvm.ptr<5> loc(#loc121)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc121)
// CHECK-NEXT:     return %7 : i256 loc(#loc122)
...
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc19)
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc124)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc124)
// CHECK-NEXT:     return %1 : i256 loc(#loc125)
...
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc127)
// CHECK-NEXT:     %0 = arith.extui %c18_i8 : i8 to i256 loc(#loc127)
// CHECK-NEXT:     return %0 : i256 loc(#loc128)
...
// CHECK-NEXT:     %c4_i256 = arith.constant 4 : i256 loc(#loc130)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc130)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     llvm.store %c4_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc130)
// CHECK-NEXT:     %1 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %2 = call @__sha3(%1, %c32_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc130)
// CHECK-NEXT:     %3 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<5> loc(#loc130)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc130)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc130)
// CHECK-NEXT:     %5 = arith.addi %4, %c31_i256 : i256 loc(#loc130)
// CHECK-NEXT:     %c4294967264_i256 = arith.constant 4294967264 : i256 loc(#loc130)
// CHECK-NEXT:     %6 = arith.andi %5, %c4294967264_i256 : i256 loc(#loc130)
// CHECK-NEXT:     %c32_i256_0 = arith.constant 32 : i256 loc(#loc130)
// CHECK-NEXT:     %7 = arith.addi %6, %c32_i256_0 : i256 loc(#loc130)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc130)
// CHECK-NEXT:     %8 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     %9 = llvm.load %8 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc130)
// CHECK-NEXT:     %10 = arith.addi %9, %7 : i256 loc(#loc130)
// CHECK-NEXT:     %c18446744073709551615_i256 = arith.constant 18446744073709551615 : i256 loc(#loc130)
// CHECK-NEXT:     %11 = arith.cmpi ugt, %10, %c18446744073709551615_i256 : i256 loc(#loc130)
// CHECK-NEXT:     %12 = arith.cmpi ult, %10, %9 : i256 loc(#loc130)
// CHECK-NEXT:     %13 = arith.ori %11, %12 : i1 loc(#loc130)
// CHECK-NEXT:     scf.if %13 {
// CHECK-NEXT:       %c0_i256_4 = arith.constant 0 : i256 loc(#loc130)
// CHECK-NEXT:       %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc130)
// CHECK-NEXT:       %19 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc130)
...
// CHECK-NEXT:       %c4_i256_5 = arith.constant 4 : i256 loc(#loc130)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc130)
// CHECK-NEXT:       %20 = llvm.inttoptr %c4_i256_5 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:       llvm.store %c65_i256, %20 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc130)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc130)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc130)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc130)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc130)
// CHECK-NEXT:     } loc(#loc130)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc130)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     llvm.store %10, %14 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     %15 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     llvm.store %4, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     %c31_i256_2 = arith.constant 31 : i256 loc(#loc130)
// CHECK-NEXT:     %16 = arith.addi %4, %c31_i256_2 : i256 loc(#loc130)
// CHECK-NEXT:     %c4294967264_i256_3 = arith.constant 4294967264 : i256 loc(#loc130)
// CHECK-NEXT:     %17 = arith.andi %16, %c4294967264_i256_3 : i256 loc(#loc130)
// CHECK-NEXT:     %c0 = arith.constant 0 : index loc(#loc130)
// CHECK-NEXT:     %18 = arith.index_castui %17 : i256 to index loc(#loc130)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc130)
// CHECK-NEXT:     scf.for %arg0 = %c0 to %18 step %c1 {
// CHECK-NEXT:       %19 = arith.index_castui %arg0 : index to i256 loc(#loc130)
// CHECK-NEXT:       %20 = arith.addi %2, %19 : i256 loc(#loc130)
// CHECK-NEXT:       %21 = llvm.inttoptr %20 : i256 to !llvm.ptr<5> loc(#loc130)
// CHECK-NEXT:       %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc130)
// CHECK-NEXT:       %c32_i256_4 = arith.constant 32 : i256 loc(#loc130)
// CHECK-NEXT:       %23 = arith.muli %19, %c32_i256_4 : i256 loc(#loc130)
// CHECK-NEXT:       %24 = arith.addi %9, %23 : i256 loc(#loc130)
// CHECK-NEXT:       %25 = llvm.inttoptr %24 : i256 to !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:       llvm.store %22, %25 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc130)
// CHECK-NEXT:     } loc(#loc130)
// CHECK-NEXT:     return %9 : i256 loc(#loc131)
...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     return %9 : i256 loc(#loc133)
...
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3170 : i32, name = "eravm.caller"}> : () -> i256 loc(#loc135)
// CHECK-NEXT:     return %0 : i256 loc(#loc136)
...
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc130)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc130)
// CHECK-NEXT:       %c0_i256_7 = arith.constant 0 : i256 loc(#loc130)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc130)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc130)
// CHECK-NEXT:     } loc(#loc130)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc130)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc130)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc95)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc95)
// CHECK-NEXT:     %2 = call @_msgSender_42() : () -> i256 loc(#loc96)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc97)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc98)
// CHECK-NEXT:     call @_approve_326(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc99)
// CHECK-NEXT:     %true = arith.constant true loc(#loc100)
...
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc84)
// CHECK-NEXT:     %12 = call @_msgSender_42() : () -> i256 loc(#loc85)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc84)
// CHECK-NEXT:     %13 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     llvm.store %12, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc84)
// CHECK-NEXT:     %c32_i256_5 = arith.constant 32 : i256 loc(#loc84)
...
// CHECK-NEXT:     llvm.store %18, %6 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc82)
// CHECK-NEXT:     %19 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc86)
// CHECK-NEXT:     %20 = call @_msgSender_42() : () -> i256 loc(#loc87)
// CHECK-NEXT:     %21 = llvm.load %6 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc88)
// CHECK-NEXT:     %22 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc89)
// CHECK-NEXT:     %23 = arith.subi %21, %22 : i256 loc(#loc88)
// CHECK-NEXT:     call @_approve_326(%19, %20, %23) : (i256, i256, i256) -> () loc(#loc90)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc64)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc64)
// CHECK-NEXT:     %2 = call @_msgSender_42() : () -> i256 loc(#loc65)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc66)
// CHECK-NEXT:     %c1_i256_1 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %4 = call @_msgSender_42() : () -> i256 loc(#loc67)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc68)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     llvm.store %4, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc68)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc68)
...
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256_1 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc51)
// CHECK-NEXT:     %c1_i256_2 = arith.constant 1 : i256 loc(#loc7)
// CHECK-NEXT:     %3 = call @_msgSender_42() : () -> i256 loc(#loc52)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc53)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     llvm.store %3, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc53)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc53)
...
// CHECK-NEXT:     %14 = llvm.load %13 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc53)
// CHECK-NEXT:     llvm.store %14, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc51)
// CHECK-NEXT:     %15 = call @_msgSender_42() : () -> i256 loc(#loc55)
// CHECK-NEXT:     %16 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc56)
// CHECK-NEXT:     %17 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc57)
// CHECK-NEXT:     %18 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc58)
// CHECK-NEXT:     %19 = arith.subi %17, %18 : i256 loc(#loc57)
...
// CHECK-NEXT:       %c0_i256_28 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:       %c0_i256_30 = arith.constant 0 : i256 loc(#loc47)
// CHECK-NEXT:       func.call @__revert(%c0_i256_28, %c0_i256_29, %c0_i256_30) : (i256, i256, i256) -> () loc(#loc47)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc47)
// CHECK-NEXT:     } loc(#loc47)
// CHECK-NEXT:     return loc(#loc30)
// CHECK-NEXT:   } loc(#loc30)
...
// CHECK-NEXT:       %c0_i256_17 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:       %c0_i256_18 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:       %c0_i256_19 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:       func.call @__revert(%c0_i256_17, %c0_i256_18, %c0_i256_19) : (i256, i256, i256) -> () loc(#loc29)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc29)
// CHECK-NEXT:     } loc(#loc29)
// CHECK-NEXT:     return loc(#loc16)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @_approve_326(%arg0: i256 loc({{.*}}:117:20), %arg1: i256 loc({{.*}}:117:35), %arg2: i256 loc({{.*}}:117:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc5)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:117:2)
// CHECK-NEXT: #loc7 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc8 = loc({{.*}}:122:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:122:4)
// CHECK-NEXT: #loc10 = loc({{.*}}:122:23)
// CHECK-NEXT: #loc11 = loc({{.*}}:122:34)
// CHECK-NEXT: #loc12 = loc({{.*}}:123:18)
// CHECK-NEXT: #loc13 = loc({{.*}}:123:25)
// CHECK-NEXT: #loc14 = loc({{.*}}:123:34)
// CHECK-NEXT: #loc15 = loc({{.*}}:123:9)
// CHECK-NEXT: #loc16 = loc({{.*}}:105:2)
// CHECK-NEXT: #loc19 = loc({{.*}}:9:2)
// CHECK-NEXT: #loc20 = loc({{.*}}:111:22)
// CHECK-NEXT: #loc21 = loc({{.*}}:111:6)
// CHECK-NEXT: #loc22 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc23 = loc({{.*}}:112:16)
// CHECK-NEXT: #loc24 = loc({{.*}}:112:6)
// CHECK-NEXT: #loc25 = loc({{.*}}:112:28)
// CHECK-NEXT: #loc26 = loc({{.*}}:114:26)
// CHECK-NEXT: #loc27 = loc({{.*}}:114:30)
// CHECK-NEXT: #loc28 = loc({{.*}}:114:39)
// CHECK-NEXT: #loc29 = loc({{.*}}:114:9)
// CHECK-NEXT: #loc30 = loc({{.*}}:89:2)
// CHECK-NEXT: #loc34 = loc({{.*}}:94:4)
// CHECK-NEXT: #loc35 = loc({{.*}}:94:38)
// CHECK-NEXT: #loc36 = loc({{.*}}:94:28)
// CHECK-NEXT: #loc37 = loc({{.*}}:98:16)
// CHECK-NEXT: #loc38 = loc({{.*}}:98:6)
// CHECK-NEXT: #loc39 = loc({{.*}}:98:26)
// CHECK-NEXT: #loc40 = loc({{.*}}:98:42)
// CHECK-NEXT: #loc41 = loc({{.*}}:100:16)
// CHECK-NEXT: #loc42 = loc({{.*}}:100:6)
// CHECK-NEXT: #loc43 = loc({{.*}}:100:30)
// CHECK-NEXT: #loc44 = loc({{.*}}:102:18)
// CHECK-NEXT: #loc45 = loc({{.*}}:102:26)
// CHECK-NEXT: #loc46 = loc({{.*}}:102:37)
// CHECK-NEXT: #loc47 = loc({{.*}}:102:9)
// CHECK-NEXT: #loc48 = loc({{.*}}:77:2)
// CHECK-NEXT: #loc51 = loc({{.*}}:79:4)
// CHECK-NEXT: #loc52 = loc({{.*}}:79:43)
// CHECK-NEXT: #loc53 = loc({{.*}}:79:31)
// CHECK-NEXT: #loc54 = loc({{.*}}:79:57)
// CHECK-NEXT: #loc55 = loc({{.*}}:83:15)
// CHECK-NEXT: #loc56 = loc({{.*}}:83:29)
// CHECK-NEXT: #loc57 = loc({{.*}}:83:38)
// CHECK-NEXT: #loc58 = loc({{.*}}:83:57)
// CHECK-NEXT: #loc59 = loc({{.*}}:83:6)
// CHECK-NEXT: #loc60 = loc({{.*}}:86:11)
// CHECK-NEXT: #loc61 = loc({{.*}}:86:4)
// CHECK-NEXT: #loc62 = loc({{.*}}:68:2)
// CHECK-NEXT: #loc65 = loc({{.*}}:72:13)
// CHECK-NEXT: #loc66 = loc({{.*}}:72:27)
// CHECK-NEXT: #loc67 = loc({{.*}}:72:48)
// CHECK-NEXT: #loc68 = loc({{.*}}:72:36)
// CHECK-NEXT: #loc69 = loc({{.*}}:72:62)
// CHECK-NEXT: #loc70 = loc({{.*}}:72:73)
// CHECK-NEXT: #loc71 = loc({{.*}}:72:4)
// CHECK-NEXT: #loc72 = loc({{.*}}:74:11)
// CHECK-NEXT: #loc73 = loc({{.*}}:74:4)
// CHECK-NEXT: #loc74 = loc({{.*}}:54:2)
// CHECK-NEXT: #loc78 = loc({{.*}}:56:14)
// CHECK-NEXT: #loc79 = loc({{.*}}:56:22)
// CHECK-NEXT: #loc80 = loc({{.*}}:56:33)
// CHECK-NEXT: #loc81 = loc({{.*}}:56:4)
// CHECK-NEXT: #loc82 = loc({{.*}}:58:4)
// CHECK-NEXT: #loc83 = loc({{.*}}:58:43)
// CHECK-NEXT: #loc84 = loc({{.*}}:58:31)
// CHECK-NEXT: #loc85 = loc({{.*}}:58:51)
// CHECK-NEXT: #loc86 = loc({{.*}}:62:15)
// CHECK-NEXT: #loc87 = loc({{.*}}:62:23)
// CHECK-NEXT: #loc88 = loc({{.*}}:62:37)
// CHECK-NEXT: #loc89 = loc({{.*}}:62:56)
// CHECK-NEXT: #loc90 = loc({{.*}}:62:6)
// CHECK-NEXT: #loc91 = loc({{.*}}:65:11)
// CHECK-NEXT: #loc92 = loc({{.*}}:65:4)
// CHECK-NEXT: #loc93 = loc({{.*}}:49:2)
// CHECK-NEXT: #loc96 = loc({{.*}}:50:13)
// CHECK-NEXT: #loc97 = loc({{.*}}:50:27)
// CHECK-NEXT: #loc98 = loc({{.*}}:50:36)
// CHECK-NEXT: #loc99 = loc({{.*}}:50:4)
// CHECK-NEXT: #loc100 = loc({{.*}}:51:11)
// CHECK-NEXT: #loc101 = loc({{.*}}:51:4)
// CHECK-NEXT: #loc102 = loc({{.*}}:45:2)
// CHECK-NEXT: #loc105 = loc({{.*}}:46:23)
// CHECK-NEXT: #loc106 = loc({{.*}}:46:11)
// CHECK-NEXT: #loc107 = loc({{.*}}:46:30)
// CHECK-NEXT: #loc108 = loc({{.*}}:46:4)
// CHECK-NEXT: #loc109 = loc({{.*}}:40:2)
// CHECK-NEXT: #loc112 = loc({{.*}}:41:14)
// CHECK-NEXT: #loc113 = loc({{.*}}:41:28)
// CHECK-NEXT: #loc114 = loc({{.*}}:41:39)
// CHECK-NEXT: #loc115 = loc({{.*}}:41:4)
// CHECK-NEXT: #loc116 = loc({{.*}}:42:11)
// CHECK-NEXT: #loc117 = loc({{.*}}:42:4)
// CHECK-NEXT: #loc118 = loc({{.*}}:36:2)
// CHECK-NEXT: #loc120 = loc({{.*}}:37:21)
// CHECK-NEXT: #loc121 = loc({{.*}}:37:11)
// CHECK-NEXT: #loc122 = loc({{.*}}:37:4)
// CHECK-NEXT: #loc123 = loc({{.*}}:32:2)
// CHECK-NEXT: #loc124 = loc({{.*}}:33:11)
// CHECK-NEXT: #loc125 = loc({{.*}}:33:4)
// CHECK-NEXT: #loc126 = loc({{.*}}:28:2)
// CHECK-NEXT: #loc127 = loc({{.*}}:29:11)
// CHECK-NEXT: #loc128 = loc({{.*}}:29:4)
// CHECK-NEXT: #loc129 = loc({{.*}}:24:2)
// CHECK-NEXT: #loc130 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc131 = loc({{.*}}:25:4)
// CHECK-NEXT: #loc132 = loc({{.*}}:20:2)
// CHECK-NEXT: #loc133 = loc({{.*}}:21:4)
// CHECK-NEXT: #loc134 = loc({{.*}}:16:2)
// CHECK-NEXT: #loc135 = loc({{.*}}:17:11)
// CHECK-NEXT: #loc136 = loc({{.*}}:17:4)
// CHECK-EMPTY:
