...
// CHECK-NEXT:     %c0_i256_10 = arith.constant 0 : i256 loc(#loc33)
// CHECK-NEXT:     %29 = arith.addi %28, %c0_i256_10 : i256 loc(#loc33)
// CHECK-NEXT:     %c32_i256_11 = arith.constant 32 : i256 loc(#loc33)
// CHECK-NEXT:     %30 = arith.addi %28, %c32_i256_11 : i256 loc(#loc33)
// CHECK-NEXT:     %31 = llvm.inttoptr %29 : i256 to !llvm.ptr<1> loc(#loc33)
// CHECK-NEXT:     llvm.store %26, %31 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc33)
// CHECK-NEXT:     %32 = arith.subi %30, %28 : i256 loc(#loc33)
...
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc45)
// CHECK-NEXT:     %27 = arith.addi %26, %c0_i256_9 : i256 loc(#loc45)
// CHECK-NEXT:     %c32_i256_10 = arith.constant 32 : i256 loc(#loc45)
// CHECK-NEXT:     %28 = arith.addi %26, %c32_i256_10 : i256 loc(#loc45)
// CHECK-NEXT:     %29 = llvm.inttoptr %27 : i256 to !llvm.ptr<1> loc(#loc45)
// CHECK-NEXT:     llvm.store %24, %29 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc45)
// CHECK-NEXT:     %30 = arith.subi %28, %26 : i256 loc(#loc45)
...
// CHECK-NEXT:     %c0_i256_20 = arith.constant 0 : i256 loc(#loc63)
// CHECK-NEXT:     %40 = arith.addi %39, %c0_i256_20 : i256 loc(#loc63)
// CHECK-NEXT:     %c32_i256_21 = arith.constant 32 : i256 loc(#loc63)
// CHECK-NEXT:     %41 = arith.addi %39, %c32_i256_21 : i256 loc(#loc63)
// CHECK-NEXT:     %42 = llvm.inttoptr %40 : i256 to !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     llvm.store %37, %42 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     %43 = arith.subi %41, %39 : i256 loc(#loc63)
