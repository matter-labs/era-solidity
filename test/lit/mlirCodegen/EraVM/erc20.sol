...
// CHECK-NEXT:       %70 = llvm.inttoptr %c0_i256_27 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %70 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %71 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %71 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       %70 = llvm.inttoptr %c64_i256_27 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %71 = llvm.load %70 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
...
// CHECK-NEXT:       %72 = llvm.inttoptr %71 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c3963877391197344453575983046348115674221700746820753546331534351508065746944_i256, %72 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %73 = arith.addi %71, %c4_i256 : i256 loc(#loc2)
// CHECK-NEXT:       %c32_i256_28 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %74 = llvm.inttoptr %73 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c32_i256_28, %74 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %75 = arith.addi %73, %c32_i256_28 : i256 loc(#loc2)
// CHECK-NEXT:       %c34_i256 = arith.constant 34 : i256 loc(#loc2)
// CHECK-NEXT:       %76 = llvm.inttoptr %75 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c34_i256, %76 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c32_i256_29 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %77 = arith.addi %75, %c32_i256_29 : i256 loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c29517451764962235613010368778373659638394623262010481748738546747006033225331_i256, %78 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c32_i256_30 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %79 = arith.addi %77, %c32_i256_30 : i256 loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c45888551966424197807937402689295079693071411769653575580334356259971920822272_i256, %80 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %81 = arith.subi %75, %71 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_31 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%71, %81, %c2_i256_31) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:     %62 = llvm.inttoptr %61 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %63 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc2)
// CHECK-NEXT:     %64 = llvm.load %63 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc2)
// CHECK-NEXT:     %65 = llvm.getelementptr %64[%c0_i256_19] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%62, %65, %c0_i256_20) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %66 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c32_i256_21 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c32_i256_21, %66 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc2)
// CHECK-NEXT:     %67 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_22 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c0_i256_22, %67 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_23 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     %68 = arith.muli %c0_i256_23, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_24 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %69 = arith.addi %68, %c64_i256_24 : i256 loc(#loc2)
// CHECK-NEXT:     %c256_i256_25 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256_26 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     call @__return(%c256_i256_25, %69, %c2_i256_26) : (i256, i256, i256) -> () loc(#loc2)
