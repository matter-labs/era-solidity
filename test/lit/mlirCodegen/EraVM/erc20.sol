...
// CHECK-NEXT:       "scf.int_switch"(%7) <{cases = dense<[826074471, 404098525, 1889567281]> : tensor<3xi256>}> ({
...
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc6)
...
// CHECK-NEXT:     llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc6)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc6)
...
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc13)
// CHECK-NEXT:     return %c18_i8 : i8 loc(#loc14)
...
// CHECK-NEXT: #loc5 = loc({{.*}}:20:21)
// CHECK-NEXT: #loc6 = loc({{.*}}:20:11)
