...
// CHECK: #loc2 = loc({{.*}}:6:0)
// CHECK-NEXT: #loc4 = loc({{.*}}:70:20)
// CHECK-NEXT: #loc5 = loc({{.*}}:70:35)
// CHECK-NEXT: #loc6 = loc({{.*}}:70:52)
// CHECK-NEXT: #loc17 = loc({{.*}}:54:21)
// CHECK-NEXT: #loc18 = loc({{.*}}:54:37)
// CHECK-NEXT: #loc19 = loc({{.*}}:54:56)
// CHECK-NEXT: #loc36 = loc({{.*}}:49:19)
// CHECK-NEXT: #loc37 = loc({{.*}}:49:36)
// CHECK-NEXT: #loc45 = loc({{.*}}:45:21)
// CHECK-NEXT: #loc46 = loc({{.*}}:45:36)
// CHECK-NEXT: #loc52 = loc({{.*}}:40:20)
// CHECK-NEXT: #loc53 = loc({{.*}}:40:39)
// CHECK-NEXT: #loc61 = loc({{.*}}:36:21)
// CHECK-NEXT: module {
...
// CHECK-NEXT:         func.call @_transfer_177(%14, %19, %24) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_approve_201.0(%arg0: i256 loc({{.*}}:70:20), %arg1: i256 loc({{.*}}:70:35), %arg2: i256 loc({{.*}}:70:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc3)
// CHECK-NEXT:   func.func @_transfer_177.0(%arg0: i256 loc({{.*}}:54:21), %arg1: i256 loc({{.*}}:54:37), %arg2: i256 loc({{.*}}:54:56)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     llvm.store %arg2, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc19)
// CHECK-NEXT:     %c1_i256_2 = arith.constant 1 : i256 loc(#loc20)
// CHECK-NEXT:     %3 = llvm.alloca %c1_i256_2 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc21)
// CHECK-NEXT:     %4 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc22)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc23)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc23)
// CHECK-NEXT:     llvm.store %4, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc23)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc23)
// CHECK-NEXT:     %6 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc23)
// CHECK-NEXT:     llvm.store %c0_i256, %6 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc23)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc23)
// CHECK-NEXT:     %7 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc23)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %8 = call @__sha3(%7, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc23)
// CHECK-NEXT:     %9 = llvm.inttoptr %8 : i256 to !llvm.ptr<5> loc(#loc23)
// CHECK-NEXT:     %10 = llvm.load %9 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc23)
// CHECK-NEXT:     llvm.store %10, %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc21)
// CHECK-NEXT:     %11 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc24)
// CHECK-NEXT:     %c0_i256_5 = arith.constant 0 : i256 loc(#loc25)
// CHECK-NEXT:     %12 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc25)
// CHECK-NEXT:     llvm.store %11, %12 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc25)
// CHECK-NEXT:     %c32_i256_6 = arith.constant 32 : i256 loc(#loc25)
// CHECK-NEXT:     %13 = llvm.inttoptr %c32_i256_6 : i256 to !llvm.ptr<1> loc(#loc25)
// CHECK-NEXT:     llvm.store %c0_i256_4, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc25)
// CHECK-NEXT:     %c64_i256_7 = arith.constant 64 : i256 loc(#loc25)
// CHECK-NEXT:     %14 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc25)
// CHECK-NEXT:     %false_8 = arith.constant false loc(#loc)
// CHECK-NEXT:     %15 = call @__sha3(%14, %c64_i256_7, %false_8) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc25)
// CHECK-NEXT:     %16 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc26)
// CHECK-NEXT:     %17 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc27)
// CHECK-NEXT:     %18 = arith.subi %16, %17 : i256 loc(#loc26)
// CHECK-NEXT:     %19 = llvm.inttoptr %15 : i256 to !llvm.ptr<5> loc(#loc25)
// CHECK-NEXT:     llvm.store %18, %19 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc25)
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc21)
// CHECK-NEXT:     %20 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc28)
// CHECK-NEXT:     %c0_i256_10 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:     %21 = llvm.inttoptr %c0_i256_10 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %20, %21 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c32_i256_11 = arith.constant 32 : i256 loc(#loc29)
// CHECK-NEXT:     %22 = llvm.inttoptr %c32_i256_11 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %c0_i256_9, %22 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c64_i256_12 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %23 = llvm.inttoptr %c0_i256_10 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %false_13 = arith.constant false loc(#loc)
// CHECK-NEXT:     %24 = call @__sha3(%23, %c64_i256_12, %false_13) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc29)
// CHECK-NEXT:     %25 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc30)
// CHECK-NEXT:     %c0_i256_14 = arith.constant 0 : i256 loc(#loc21)
// CHECK-NEXT:     %26 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc28)
// CHECK-NEXT:     %c0_i256_15 = arith.constant 0 : i256 loc(#loc29)
// CHECK-NEXT:     %27 = llvm.inttoptr %c0_i256_15 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %26, %27 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c32_i256_16 = arith.constant 32 : i256 loc(#loc29)
// CHECK-NEXT:     %28 = llvm.inttoptr %c32_i256_16 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     llvm.store %c0_i256_14, %28 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %c64_i256_17 = arith.constant 64 : i256 loc(#loc29)
// CHECK-NEXT:     %29 = llvm.inttoptr %c0_i256_15 : i256 to !llvm.ptr<1> loc(#loc29)
// CHECK-NEXT:     %false_18 = arith.constant false loc(#loc)
// CHECK-NEXT:     %30 = call @__sha3(%29, %c64_i256_17, %false_18) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc29)
// CHECK-NEXT:     %31 = llvm.inttoptr %30 : i256 to !llvm.ptr<5> loc(#loc29)
// CHECK-NEXT:     %32 = llvm.load %31 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc29)
// CHECK-NEXT:     %33 = arith.addi %32, %25 : i256 loc(#loc29)
// CHECK-NEXT:     %34 = llvm.inttoptr %24 : i256 to !llvm.ptr<5> loc(#loc29)
// CHECK-NEXT:     llvm.store %33, %34 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc29)
// CHECK-NEXT:     %35 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc31)
// CHECK-NEXT:     %36 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc32)
// CHECK-NEXT:     %37 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc33)
// CHECK-NEXT:     %c64_i256_19 = arith.constant 64 : i256 loc(#loc34)
// CHECK-NEXT:     %38 = llvm.inttoptr %c64_i256_19 : i256 to !llvm.ptr<1> loc(#loc34)
// CHECK-NEXT:     %39 = llvm.load %38 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc34)
// CHECK-NEXT:     %c0_i256_20 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:     %40 = arith.addi %39, %c0_i256_20 : i256 loc(#loc34)
// CHECK-NEXT:     %c32_i256_21 = arith.constant 32 : i256 loc(#loc34)
// CHECK-NEXT:     %41 = arith.addi %39, %c32_i256_21 : i256 loc(#loc34)
// CHECK-NEXT:     %42 = llvm.inttoptr %40 : i256 to !llvm.ptr<1> loc(#loc34)
// CHECK-NEXT:     llvm.store %37, %42 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc34)
// CHECK-NEXT:     %43 = arith.subi %41, %39 : i256 loc(#loc34)
// CHECK-NEXT:     %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256 = arith.constant 51735811207051471423543085523402233001646248530043601449996937859018943444521 : i256 loc(#loc34)
// CHECK-NEXT:     %c4294967295_i256 = arith.constant 4294967295 : i256 loc(#loc34)
// CHECK-NEXT:     %c1_i64 = arith.constant 1 : i64 loc(#loc34)
// CHECK-NEXT:     %44 = llvm.alloca %c1_i64 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     llvm.store %c4294967295_i256, %44 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %45 = arith.cmpi ule, %39, %c4294967295_i256 : i256 loc(#loc34)
// CHECK-NEXT:     scf.if %45 {
// CHECK-NEXT:       llvm.store %39, %44 : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     } loc(#loc34)
// CHECK-NEXT:     %46 = llvm.load %44 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %c4294967295_i256_22 = arith.constant 4294967295 : i256 loc(#loc34)
// CHECK-NEXT:     %c1_i64_23 = arith.constant 1 : i64 loc(#loc34)
// CHECK-NEXT:     %47 = llvm.alloca %c1_i64_23 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     llvm.store %c4294967295_i256_22, %47 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %48 = arith.cmpi ule, %43, %c4294967295_i256_22 : i256 loc(#loc34)
// CHECK-NEXT:     scf.if %48 {
// CHECK-NEXT:       llvm.store %43, %47 : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     } loc(#loc34)
// CHECK-NEXT:     %49 = llvm.load %47 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %50 = "llvm.intrcall"() <{id = 3176 : i32, name = "eravm.gasleft"}> : () -> i256 loc(#loc34)
// CHECK-NEXT:     %c4294967295_i256_24 = arith.constant 4294967295 : i256 loc(#loc34)
// CHECK-NEXT:     %c1_i64_25 = arith.constant 1 : i64 loc(#loc34)
// CHECK-NEXT:     %51 = llvm.alloca %c1_i64_25 x i256 {alignment = 32 : i64} : (i64) -> !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     llvm.store %c4294967295_i256_24, %51 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %52 = arith.cmpi ule, %50, %c4294967295_i256_24 : i256 loc(#loc34)
// CHECK-NEXT:     scf.if %52 {
// CHECK-NEXT:       llvm.store %50, %51 : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     } loc(#loc34)
// CHECK-NEXT:     %53 = llvm.load %51 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc34)
// CHECK-NEXT:     %c64_i256_26 = arith.constant 64 : i256 loc(#loc34)
// CHECK-NEXT:     %54 = arith.shli %46, %c64_i256_26 : i256 loc(#loc34)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc34)
// CHECK-NEXT:     %55 = arith.shli %49, %c96_i256 : i256 loc(#loc34)
// CHECK-NEXT:     %c192_i256 = arith.constant 192 : i256 loc(#loc34)
// CHECK-NEXT:     %56 = arith.shli %53, %c192_i256 : i256 loc(#loc34)
// CHECK-NEXT:     %57 = arith.addi %54, %55 : i256 loc(#loc34)
// CHECK-NEXT:     %58 = arith.addi %57, %56 : i256 loc(#loc34)
// CHECK-NEXT:     %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 = arith.constant 904625697166532776746648320380374280103671755200316906558262375061821325312 : i256 loc(#loc34)
// CHECK-NEXT:     %59 = arith.addi %58, %c904625697166532776746648320380374280103671755200316906558262375061821325312_i256 : i256 loc(#loc34)
// CHECK-NEXT:     %c32781_i256 = arith.constant 32781 : i256 loc(#loc34)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc34)
// CHECK-NEXT:     %60 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %61 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %62 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %63 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %64 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %65 = llvm.mlir.undef : i256 loc(#loc34)
// CHECK-NEXT:     %66:2 = call @__farcall(%59, %c32781_i256, %c3_i256, %c51735811207051471423543085523402233001646248530043601449996937859018943444521_i256, %35, %36, %60, %61, %62, %63, %64, %65) : (i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256, i256) -> (!llvm.ptr<3>, i1) loc(#loc34)
// CHECK-NEXT:     %false_27 = arith.constant false loc(#loc34)
// CHECK-NEXT:     %67 = arith.cmpi eq, %66#1, %false_27 : i1 loc(#loc34)
// CHECK-NEXT:     scf.if %67 {
// CHECK-NEXT:       %c0_i256_28 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc34)
// CHECK-NEXT:       func.call @__revert(%c0_i256_28, %c0_i256_29, %c2_i256) : (i256, i256, i256) -> () loc(#loc34)
...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc36)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc36)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc37)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc37)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc37)
// CHECK-NEXT:     %2 = call @_msgSender_42.0() : () -> i256 loc(#loc38)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc39)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc40)
// CHECK-NEXT:     call @_approve_201(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc41)
// CHECK-NEXT:     %true = arith.constant true loc(#loc42)
// CHECK-NEXT:     return %true : i1 loc(#loc43)
...
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc48)
...
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc48)
// CHECK-NEXT:     %4 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     llvm.store %c1_i256_1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc48)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %6 = call @__sha3(%5, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc48)
// CHECK-NEXT:     %7 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc49)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc48)
// CHECK-NEXT:     %8 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     llvm.store %7, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc48)
// CHECK-NEXT:     %9 = llvm.inttoptr %c32_i256_3 : i256 to !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     llvm.store %6, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc48)
// CHECK-NEXT:     %10 = llvm.inttoptr %c0_i256_2 : i256 to !llvm.ptr<1> loc(#loc48)
// CHECK-NEXT:     %false_5 = arith.constant false loc(#loc)
// CHECK-NEXT:     %11 = call @__sha3(%10, %c64_i256_4, %false_5) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc48)
// CHECK-NEXT:     %12 = llvm.inttoptr %11 : i256 to !llvm.ptr<5> loc(#loc48)
// CHECK-NEXT:     %13 = llvm.load %12 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc48)
// CHECK-NEXT:     return %13 : i256 loc(#loc50)
...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc52)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc52)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc53)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc53)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc53)
// CHECK-NEXT:     %2 = call @_msgSender_42.0() : () -> i256 loc(#loc54)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc55)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc56)
// CHECK-NEXT:     call @_transfer_177(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc57)
// CHECK-NEXT:     %true = arith.constant true loc(#loc58)
// CHECK-NEXT:     return %true : i1 loc(#loc59)
...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc61)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc61)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc21)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc62)
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256 loc(#loc63)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc63)
// CHECK-NEXT:     %3 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc63)
// CHECK-NEXT:     %4 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1> loc(#loc63)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %5 = call @__sha3(%4, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc63)
// CHECK-NEXT:     %6 = llvm.inttoptr %5 : i256 to !llvm.ptr<5> loc(#loc63)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc63)
// CHECK-NEXT:     return %7 : i256 loc(#loc64)
...
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc66)
// CHECK-NEXT:     %0 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<5> loc(#loc67)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc67)
// CHECK-NEXT:     return %1 : i256 loc(#loc68)
...
// CHECK-NEXT:     %c18_i8 = arith.constant 18 : i8 loc(#loc70)
// CHECK-NEXT:     %0 = arith.extui %c18_i8 : i8 to i256 loc(#loc70)
// CHECK-NEXT:     return %0 : i256 loc(#loc71)
...
// CHECK-NEXT:     %c4_i256 = arith.constant 4 : i256 loc(#loc73)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc73)
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     llvm.store %c4_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc73)
// CHECK-NEXT:     %1 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %2 = call @__sha3(%1, %c32_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc73)
// CHECK-NEXT:     %3 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<5> loc(#loc73)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc73)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc73)
// CHECK-NEXT:     %5 = arith.addi %4, %c31_i256 : i256 loc(#loc73)
// CHECK-NEXT:     %c4294967264_i256 = arith.constant 4294967264 : i256 loc(#loc73)
// CHECK-NEXT:     %6 = arith.andi %5, %c4294967264_i256 : i256 loc(#loc73)
// CHECK-NEXT:     %c32_i256_0 = arith.constant 32 : i256 loc(#loc73)
// CHECK-NEXT:     %7 = arith.addi %6, %c32_i256_0 : i256 loc(#loc73)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc73)
// CHECK-NEXT:     %8 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     %9 = llvm.load %8 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc73)
// CHECK-NEXT:     %10 = arith.addi %9, %7 : i256 loc(#loc73)
// CHECK-NEXT:     %c18446744073709551615_i256 = arith.constant 18446744073709551615 : i256 loc(#loc73)
// CHECK-NEXT:     %11 = arith.cmpi ugt, %10, %c18446744073709551615_i256 : i256 loc(#loc73)
// CHECK-NEXT:     %12 = arith.cmpi ult, %10, %9 : i256 loc(#loc73)
// CHECK-NEXT:     %13 = arith.ori %11, %12 : i1 loc(#loc73)
// CHECK-NEXT:     scf.if %13 {
// CHECK-NEXT:       %c0_i256_4 = arith.constant 0 : i256 loc(#loc73)
// CHECK-NEXT:       %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc73)
// CHECK-NEXT:       %19 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %19 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:       %c4_i256_5 = arith.constant 4 : i256 loc(#loc73)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc73)
// CHECK-NEXT:       %20 = llvm.inttoptr %c4_i256_5 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:       llvm.store %c65_i256, %20 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc73)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc73)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc73)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc73)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc73)
// CHECK-NEXT:     } loc(#loc73)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc73)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     llvm.store %10, %14 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     %15 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     llvm.store %4, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     %c31_i256_2 = arith.constant 31 : i256 loc(#loc73)
// CHECK-NEXT:     %16 = arith.addi %4, %c31_i256_2 : i256 loc(#loc73)
// CHECK-NEXT:     %c4294967264_i256_3 = arith.constant 4294967264 : i256 loc(#loc73)
// CHECK-NEXT:     %17 = arith.andi %16, %c4294967264_i256_3 : i256 loc(#loc73)
// CHECK-NEXT:     %c0 = arith.constant 0 : index loc(#loc73)
// CHECK-NEXT:     %18 = arith.index_castui %17 : i256 to index loc(#loc73)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc73)
// CHECK-NEXT:     scf.for %arg0 = %c0 to %18 step %c1 {
// CHECK-NEXT:       %19 = arith.index_castui %arg0 : index to i256 loc(#loc73)
// CHECK-NEXT:       %20 = arith.addi %2, %19 : i256 loc(#loc73)
// CHECK-NEXT:       %21 = llvm.inttoptr %20 : i256 to !llvm.ptr<5> loc(#loc73)
// CHECK-NEXT:       %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc73)
// CHECK-NEXT:       %c32_i256_4 = arith.constant 32 : i256 loc(#loc73)
// CHECK-NEXT:       %23 = arith.muli %19, %c32_i256_4 : i256 loc(#loc73)
// CHECK-NEXT:       %24 = arith.addi %9, %23 : i256 loc(#loc73)
// CHECK-NEXT:       %25 = llvm.inttoptr %24 : i256 to !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:       llvm.store %22, %25 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc73)
// CHECK-NEXT:     } loc(#loc73)
// CHECK-NEXT:     return %9 : i256 loc(#loc74)
...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     return %9 : i256 loc(#loc76)
...
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3170 : i32, name = "eravm.caller"}> : () -> i256 loc(#loc78)
// CHECK-NEXT:     return %0 : i256 loc(#loc79)
...
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc73)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc73)
// CHECK-NEXT:       %c0_i256_7 = arith.constant 0 : i256 loc(#loc73)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc73)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc73)
// CHECK-NEXT:     } loc(#loc73)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc73)
// CHECK-NEXT:     %14 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc73)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc53)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc53)
// CHECK-NEXT:     %2 = call @_msgSender_42() : () -> i256 loc(#loc54)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc55)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc56)
// CHECK-NEXT:     call @_transfer_177(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc57)
// CHECK-NEXT:     %true = arith.constant true loc(#loc58)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc37)
// CHECK-NEXT:     llvm.store %arg1, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc37)
// CHECK-NEXT:     %2 = call @_msgSender_42() : () -> i256 loc(#loc38)
// CHECK-NEXT:     %3 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc39)
// CHECK-NEXT:     %4 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc40)
// CHECK-NEXT:     call @_approve_201(%2, %3, %4) : (i256, i256, i256) -> () loc(#loc41)
// CHECK-NEXT:     %true = arith.constant true loc(#loc42)
// CHECK-NEXT:     return %true : i1 loc(#loc43)
// CHECK-NEXT:   } loc(#loc35)
// CHECK-NEXT:   func.func @_transfer_177(%arg0: i256 loc({{.*}}:54:21), %arg1: i256 loc({{.*}}:54:37), %arg2: i256 loc({{.*}}:54:56)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc17)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc18)
...
// CHECK-NEXT:       %c0_i256_28 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:       %c0_i256_30 = arith.constant 0 : i256 loc(#loc34)
// CHECK-NEXT:       func.call @__revert(%c0_i256_28, %c0_i256_29, %c0_i256_30) : (i256, i256, i256) -> () loc(#loc34)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc34)
// CHECK-NEXT:     } loc(#loc34)
// CHECK-NEXT:     return loc(#loc16)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @_approve_201(%arg0: i256 loc({{.*}}:70:20), %arg1: i256 loc({{.*}}:70:35), %arg2: i256 loc({{.*}}:70:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc5)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:70:2)
// CHECK-NEXT: #loc7 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc8 = loc({{.*}}:75:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:75:4)
// CHECK-NEXT: #loc10 = loc({{.*}}:75:23)
// CHECK-NEXT: #loc11 = loc({{.*}}:75:34)
// CHECK-NEXT: #loc12 = loc({{.*}}:76:18)
// CHECK-NEXT: #loc13 = loc({{.*}}:76:25)
// CHECK-NEXT: #loc14 = loc({{.*}}:76:34)
// CHECK-NEXT: #loc15 = loc({{.*}}:76:9)
// CHECK-NEXT: #loc16 = loc({{.*}}:54:2)
// CHECK-NEXT: #loc20 = loc({{.*}}:59:4)
// CHECK-NEXT: #loc21 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc22 = loc({{.*}}:59:38)
// CHECK-NEXT: #loc23 = loc({{.*}}:59:28)
// CHECK-NEXT: #loc24 = loc({{.*}}:63:16)
// CHECK-NEXT: #loc25 = loc({{.*}}:63:6)
// CHECK-NEXT: #loc26 = loc({{.*}}:63:26)
// CHECK-NEXT: #loc27 = loc({{.*}}:63:42)
// CHECK-NEXT: #loc28 = loc({{.*}}:65:16)
// CHECK-NEXT: #loc29 = loc({{.*}}:65:6)
// CHECK-NEXT: #loc30 = loc({{.*}}:65:30)
// CHECK-NEXT: #loc31 = loc({{.*}}:67:18)
// CHECK-NEXT: #loc32 = loc({{.*}}:67:26)
// CHECK-NEXT: #loc33 = loc({{.*}}:67:37)
// CHECK-NEXT: #loc34 = loc({{.*}}:67:9)
// CHECK-NEXT: #loc35 = loc({{.*}}:49:2)
// CHECK-NEXT: #loc38 = loc({{.*}}:50:13)
// CHECK-NEXT: #loc39 = loc({{.*}}:50:27)
// CHECK-NEXT: #loc40 = loc({{.*}}:50:36)
// CHECK-NEXT: #loc41 = loc({{.*}}:50:4)
// CHECK-NEXT: #loc42 = loc({{.*}}:51:11)
// CHECK-NEXT: #loc43 = loc({{.*}}:51:4)
// CHECK-NEXT: #loc44 = loc({{.*}}:45:2)
// CHECK-NEXT: #loc47 = loc({{.*}}:46:23)
// CHECK-NEXT: #loc48 = loc({{.*}}:46:11)
// CHECK-NEXT: #loc49 = loc({{.*}}:46:30)
// CHECK-NEXT: #loc50 = loc({{.*}}:46:4)
// CHECK-NEXT: #loc51 = loc({{.*}}:40:2)
// CHECK-NEXT: #loc54 = loc({{.*}}:41:14)
// CHECK-NEXT: #loc55 = loc({{.*}}:41:28)
// CHECK-NEXT: #loc56 = loc({{.*}}:41:39)
// CHECK-NEXT: #loc57 = loc({{.*}}:41:4)
// CHECK-NEXT: #loc58 = loc({{.*}}:42:11)
// CHECK-NEXT: #loc59 = loc({{.*}}:42:4)
// CHECK-NEXT: #loc60 = loc({{.*}}:36:2)
// CHECK-NEXT: #loc62 = loc({{.*}}:37:21)
// CHECK-NEXT: #loc63 = loc({{.*}}:37:11)
// CHECK-NEXT: #loc64 = loc({{.*}}:37:4)
// CHECK-NEXT: #loc65 = loc({{.*}}:32:2)
// CHECK-NEXT: #loc66 = loc({{.*}}:9:2)
// CHECK-NEXT: #loc67 = loc({{.*}}:33:11)
// CHECK-NEXT: #loc68 = loc({{.*}}:33:4)
// CHECK-NEXT: #loc69 = loc({{.*}}:28:2)
// CHECK-NEXT: #loc70 = loc({{.*}}:29:11)
// CHECK-NEXT: #loc71 = loc({{.*}}:29:4)
// CHECK-NEXT: #loc72 = loc({{.*}}:24:2)
// CHECK-NEXT: #loc73 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc74 = loc({{.*}}:25:4)
// CHECK-NEXT: #loc75 = loc({{.*}}:20:2)
// CHECK-NEXT: #loc76 = loc({{.*}}:21:4)
// CHECK-NEXT: #loc77 = loc({{.*}}:16:2)
// CHECK-NEXT: #loc78 = loc({{.*}}:17:11)
// CHECK-NEXT: #loc79 = loc({{.*}}:17:4)
// CHECK-EMPTY:
