...
// CHECK-NEXT:           %c0_i256_8 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:           %c0_i256_9 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:           func.call @__revert(%c0_i256_7, %c0_i256_8, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:           func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:         } loc(#loc2)
// CHECK-NEXT:         %10 = func.call @_msgSender_42() : () -> i256 loc(#loc2)
// CHECK-NEXT:         %c64_i256_4 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %11 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:         %15 = arith.addi %12, %c32_i256_5 : i256 loc(#loc2)
// CHECK-NEXT:         %16 = arith.subi %13, %12 : i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_6 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:         func.call @__return(%12, %16, %c0_i256_6) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_5 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %19 = arith.addi %10, %c32_i256_5 : i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %20 = arith.addi %13, %c32_i256_6 : i256 loc(#loc2)
...
// CHECK-NEXT:         llvm.store %c0_i256_7, %24 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:         %26 = arith.andi %25, %c4294967264_i256 : i256 loc(#loc2)
// CHECK-NEXT:         %27 = arith.addi %20, %26 : i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %28 = arith.addi %12, %c32_i256_8 : i256 loc(#loc2)
// CHECK-NEXT:         %29 = arith.subi %27, %12 : i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_9 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:         func.call @__return(%12, %29, %c0_i256_9) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:         scf.yield loc(#loc2)
// CHECK-NEXT:       }
