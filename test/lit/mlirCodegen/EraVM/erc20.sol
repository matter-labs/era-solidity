...
// CHECK-NEXT:         %15 = arith.addi %12, %c32_i256_6 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_6 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %19 = arith.addi %10, %c32_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_7 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %20 = arith.addi %13, %c32_i256_7 : i256 loc(#loc2)
...
// CHECK-NEXT:         llvm.store %c0_i256_8, %24 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:         %28 = arith.addi %12, %c32_i256_9 : i256 loc(#loc2)
...
// CHECK-NEXT:         %24 = arith.extui %20 : i1 to i256 loc(#loc2)
// CHECK-NEXT:         %25 = llvm.inttoptr %22 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:         %26 = arith.addi %22, %c32_i256_8 : i256 loc(#loc2)
...
// CHECK-NEXT:         %c32_i256_7 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %23 = arith.addi %22, %c32_i256_7 : i256 loc(#loc2)
// CHECK-NEXT:         %24 = llvm.inttoptr %22 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         llvm.store %20, %24 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %c32_i256_8 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %25 = arith.addi %22, %c32_i256_8 : i256 loc(#loc2)
...
// CHECK-NEXT:         %25 = func.call @transferFrom_186(%14, %19, %24) : (i256, i256, i256) -> i1 loc(#loc2)
...
// CHECK-NEXT:         %29 = arith.extui %25 : i1 to i256 loc(#loc2)
// CHECK-NEXT:         %30 = llvm.inttoptr %27 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         llvm.store %29, %30 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %c32_i256_9 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:         %31 = arith.addi %27, %c32_i256_9 : i256 loc(#loc2)
...
// CHECK-NEXT:         %18 = llvm.getelementptr %17[%15] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc2)
// CHECK-NEXT:         %20 = func.call @increaseAllowance_213(%14, %19) : (i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %21 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_7 = arith.constant 32 : i256 loc(#loc2)
...
// CHECK-NEXT:         %18 = llvm.getelementptr %17[%15] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc2)
// CHECK-NEXT:         %20 = func.call @decreaseAllowance_251(%14, %19) : (i256, i256) -> i1 loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %21 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c32_i256_7 = arith.constant 32 : i256 loc(#loc2)
...
// CHECK-NEXT:         %23 = llvm.getelementptr %22[%20] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:         %24 = llvm.load %23 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc2)
// CHECK-NEXT:         func.call @_transfer_316(%14, %19, %24) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_7 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %18 = llvm.getelementptr %17[%15] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc2)
// CHECK-NEXT:         func.call @_mint_354(%14, %19) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
...
// CHECK-NEXT:         %18 = llvm.getelementptr %17[%15] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:         %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc2)
// CHECK-NEXT:         func.call @_burn_408(%14, %19) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:         %c64_i256_6 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:         %20 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:         %21 = llvm.load %20 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:         %c0_i256_7 = arith.constant 0 : i256 loc(#loc2)
...
// CHECK-NEXT:       %19 = llvm.inttoptr %c0_i256_4 : i256 to !llvm.ptr<1> loc(#loc176)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %19 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc176)
// CHECK-NEXT:       %c4_i256_5 = arith.constant 4 : i256 loc(#loc176)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc176)
// CHECK-NEXT:       %20 = llvm.inttoptr %c4_i256_5 : i256 to !llvm.ptr<1> loc(#loc176)
// CHECK-NEXT:       llvm.store %c65_i256, %20 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc176)
...
// CHECK-NEXT:     %16 = arith.addi %4, %c31_i256_2 : i256 loc(#loc176)
// CHECK-NEXT:     %c4294967264_i256_3 = arith.constant 4294967264 : i256 loc(#loc176)
// CHECK-NEXT:     %17 = arith.andi %16, %c4294967264_i256_3 : i256 loc(#loc176)
// CHECK-NEXT:     %c0 = arith.constant 0 : index loc(#loc176)
// CHECK-NEXT:     %18 = arith.index_castui %17 : i256 to index loc(#loc176)
// CHECK-NEXT:     %c1 = arith.constant 1 : index loc(#loc176)
// CHECK-NEXT:     scf.for %arg0 = %c0 to %18 step %c1 {
// CHECK-NEXT:       %19 = arith.index_castui %arg0 : index to i256 loc(#loc176)
// CHECK-NEXT:       %20 = arith.addi %2, %19 : i256 loc(#loc176)
// CHECK-NEXT:       %21 = llvm.inttoptr %20 : i256 to !llvm.ptr<5> loc(#loc176)
// CHECK-NEXT:       %22 = llvm.load %21 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc176)
// CHECK-NEXT:       %c32_i256_4 = arith.constant 32 : i256 loc(#loc176)
// CHECK-NEXT:       %23 = arith.muli %19, %c32_i256_4 : i256 loc(#loc176)
// CHECK-NEXT:       %24 = arith.addi %9, %23 : i256 loc(#loc176)
// CHECK-NEXT:       %25 = llvm.inttoptr %24 : i256 to !llvm.ptr<1> loc(#loc176)
// CHECK-NEXT:       llvm.store %22, %25 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc176)
// CHECK-NEXT:     } loc(#loc176)
