...
// CHECK-NEXT: #loc17 = loc({{.*}}:35:21)
// CHECK-NEXT: #loc18 = loc({{.*}}:35:36)
// CHECK-NEXT: #loc24 = loc({{.*}}:31:21)
// CHECK-NEXT: module {
...
// CHECK-NEXT:         func.call @_approve_109(%14, %19, %24) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_approve_109.0(%arg0: i256 loc({{.*}}:39:20), %arg1: i256 loc({{.*}}:39:35), %arg2: i256 loc({{.*}}:39:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     return %13 : i256 loc(#loc22)
// CHECK-NEXT:   } loc(#loc16)
// CHECK-NEXT:   func.func @_approve_109(%arg0: i256 loc({{.*}}:39:20), %arg1: i256 loc({{.*}}:39:35), %arg2: i256 loc({{.*}}:39:52)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc5)
...
// CHECK-NEXT: #loc8 = loc({{.*}}:44:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:44:4)
// CHECK-NEXT: #loc10 = loc({{.*}}:44:23)
// CHECK-NEXT: #loc11 = loc({{.*}}:44:34)
// CHECK-NEXT: #loc12 = loc({{.*}}:45:18)
// CHECK-NEXT: #loc13 = loc({{.*}}:45:25)
// CHECK-NEXT: #loc14 = loc({{.*}}:45:34)
// CHECK-NEXT: #loc15 = loc({{.*}}:45:9)
// CHECK-NEXT: #loc16 = loc({{.*}}:35:2)
// CHECK-NEXT: #loc19 = loc({{.*}}:36:23)
// CHECK-NEXT: #loc20 = loc({{.*}}:36:11)
// CHECK-NEXT: #loc21 = loc({{.*}}:36:30)
// CHECK-NEXT: #loc22 = loc({{.*}}:36:4)
// CHECK-NEXT: #loc23 = loc({{.*}}:31:2)
// CHECK-NEXT: #loc25 = loc({{.*}}:7:2)
// CHECK-NEXT: #loc26 = loc({{.*}}:32:21)
// CHECK-NEXT: #loc27 = loc({{.*}}:32:11)
// CHECK-NEXT: #loc28 = loc({{.*}}:32:4)
// CHECK-NEXT: #loc29 = loc({{.*}}:27:2)
// CHECK-NEXT: #loc30 = loc({{.*}}:9:2)
// CHECK-NEXT: #loc31 = loc({{.*}}:28:11)
// CHECK-NEXT: #loc32 = loc({{.*}}:28:4)
// CHECK-NEXT: #loc33 = loc({{.*}}:23:2)
// CHECK-NEXT: #loc34 = loc({{.*}}:24:11)
// CHECK-NEXT: #loc35 = loc({{.*}}:24:4)
// CHECK-NEXT: #loc36 = loc({{.*}}:19:2)
// CHECK-NEXT: #loc37 = loc({{.*}}:11:2)
// CHECK-NEXT: #loc38 = loc({{.*}}:20:4)
// CHECK-NEXT: #loc39 = loc({{.*}}:15:2)
// CHECK-NEXT: #loc40 = loc({{.*}}:16:4)
// CHECK-EMPTY:
