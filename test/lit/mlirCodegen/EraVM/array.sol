...
// CHECK-NEXT:     %4 = arith.cmpi uge, %3, %c4_i256 : i256 loc(#loc6)
// CHECK-NEXT:     scf.if %4 {
...
// CHECK-NEXT:       %c4_i256_2 = arith.constant 4 : i256 loc(#loc6)
// CHECK-NEXT:       %c50_i256 = arith.constant 50 : i256 loc(#loc6)
// CHECK-NEXT:       %16 = llvm.inttoptr %c4_i256_2 : i256 to !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:       llvm.store %c50_i256, %16 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:       %c0_i256_3 = arith.constant 0 : i256 loc(#loc6)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc6)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc6)
// CHECK-NEXT:       func.call @__revert(%c0_i256_3, %c24_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc6)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc6)
// CHECK-NEXT:     } loc(#loc6)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc6)
// CHECK-NEXT:     %5 = arith.muli %3, %c32_i256 : i256 loc(#loc6)
// CHECK-NEXT:     %6 = arith.addi %2, %5 : i256 loc(#loc6)
...
// CHECK-NEXT:     %9 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %c3_i256 = arith.constant 3 : i256 loc(#loc6)
// CHECK-NEXT:     %10 = arith.cmpi uge, %9, %c3_i256 : i256 loc(#loc6)
...
// CHECK-NEXT:     %11 = arith.muli %9, %c32_i256_1 : i256 loc(#loc6)
// CHECK-NEXT:     %12 = arith.addi %8, %11 : i256 loc(#loc6)
...
// CHECK-NEXT:     return %14 : i256 loc(#loc9)
// CHECK-NEXT:   } loc(#loc3)
...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc12)
...
// CHECK-NEXT:       func.call @__revert(%c0_i256_3, %c24_i256, %c0_i256_4) : (i256, i256, i256) -> () loc(#loc6)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc6)
// CHECK-NEXT:     } loc(#loc6)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc6)
// CHECK-NEXT:     %5 = arith.muli %3, %c32_i256 : i256 loc(#loc6)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:6:17)
// CHECK-NEXT: #loc5 = loc({{.*}}:6:41)
// CHECK-NEXT: #loc6 = loc({{.*}}:7:11)
// CHECK-NEXT: #loc7 = loc({{.*}}:7:13)
// CHECK-NEXT: #loc8 = loc({{.*}}:7:16)
// CHECK-NEXT: #loc9 = loc({{.*}}:7:4)
// CHECK-NEXT: #loc10 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc11 = loc({{.*}}:3:17)
// CHECK-NEXT: #loc12 = loc({{.*}}:3:38)
// CHECK-NEXT: #loc13 = loc({{.*}}:4:13)
