...
// CHECK-NEXT:     %17 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %18 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %19 = llvm.load %18 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %20 = llvm.getelementptr %19[%16] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%17, %20, %c96_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
...
// CHECK-NEXT:     %32 = llvm.inttoptr %24 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %33 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %34 = llvm.load %33 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %35 = llvm.getelementptr %34[%31] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%32, %35, %c96_i256_4) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
...
// CHECK-NEXT:     %47 = llvm.inttoptr %39 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %48 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %49 = llvm.load %48 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %50 = llvm.getelementptr %49[%46] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%47, %50, %c96_i256_10) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
...
// CHECK-NEXT:     %62 = llvm.inttoptr %54 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %63 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %64 = llvm.load %63 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %65 = llvm.getelementptr %64[%61] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%62, %65, %c96_i256_16) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
...
// CHECK-NEXT:     %10 = llvm.inttoptr %2 : i256 to !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:     %11 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc6)
// CHECK-NEXT:     %12 = llvm.load %11 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc6)
// CHECK-NEXT:     %13 = llvm.getelementptr %12[%9] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc6)
// CHECK-NEXT:     "llvm.intr.memcpy"(%10, %13, %c96_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc6)
...
// CHECK-NEXT:     %49 = llvm.load %48 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %50 = llvm.getelementptr %49[%46] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%47, %50, %c96_i256_9) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
// CHECK-NEXT:     %51 = llvm.inttoptr %37 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %39, %51 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
...
// CHECK-NEXT:     %64 = llvm.load %63 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %65 = llvm.getelementptr %64[%61] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%62, %65, %c96_i256_14) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
// CHECK-NEXT:     %66 = llvm.inttoptr %52 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %54, %66 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %2, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     return loc(#loc3)
