...
// CHECK-NEXT:     %c1_i64 = arith.constant 1 : i64 loc(#loc5)
// CHECK-NEXT:     %7 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc5)
// CHECK-NEXT:     %8 = arith.extui %c1_i64 : i64 to i256 loc(#loc5)
// CHECK-NEXT:     %c32_i256_0 = arith.constant 32 : i256 loc(#loc5)
// CHECK-NEXT:     %9 = arith.muli %8, %c32_i256_0 : i256 loc(#loc5)
// CHECK-NEXT:     %10 = arith.addi %7, %9 : i256 loc(#loc5)
// CHECK-NEXT:     %11 = llvm.inttoptr %10 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:     %12 = llvm.load %11 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc5)
// CHECK-NEXT:     %c2_i8 = arith.constant 2 : i8 loc(#loc6)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc5)
// CHECK-NEXT:     %13 = arith.addi %12, %c64_i256 : i256 loc(#loc5)
