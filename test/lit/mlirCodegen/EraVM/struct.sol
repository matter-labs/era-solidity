...
// CHECK-NEXT:     llvm.unreachable loc(#loc2)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @malloc_32.0() attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     %1 = llvm.inttoptr %c64_i256_0 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %2 = llvm.load %1 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc4)
// CHECK-NEXT:     %3 = arith.addi %2, %c64_i256 : i256 loc(#loc4)
...
// CHECK-NEXT:     scf.if %6 {
// CHECK-NEXT:       %c0_i256_6 = arith.constant 0 : i256 loc(#loc4)
...
// CHECK-NEXT:       %23 = llvm.inttoptr %c0_i256_6 : i256 to !llvm.ptr<1> loc(#loc4)
...
// CHECK-NEXT:       %c0_i256_7 = arith.constant 0 : i256 loc(#loc4)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc4)
// CHECK-NEXT:       %c2_i256 = arith.constant 2 : i256 loc(#loc4)
// CHECK-NEXT:       func.call @__revert(%c0_i256_7, %c24_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc4)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc4)
// CHECK-NEXT:     } loc(#loc4)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc4)
// CHECK-NEXT:     %7 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc4)
...
// CHECK-NEXT:     llvm.store %c0_i256, %8 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %c96_i256 = arith.constant 96 : i256 loc(#loc4)
// CHECK-NEXT:     %c64_i256_2 = arith.constant 64 : i256 loc(#loc4)
// CHECK-NEXT:     %9 = llvm.inttoptr %c64_i256_2 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %10 = llvm.load %9 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc4)
// CHECK-NEXT:     %11 = arith.addi %10, %c96_i256 : i256 loc(#loc4)
// CHECK-NEXT:     %c18446744073709551615_i256_3 = arith.constant 18446744073709551615 : i256 loc(#loc4)
// CHECK-NEXT:     %12 = arith.cmpi ugt, %11, %c18446744073709551615_i256_3 : i256 loc(#loc4)
...
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc4)
// CHECK-NEXT:     } loc(#loc4)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc4)
// CHECK-NEXT:     %15 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %11, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %c0_i256_5 = arith.constant 0 : i256 loc(#loc4)
// CHECK-NEXT:     %16 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %17 = llvm.load %16 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
...
// CHECK-NEXT:     %20 = llvm.getelementptr %19[%17] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     %21 = llvm.inttoptr %10 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%21, %20, %c96_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
// CHECK-NEXT:     %22 = llvm.inttoptr %2 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %10, %22 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %2, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     return loc(#loc3)
// CHECK-NEXT:   } loc(#loc3)
// CHECK-NEXT:   func.func @ui_24.0(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     %c1_i64 = arith.constant 1 : i64 loc(#loc7)
// CHECK-NEXT:     %7 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %8 = arith.extui %c1_i64 : i64 to i256 loc(#loc7)
// CHECK-NEXT:     %c32_i256_0 = arith.constant 32 : i256 loc(#loc7)
// CHECK-NEXT:     %9 = arith.muli %8, %c32_i256_0 : i256 loc(#loc7)
// CHECK-NEXT:     %10 = arith.addi %7, %9 : i256 loc(#loc7)
...
// CHECK-NEXT:     %c2_i8 = arith.constant 2 : i8 loc(#loc8)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc7)
// CHECK-NEXT:     %13 = arith.addi %12, %c64_i256 : i256 loc(#loc7)
...
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @ui_24(%arg0: i256 loc(unknown)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc6)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc6)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc6)
// CHECK-NEXT:     %c0_i64 = arith.constant 0 : i64 loc(#loc1)
...
// CHECK-NEXT:     return %16 : i256 loc(#loc9)
// CHECK-NEXT:   } loc(#loc5)
// CHECK-NEXT:   func.func @malloc_32() attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc4)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc4)
// CHECK-NEXT:     %c64_i256_0 = arith.constant 64 : i256 loc(#loc4)
...
// CHECK-NEXT:       %c0_i256_5 = arith.constant 0 : i256 loc(#loc4)
// CHECK-NEXT:       %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc4)
// CHECK-NEXT:       %23 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %23 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc4)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc4)
// CHECK-NEXT:       %24 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc4)
...
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc4)
// CHECK-NEXT:       %c0_i256_7 = arith.constant 0 : i256 loc(#loc4)
// CHECK-NEXT:       func.call @__revert(%c0_i256_6, %c24_i256, %c0_i256_7) : (i256, i256, i256) -> () loc(#loc4)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc4)
// CHECK-NEXT:     } loc(#loc4)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc4)
// CHECK-NEXT:     %7 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc4)
...
// CHECK-NEXT: #loc6 = loc({{.*}}:8:14)
// CHECK-NEXT: #loc7 = loc({{.*}}:9:18)
// CHECK-NEXT: #loc8 = loc({{.*}}:9:26)
