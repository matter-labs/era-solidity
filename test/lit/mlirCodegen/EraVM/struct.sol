...
// CHECK-NEXT:     %18 = llvm.inttoptr %10 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %19 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %20 = llvm.load %19 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %21 = llvm.getelementptr %20[%17] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%18, %21, %c96_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
