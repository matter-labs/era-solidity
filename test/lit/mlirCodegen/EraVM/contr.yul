// RUN: solc --yul --yul-dialect=evm --mlir-action=print-std-mlir --mlir-target=eravm --mmlir --mlir-print-debuginfo %s | FileCheck %s
...
// CHECK-NEXT:     %1 = "llvm.intrcall"() {id = 2630 : i32, name = "eravm.getu128"} : () -> i256 loc(#loc5)
...
// CHECK-NEXT:     %11 = llvm.mlir.constant(false) : i1 loc(#loc16)
// CHECK-NEXT:     "llvm.intr.memcpy"(%7, %10, %c0_i256_2, %11) : (!llvm.ptr<1>, !llvm.ptr<3>, i256, i1) -> () loc(#loc16)
// CHECK-NEXT:     %12 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc18)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc19)
// CHECK-NEXT:     %13 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc19)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc19)
// CHECK-NEXT:     llvm.store %c32_i256, %13 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc19)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc19)
// CHECK-NEXT:     %14 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc19)
// CHECK-NEXT:     %c0_i256_4 = arith.constant 0 : i256 loc(#loc19)
// CHECK-NEXT:     llvm.store %c0_i256_4, %14 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc19)
// CHECK-NEXT:     %c0_i256_5 = arith.constant 0 : i256 loc(#loc19)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc19)
// CHECK-NEXT:     %15 = arith.muli %c0_i256_5, %c2_i256 : i256 loc(#loc19)
// CHECK-NEXT:     %c64_i256_6 = arith.constant 64 : i256 loc(#loc19)
// CHECK-NEXT:     %16 = arith.addi %15, %c64_i256_6 : i256 loc(#loc19)
// CHECK-NEXT:     %c256_i256_7 = arith.constant 256 : i256 loc(#loc19)
// CHECK-NEXT:     %c2_i256_8 = arith.constant 2 : i256 loc(#loc19)
// CHECK-NEXT:     call @__return(%c256_i256_7, %16, %c2_i256_8) : (i256, i256, i256) -> () loc(#loc19)
...
// CHECK-NEXT:       "scf.int_switch"(%12) ({
// CHECK-NEXT:         scf.yield loc(#loc35)
// CHECK-NEXT:       }, {
// CHECK-NEXT:         %13 = "llvm.intrcall"() {id = 2630 : i32, name = "eravm.getu128"} : () -> i256 loc(#loc36)
...
// CHECK-NEXT:         scf.yield loc(#loc35)
// CHECK-NEXT:       }) {cases = dense<638722032> : tensor<1xi256>} : (i256) -> () loc(#loc35)
