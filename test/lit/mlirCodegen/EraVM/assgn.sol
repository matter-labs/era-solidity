...
// CHECK: #loc1 = loc({{.*}}:4:0)
// CHECK-NEXT: #loc3 = loc({{.*}}:9:16)
// CHECK-NEXT: #loc4 = loc({{.*}}:9:27)
// CHECK-NEXT: #loc5 = loc({{.*}}:9:38)
...
// CHECK-NEXT:   func.func private @__entry(%arg0: !llvm.ptr<3> loc({{.*}}:4:0), %arg1: i256 loc({{.*}}:4:0), %arg2: i256 loc({{.*}}:4:0), %arg3: i256 loc({{.*}}:4:0), %arg4: i256 loc({{.*}}:4:0), %arg5: i256 loc({{.*}}:4:0), %arg6: i256 loc({{.*}}:4:0), %arg7: i256 loc({{.*}}:4:0), %arg8: i256 loc({{.*}}:4:0), %arg9: i256 loc({{.*}}:4:0), %arg10: i256 loc({{.*}}:4:0), %arg11: i256 loc({{.*}}:4:0)) -> i256 attributes {llvm.linkage = #llvm.linkage<external>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality} {
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_m1_36.0(%arg0: i256 loc({{.*}}:9:16), %arg1: i256 loc({{.*}}:9:27), %arg2: i256 loc({{.*}}:9:38)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     llvm.store %3, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %c32_i256 = arith.constant 32 : i256 loc(#loc8)
// CHECK-NEXT:     %5 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     llvm.store %c1_i256_2, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %c64_i256 = arith.constant 64 : i256 loc(#loc8)
// CHECK-NEXT:     %6 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %false = arith.constant false loc(#loc)
// CHECK-NEXT:     %7 = call @__sha3(%6, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc8)
// CHECK-NEXT:     %8 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc8)
// CHECK-NEXT:     %9 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     llvm.store %8, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %c32_i256_4 = arith.constant 32 : i256 loc(#loc8)
// CHECK-NEXT:     %10 = llvm.inttoptr %c32_i256_4 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     llvm.store %7, %10 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %c64_i256_5 = arith.constant 64 : i256 loc(#loc8)
// CHECK-NEXT:     %11 = llvm.inttoptr %c0_i256_3 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     %false_6 = arith.constant false loc(#loc)
// CHECK-NEXT:     %12 = call @__sha3(%11, %c64_i256_5, %false_6) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc8)
// CHECK-NEXT:     %13 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     %14 = llvm.inttoptr %12 : i256 to !llvm.ptr<5> loc(#loc8)
// CHECK-NEXT:     llvm.store %13, %14 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc8)
// CHECK-NEXT:     return loc(#loc2)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_ui_18.0(%arg0: i256 loc({{.*}}:8:16)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<5> loc(#loc15)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc15)
// CHECK-NEXT:     return loc(#loc11)
// CHECK-NEXT:   } loc(#loc11)
// CHECK-NEXT:   func.func @f_ui_18(%arg0: i256 loc({{.*}}:8:16)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc12)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc13)
...
// CHECK-NEXT:     return loc(#loc11)
// CHECK-NEXT:   } loc(#loc11)
// CHECK-NEXT:   func.func @f_m1_36(%arg0: i256 loc({{.*}}:9:16), %arg1: i256 loc({{.*}}:9:27), %arg2: i256 loc({{.*}}:9:38)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT: #loc7 = loc({{.*}}:9:62)
// CHECK-NEXT: #loc8 = loc({{.*}}:9:59)
// CHECK-NEXT: #loc9 = loc({{.*}}:9:65)
// CHECK-NEXT: #loc10 = loc({{.*}}:9:70)
// CHECK-NEXT: #loc11 = loc({{.*}}:8:2)
// CHECK-NEXT: #loc13 = loc({{.*}}:5:2)
// CHECK-NEXT: #loc14 = loc({{.*}}:8:39)
// CHECK-NEXT: #loc15 = loc({{.*}}:8:34)
// CHECK-EMPTY:
