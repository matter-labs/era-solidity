...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_m1_36.0(%arg0: i256 loc({{.*}}:7:16), %arg1: i256 loc({{.*}}:7:27), %arg2: i256 loc({{.*}}:7:38)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_ui_18.0(%arg0: i256 loc({{.*}}:6:16)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   func.func @f_ui_18(%arg0: i256 loc({{.*}}:6:16)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc12)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc13)
...
// CHECK-NEXT:     return loc(#loc11)
// CHECK-NEXT:   } loc(#loc11)
// CHECK-NEXT:   func.func @f_m1_36(%arg0: i256 loc({{.*}}:7:16), %arg1: i256 loc({{.*}}:7:27), %arg2: i256 loc({{.*}}:7:38)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c1_i256_0 = arith.constant 1 : i256 loc(#loc4)
...
// CHECK-NEXT: #loc7 = loc({{.*}}:7:62)
// CHECK-NEXT: #loc8 = loc({{.*}}:7:59)
// CHECK-NEXT: #loc9 = loc({{.*}}:7:65)
// CHECK-NEXT: #loc10 = loc({{.*}}:7:70)
// CHECK-NEXT: #loc11 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc13 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc14 = loc({{.*}}:6:39)
// CHECK-NEXT: #loc15 = loc({{.*}}:6:34)
// CHECK-EMPTY:
