...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @f_12.0(%arg0: i256 loc({{.*}}:4:13)) attributes {llvm.linkage = #llvm.linkage<private>, personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @f_12(%arg0: i256 loc({{.*}}:4:13)) attributes {llvm.linkage = #llvm.linkage<private>, personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc4)
