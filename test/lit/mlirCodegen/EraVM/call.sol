...
// CHECK-NEXT:         %10 = arith.subi %2, %c4_i256_4 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_5 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %11 = arith.cmpi slt, %10, %c0_i256_5 : i256 loc(#loc1)
...
// CHECK-NEXT:         %13 = llvm.inttoptr %c64_i256_6 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:         %17 = arith.addi %14, %c32_i256_7 : i256 loc(#loc1)
// CHECK-NEXT:         %18 = arith.subi %15, %14 : i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%14, %18, %c0_i256_8) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
