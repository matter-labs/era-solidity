...
// CHECK-NEXT:         %10 = func.call @ret_10() : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c64_i256_5 = arith.constant 64 : i256 loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @main_33.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc3)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc3)
// CHECK-NEXT:     call @no_ret_20.0(%0) : (i256) -> () loc(#loc4)
// CHECK-NEXT:     %1 = call @ret_10.0() : () -> i256 loc(#loc5)
// CHECK-NEXT:     return %1 : i256 loc(#loc6)
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @no_ret_20.0(%arg0: i256 loc({{.*}}:6:18)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<5> loc(#loc11)
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc11)
// CHECK-NEXT:     return loc(#loc7)
// CHECK-NEXT:   } loc(#loc7)
// CHECK-NEXT:   func.func @ret_10.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc13)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc13)
// CHECK-NEXT:     return %0 : i256 loc(#loc14)
// CHECK-NEXT:   } loc(#loc12)
// CHECK-NEXT:   func.func @ret_10() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability Pure>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc13)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc13)
// CHECK-NEXT:     return %0 : i256 loc(#loc14)
// CHECK-NEXT:   } loc(#loc12)
// CHECK-NEXT:   func.func @no_ret_20(%arg0: i256 loc({{.*}}:6:18)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc8)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc9)
...
// CHECK-NEXT:     return loc(#loc7)
// CHECK-NEXT:   } loc(#loc7)
// CHECK-NEXT:   func.func @main_33() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc3)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc3)
// CHECK-NEXT:     call @no_ret_20(%0) : (i256) -> () loc(#loc4)
// CHECK-NEXT:     %1 = call @ret_10() : () -> i256 loc(#loc5)
// CHECK-NEXT:     return %1 : i256 loc(#loc6)
// CHECK-NEXT:   } loc(#loc2)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:7:42)
// CHECK-NEXT: #loc5 = loc({{.*}}:7:61)
// CHECK-NEXT: #loc6 = loc({{.*}}:7:54)
// CHECK-NEXT: #loc7 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc9 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc10 = loc({{.*}}:6:40)
// CHECK-NEXT: #loc11 = loc({{.*}}:6:36)
// CHECK-NEXT: #loc12 = loc({{.*}}:5:2)
// CHECK-NEXT: #loc13 = loc({{.*}}:5:54)
// CHECK-NEXT: #loc14 = loc({{.*}}:5:47)
// CHECK-EMPTY:
