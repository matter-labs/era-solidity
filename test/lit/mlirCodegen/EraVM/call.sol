...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @main_33.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:   } loc(#loc2)
// CHECK-NEXT:   func.func @no_ret_20.0(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
...
// CHECK-NEXT:   } loc(#loc7)
// CHECK-NEXT:   func.func @ret_10.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #Pure} {
...
// CHECK-NEXT:   func.func @ret_10() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #Pure} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc13)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc13)
// CHECK-NEXT:     return %0 : i256 loc(#loc14)
// CHECK-NEXT:   } loc(#loc12)
// CHECK-NEXT:   func.func @no_ret_20(%arg0: i256 loc(unknown)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc8)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     llvm.store %arg0, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc9)
...
// CHECK-NEXT:     return loc(#loc7)
// CHECK-NEXT:   } loc(#loc7)
// CHECK-NEXT:   func.func @main_33() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, runtime, state_mutability = #NonPayable} {
// CHECK-NEXT:     %c42_i8 = arith.constant 42 : i8 loc(#loc3)
// CHECK-NEXT:     %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc3)
