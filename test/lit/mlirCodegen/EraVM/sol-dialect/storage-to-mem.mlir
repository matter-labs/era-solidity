...
// CHECK-NEXT:     llvm.unreachable
// CHECK-NEXT:   }
// CHECK-NEXT:   func.func @f.0() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, personality = @__personality} {
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256
...
// CHECK-NEXT:   }
// CHECK-NEXT:   func.func @f() -> i256 attributes {llvm.linkage = #llvm.linkage<private>, personality = @__personality, runtime} {
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256
// CHECK-NEXT:     %c0_i256_0 = arith.constant 0 : i256
// CHECK-NEXT:     %0 = llvm.inttoptr %c0_i256_0 : i256 to !llvm.ptr<1>
// CHECK-NEXT:     llvm.store %c0_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1>
