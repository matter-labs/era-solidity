...
// CHECK-NEXT:       %29 = llvm.inttoptr %c0_i256_12 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %15 = arith.cmpi slt, %3, %c32_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:     %22 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %23 = llvm.load %22 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %24 = llvm.getelementptr %23[%c0_i256_4] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%21, %24, %c0_i256_5) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %25 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256_6 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256_6, %25 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %26 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_7, %26 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %27 = arith.muli %c0_i256_8, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_9 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %28 = arith.addi %27, %c64_i256_9 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_10 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_11 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_10, %28, %c2_i256_11) : (i256, i256, i256) -> () loc(#loc1)
