...
// CHECK-NEXT:       %31 = llvm.inttoptr %c0_i256_12 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:       %c2_i256_14 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:       func.call @__revert(%c0_i256_13, %c24_i256, %c2_i256_14) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %15 = arith.addi %5, %3 : i256 loc(#loc1)
// CHECK-NEXT:     %16 = arith.subi %15, %5 : i256 loc(#loc1)
...
// CHECK-NEXT:       func.call @__revert(%c0_i256_12, %c0_i256_12, %c2_i256_13) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %18 = llvm.inttoptr %5 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     %19 = llvm.load %18 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:     %c32_i256_2 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     %20 = arith.addi %5, %c32_i256_2 : i256 loc(#loc1)
// CHECK-NEXT:     call @_12(%19) : (i256) -> () loc(#loc1)
// CHECK-NEXT:     %c64_i256_3 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %21 = llvm.inttoptr %c64_i256_3 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %24 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %25 = llvm.load %24 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %26 = llvm.getelementptr %25[%c0_i256_4] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%23, %26, %c0_i256_5) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %27 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256_6 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256_6, %27 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %28 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_7 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_7, %28 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %29 = arith.muli %c0_i256_8, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_9 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %30 = arith.addi %29, %c64_i256_9 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_10 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_11 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_10, %30, %c2_i256_11) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_12(%arg0: i256 loc(unknown)) attributes {ctor, llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #sol<StateMutability NonPayable>} {
