...
// CHECK-NEXT:     sol.func @f_12(%arg0: ui256 loc({{.*}}:4:13)) attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     } loc(#loc3)
// CHECK-NEXT:     sol.func @unchk_51(%arg0: ui256 loc({{.*}}:8:17), %arg1: ui256 loc({{.*}}:8:25)) attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:       %2 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc10)
// CHECK-NEXT:       %3 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc11)
// CHECK-NEXT:       %4 = sol.add %3, %2 : ui256 loc(#loc11)
// CHECK-NEXT:       sol.store %4, %0 : ui256, !sol.ptr<ui256, Stack> loc(#loc11)
// CHECK-NEXT:       %5 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc12)
// CHECK-NEXT:       %6 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc13)
// CHECK-NEXT:       %7 = sol.sub %6, %5 : ui256 loc(#loc13)
// CHECK-NEXT:       sol.store %7, %0 : ui256, !sol.ptr<ui256, Stack> loc(#loc13)
// CHECK-NEXT:       %8 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc14)
// CHECK-NEXT:       %9 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc15)
// CHECK-NEXT:       %10 = sol.mul %9, %8 : ui256 loc(#loc15)
// CHECK-NEXT:       sol.store %10, %0 : ui256, !sol.ptr<ui256, Stack> loc(#loc15)
// CHECK-NEXT:       %11 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc16)
// CHECK-NEXT:       %12 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc17)
// CHECK-NEXT:       %13 = sol.add %11, %12 : ui256 loc(#loc16)
// CHECK-NEXT:       sol.call @f_12(%13) : (ui256) -> () loc(#loc18)
// CHECK-NEXT:       %14 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc19)
// CHECK-NEXT:       %15 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc20)
// CHECK-NEXT:       %16 = sol.sub %14, %15 : ui256 loc(#loc19)
// CHECK-NEXT:       sol.call @f_12(%16) : (ui256) -> () loc(#loc21)
// CHECK-NEXT:       %17 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc22)
// CHECK-NEXT:       %18 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc23)
// CHECK-NEXT:       %19 = sol.mul %17, %18 : ui256 loc(#loc22)
// CHECK-NEXT:       sol.call @f_12(%19) : (ui256) -> () loc(#loc24)
// CHECK-NEXT:       sol.return loc(#loc7)
// CHECK-NEXT:     } loc(#loc7)
// CHECK-NEXT:   } {interface_fns = [{selector = -1231012231 : i32, sym = @unchk_51, type = (ui256, ui256) -> ()}], kind = #sol<ContractKind Contract>} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
