...
// CHECK-NEXT:     sol.func @f_6(%arg0: i1 loc({{.*}}:3:13)) attributes {state_mutability = #NonPayable} {
...
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     sol.func @ui_50(%arg0: ui256 loc({{.*}}:5:14), %arg1: ui256 loc({{.*}}:5:25)) attributes {state_mutability = #NonPayable} {
...
// CHECK-NEXT:     } loc(#loc4)
// CHECK-NEXT:     sol.func @si_94(%arg0: si256 loc({{.*}}:14:14), %arg1: si256 loc({{.*}}:14:24)) attributes {state_mutability = #NonPayable} {
