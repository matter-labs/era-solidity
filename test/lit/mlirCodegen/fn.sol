...
// CHECK-NEXT:     sol.func @inp_ui_12(%arg0: i256 loc({{.*}}:3:18)) -> i256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     sol.func @internal_inp_ui_22(%arg0: i256 loc({{.*}}:4:27)) -> i256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     } loc(#loc7)
// CHECK-NEXT:     sol.func @out_ui_30() -> i256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:       %c42_i8 = arith.constant 42 : i8 loc(#loc12)
// CHECK-NEXT:       %0 = arith.extui %c42_i8 : i8 to i256 loc(#loc12)
// CHECK-NEXT:       sol.return %0 : i256 loc(#loc13)
// CHECK-NEXT:     } loc(#loc11)
// CHECK-NEXT:     sol.func @out_bool_38() -> i1 attributes {state_mutability = #sol<StateMutability NonPayable>} {
// CHECK-NEXT:       %true = arith.constant true loc(#loc15)
...
// CHECK-NEXT:   } {interface_fns = [{selector = 1891873197 : i32, sym = @out_bool_38, type = () -> i1}, {selector = 1913244289 : i32, sym = @inp_string_48, type = (!sol.string<Memory>) -> ()}, {selector = 2072703138 : i32, sym = @out_string_65, type = () -> !sol.string<Memory>}, {selector = -1856136386 : i32, sym = @inp_ui_12, type = (i256) -> i256}, {selector = -597758925 : i32, sym = @out_ui_30, type = () -> i256}], kind = #sol<ContractKind Contract>} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
