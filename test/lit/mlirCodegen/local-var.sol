...
// CHECK-NEXT:     sol.func @defInit_11() -> ui256 attributes {state_mutability = #View} {
...
// CHECK-NEXT:     } loc(#loc6)
// CHECK-NEXT:   } {interface_fns = [{selector = -584775204 : i32, sym = @defInit_11, type = () -> ui256}, {selector = -507037398 : i32, sym = @init_23, type = () -> ui256}], kind = #Contract} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
