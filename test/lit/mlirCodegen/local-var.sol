...
// CHECK-NEXT:     sol.func @defInit_11() -> i256 attributes {state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:       %0 = sol.alloca : !sol.ptr<i256, Stack> loc(#loc3)
// CHECK-NEXT:       %c0_i256 = arith.constant 0 : i256 loc(#loc3)
// CHECK-NEXT:       sol.store %c0_i256, %0 : i256, !sol.ptr<i256, Stack> loc(#loc3)
// CHECK-NEXT:       %1 = sol.load %0 : !sol.ptr<i256, Stack>, i256 loc(#loc4)
// CHECK-NEXT:       sol.return %1 : i256 loc(#loc5)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     sol.func @init_23() -> i256 attributes {state_mutability = #sol<StateMutability View>} {
// CHECK-NEXT:       %0 = sol.alloca : !sol.ptr<i256, Stack> loc(#loc7)
// CHECK-NEXT:       %c42_i8 = arith.constant 42 : i8 loc(#loc8)
// CHECK-NEXT:       %1 = arith.extui %c42_i8 : i8 to i256 loc(#loc8)
// CHECK-NEXT:       sol.store %1, %0 : i256, !sol.ptr<i256, Stack> loc(#loc7)
