...
// CHECK-NEXT:     %c2863311530_i256 = arith.constant 2863311530 : i256 loc(#loc2)
...
// CHECK-NEXT:     %1 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<4> loc(#loc4)
// CHECK-NEXT:     "llvm.intrcall"(%c2863311530_i256, %0, %1, %c128_i256) <{id = 3709 : i32, name = "evm.extcodecopy"}> : (i256, !llvm.ptr<1>, !llvm.ptr<4>, i256) -> () loc(#loc4)
// CHECK-NEXT:     %2 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     "llvm.intrcall"(%2, %c128_i256) <{id = 3735 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
