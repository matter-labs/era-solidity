...
object "Test" {
  code {
    mstore(0, extcodehash(0xaaaaaaaa))
    return(0, 32)
  }
}
...
// CHECK-NEXT:     %0 = "llvm.intrcall"(%c2863311530_i256) <{id = 3710 : i32, name = "evm.extcodehash"}> : (i256) -> i256 loc(#loc3)
// CHECK-NEXT:     %1 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     llvm.store %0, %1 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
