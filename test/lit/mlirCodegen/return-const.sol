...
// CHECK-NEXT:     func.func @f0_8() -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
// CHECK-NEXT:       %c300_i16 = arith.constant 300 : i16
// CHECK-NEXT:       %0 = arith.extui %c300_i16 : i16 to i256
// CHECK-NEXT:       return %0 : i256
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func @f1_16() -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
// CHECK-NEXT:       %c300_i16 = arith.constant 300 : i16
// CHECK-NEXT:       %0 = arith.extsi %c300_i16 : i16 to i256
// CHECK-NEXT:       return %0 : i256
// CHECK-NEXT:     }
// CHECK-NEXT:     func.func @f2_26(%arg0: i256) -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
...
// DBG-NEXT:     func.func @f0_8() -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
...
// DBG-NEXT:     } loc(#loc2)
// DBG-NEXT:     func.func @f1_16() -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
...
// DBG-NEXT:     } loc(#loc5)
// DBG-NEXT:     func.func @f2_26(%arg0: i256 loc({{.*}}:6:14)) -> i256 attributes {llvm.linkage = #llvm.linkage<private>} {
