...
// CHECK-NEXT:     }
// CHECK-NEXT:   } {interface_fns = [{selector = "b3de648b", sym = @f, type = (i256) -> i256}], kind = #sol<ContractKind Contract>}
// CHECK-NEXT: }
// CHECK-EMPTY:
// DBG: #loc3 = loc({{.*}}:4:12)
// DBG-NEXT: module {
...
// DBG-NEXT:     } loc(#loc2)
// DBG-NEXT:   } {interface_fns = [{selector = "b3de648b", sym = @f, type = (i256) -> i256}], kind = #sol<ContractKind Contract>} loc(#loc1)
// DBG-NEXT: } loc(#loc0)
