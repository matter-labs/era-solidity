...
// CHECK-NEXT:       scf.int_switch %0 : i256
// CHECK-NEXT:       case 0 {
...
// CHECK-NEXT: #loc5 = loc({{.*}}:3:5)
// CHECK-NEXT: #loc6 = loc({{.*}}:2:14)
// CHECK-NEXT: #loc7 = loc({{.*}}:6:18)
// CHECK-NEXT: #loc8 = loc({{.*}}:6:21)
// CHECK-NEXT: #loc9 = loc({{.*}}:6:11)
// CHECK-NEXT: #loc10 = loc({{.*}}:9:0)
// CHECK-NEXT: #loc11 = loc({{.*}}:9:3)
// CHECK-NEXT: #loc12 = loc({{.*}}:8:15)
// CHECK-NEXT: #loc13 = loc({{.*}}:12:13)
