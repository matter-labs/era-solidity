...
// CHECK-NEXT:     sol.func @get_ui_22() -> ui256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     } loc(#loc6)
// CHECK-NEXT:     sol.func @get_m0_34(%arg0: ui256 loc({{.*}}:9:18)) -> ui256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
...
// CHECK-NEXT:     } loc(#loc9)
// CHECK-NEXT:     sol.func @get_m1_50(%arg0: ui256 loc({{.*}}:10:18), %arg1: ui256 loc({{.*}}:10:29)) -> ui256 attributes {state_mutability = #sol<StateMutability NonPayable>} {
