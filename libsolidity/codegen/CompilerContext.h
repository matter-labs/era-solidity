...
public:
	...
	void addInlineAsmContextMapping(InlineAssembly const* _asm, std::shared_ptr<yul::CodeTransform::Context> _context)
	{
		m_inlineAsmContextMap[_asm] = _context;
	}

	/// Returns the context for @a _asm; nullptr if not found
	yul::CodeTransform::Context const* findInlineAsmContextMapping(InlineAssembly const* _asm) const
	{
...
private:
	...
	std::map<InlineAssembly const*, std::shared_ptr<yul::CodeTransform::Context>> m_inlineAsmContextMap;
