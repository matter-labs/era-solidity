...
)
{
	...
	ExtraMetadataReporter extraMetadataReporter{m_context, m_runtimeContext};
	extraMetadataReporter.run(_contract);
	m_extraMetadata = extraMetadataReporter.metadata;
