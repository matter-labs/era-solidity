...
{
	auto memberFunctionType = dynamic_cast<FunctionType const*>(_memberAccess.annotation().type.get());
	...
	case Type::Category::Module:
	{
		if (auto const* function
			= dynamic_cast<FunctionDefinition const*>(_memberAccess.annotation().referencedDeclaration))
		{
			auto funType = dynamic_cast<FunctionType const*>(_memberAccess.annotation().type.get());
			solAssert(function, "");
