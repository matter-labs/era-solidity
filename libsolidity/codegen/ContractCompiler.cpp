...
bool ContractCompiler::visit(InlineAssembly const& _inlineAssembly)
{
	...
	{
		auto dialect = yul::EVMDialect::looseAssemblyForEVM();
		solAssert(dialect, "");
		...
		object.analysisInfo = make_shared<yul::AsmAnalysisInfo>(
			yul::AsmAnalyzer::analyzeStrictAssertCorrect(dialect, m_context.evmVersion(), *object.code.get(), resolver));
