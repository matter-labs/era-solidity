...
std::map<std::string, Instruction, std::less<>> const solidity::evmasm::c_instructions =
{
	...
	{ "MEMORYGUARD", Instruction::MEMORYGUARD },
	{ "UNSAFEASM", Instruction::UNSAFEASM },
...
{   //                                                Add Args Ret SideEffects GasPriceTier
	...
	{Instruction::MEMORYGUARD,    {"MEMORYGUARD",     0,  1,   1,  false,      Tier::Low}},
	{Instruction::UNSAFEASM,      {"UNSAFEASM",       0,  0,   0,  true,       Tier::Low}},
	...
	{Instruction::SWAPX,          {"SWAPX",           0,  1,   0,  false,      Tier::VeryLow}},
	{Instruction::DUPX,           {"DUPX",            0,  1,   1,  false,      Tier::VeryLow}},
