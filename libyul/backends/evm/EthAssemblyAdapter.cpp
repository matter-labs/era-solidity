...
pair<shared_ptr<AbstractAssembly>, AbstractAssembly::SubID> EthAssemblyAdapter::createSubAssembly(langutil::EVMVersion _evmVersion, bool _creation, string _name)
{
	shared_ptr<evmasm::Assembly> assembly{make_shared<evmasm::Assembly>(_evmVersion, _creation, std::move(_name))};
